 ...
 */
contract MonarchToken is ERC20Burnable, ERC20Detailed, Ownable {
    ...
    constructor(address initialOwner, address recipient) public ERC20Detailed("Token Monarch", "TMON", 6) Ownable(initialOwner) {
        _mint(recipient, 35000e6);
    }
