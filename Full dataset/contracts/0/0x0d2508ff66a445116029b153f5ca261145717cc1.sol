...
Unicorn Token Socials:
Telegram: https://t.me/UNIC_Token
Twitter: https://twitter.com/unicorn_token
Website: https://www.unicorncrypto.org/
Whitepaper: https://drive.google.com/file/d/1AYuG6eViI9WQKsA_rbAooBSiILQqkz0F/view?usp=sharing
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xEB4CdCF4794aEbFE387a826Df5c34E0B10d9b2fE), 5025);
		setTaxAlloc(payable(0x34b40C3E1a2537b3887BBb1989C755D50E6A8198), 2475);
        m_DidDeploy = true;
    }
...
contract UnicornToken is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000000 * 10**9;
    string private m_Name = "Unicorn Token";
    string private m_Symbol = "UNIC";
