...
// CHUBBIES.IO Farming token
// CHBF - ETH, CHBF - WBTC, CHBF - LINK, CHBF - USDC
// Farms launch at GMT April 10th 18:00:00
// CHBF can be redeemed in an upcoming opensea auction for Chubbies NFTs
...
contract CHBToken is ERC20 {
     ...
     */
    constructor(address minter) public ERC20("Chubbies.io", "CHBF") {
        _admin = msg.sender;
        _setupDecimals(18);
        _mint(_admin, 100000000000000000000);
    }
