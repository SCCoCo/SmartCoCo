...
contract CRUXXE_NETWORK {
  
    mapping (address => uint256) public balanceOf;

    // 
    string public name = "Cruxxe Network";
    string public symbol = "CRX";
    uint8 public decimals = 18;
    uint256 public totalSupply = 125000000 * (uint256(10) ** decimals);
