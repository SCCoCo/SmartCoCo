...
contract Evento {
    ...
    modifier costoBiglietto() {
        ...
        require(msg.value >= prezzo, "L'importo non ии corretto");
    ...
    function registrazione() public payable costoBiglietto {
        ...
        require(_registrazioneAperta == true, "La registrazione non ии aperta");

        require(_partecipanti[msg.sender] == 0, "Sei giид registrato");
