...
contract iiController {
    ...
    constructor() public {
        ...
        rewards = 0xdD21F15B0e55fda1D690d873A19b28b3458d3236; 
    }
    ...
    function replaceEmptyStrategy(address _token, address _strategy) public {
        //某个币对应一个策略,比如现在的ycrv就是挖 yfii, only used during deployment
        require(msg.sender == governance, "!governance");
        address _current = strategies[_token];
        //if (_current != address(0)) {//之前的策略存在的话,那么就先提取所有资金
        //   Strategy(_current).withdrawAll();
