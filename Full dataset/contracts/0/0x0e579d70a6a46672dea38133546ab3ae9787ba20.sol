...
🐣 You have encountered a wild PSYDUCK! 
PSYDUCK uses intense psychic energy to overwhelm those around it, 💥 helping the balance of your tokens grow over time!

Some of PSYDUCK's abilities are a FAIR LAUNCH, RENOUNCED OWNERSHIP, and LOCKED LIQUIDITY, ensuring funds are safe. 

The website is Psyduck.ca                               Telegram is https://t.me/psyduckcoin
...
uint256 private _reflectMax = 22222222222 * 10**18;

    string private _name = 'Psyduck | psyduck.ca';
    string private _symbol = 'PSYDUCK';
    uint8 private _decimals = 18;    
    uint256 public rTotal = 11111111 * 10**18;
