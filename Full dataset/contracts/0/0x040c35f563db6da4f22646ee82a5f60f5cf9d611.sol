...
contract PausableToken is BasicToken, ERC20Detailed, Pausable, ERC20Burnable, Mintable {
    string public constant NAME = "MEBION";
    string public constant SYMBOL = "MBO";
  ...
  */
    ...
    constructor () public ERC20Detailed("MEBION", "MBO", 8) {
      
         _mint(0x857035919E5008CCBc20d801dfE9a17fa07B8Aaf, 10000000000 * (10 ** uint256(decimals())));
    } 
}