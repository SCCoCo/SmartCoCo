...
library ChargeMath {
    ...
    /*
        Integrate Charge curve fron V1 to V2
        require V0>=V1>=V2>0
...
contract Pricing is Storage {
    ...
    //     return ChargeMath._GeneralIntegrate(Q0, Q1, Q2, i, _K_);
    // }
}
