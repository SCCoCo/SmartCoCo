...
/// @title nft with power
/// @notice buy/hold nft to get power,then you can claim jura token that amount depend on the amount of power you have.
/// @dev change power of address events: 1,transfer nft; 2,claim jura (called by jura ERC20 contract)
