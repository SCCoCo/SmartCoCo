...
contract StandardERC20Token is IERC20 {
    ...
    constructor(string memory name, string memory symbol, uint8 decimals, uint256 totalSupply, address tokenOwnerAddress) public payable {
      ...
      internalTokenCreate(_tokenOwnerAddress, totalSupply);
   ...
   /**
     ...
     */
    function internalTokenCreate(address account, uint256 amount) internal {
    ...
    function _burn(address account, uint256 value) internal {
        require(account == _tokenOwnerAddress, "ERC20: burn from the zero address");
