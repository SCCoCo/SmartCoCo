...
/*
   ...
   If you want to view all the information about this coin, please check https://t.me/FatherShib
   
   I'll lock liquidity LPs through team.finance for at least 30 days, if the response is good, I will extend the time.
   I'll renounce the ownership to burn addresses to transfer $FatherShib to the community, make sure it's 100% safe.
   ...
   Great features:
    ...
    it's the best part of the $FatherShib idea, increasing the liquidity pool automatically.
...
contract FatherShib is BEP20 {
     ...
     */
    constructor() public BEP20("https://t.me/FatherShib", "FatherShib") {
