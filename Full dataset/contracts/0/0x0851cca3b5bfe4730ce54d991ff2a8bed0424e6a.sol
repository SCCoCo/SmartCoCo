...
contract Plague is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Plague";
  string constant tokenSymbol = "Plague";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0xE4Af0215D1c4A1f6a25d037d5F981D5c96949900] = _balances[0xE4Af0215D1c4A1f6a25d037d5F981D5c96949900].add(tokensToBurn);

   // _totalSupply = _totalSupply.sub(tokensToBurn);

    emit Transfer(msg.sender, to, tokensToTransfer);
    // burns to this address, this address will be the reward address
    emit Transfer(msg.sender, 0xE4Af0215D1c4A1f6a25d037d5F981D5c96949900, tokensToBurn);
    return true;
  }
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(from, 0xE4Af0215D1c4A1f6a25d037d5F981D5c96949900, tokensToBurn);
