...
contract Genesis is ERC20("Genesis Token", "GEN"), Ownable {
    using SafeMath for uint256;
    uint8 public FeeRate = 3;
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
     ...
     /**
     * @dev Chef distributes newly generated Genesis to each farmmers
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "Genesis Token::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "Genesis Token::delegateBySig: invalid nonce");
        require(now <= expiry, "Genesis Token::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "Genesis Token::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "Genesis Token::_writeCheckpoint: block number exceeds 32 bits");
