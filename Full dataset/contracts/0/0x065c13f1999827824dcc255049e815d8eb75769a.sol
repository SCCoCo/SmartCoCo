...
// SuniBar is the coolest bar in town. You come in with some SUEX, and leave with more! The longer you stay, the more SUEX you get.
//
// This contract handles swapping to and from xSuni, SuniExchange's staking token.
contract SuniBar is ERC20("SuniBar", "xSuni"){
    ...
    // Enter the bar. Pay some XSUNI. Earn some shares.
