...
contract SMN1 is ERC20Token {
    string public name = "Super Module Network One";
    string public symbol = "SMN1";
    uint8 public decimals = 18;

    uint256 public totalSupplyCap = 1 * (10**8) * (10**uint256(decimals));
