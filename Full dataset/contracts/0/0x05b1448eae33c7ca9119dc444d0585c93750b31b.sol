...
contract JEGGEE is IERC20, SafeMath {
    string public name;
    ...
    address private feecollectaddress=0xB23Bb04D743b3e5d99c9fBBC4Ffb8aBFc1A1b01c;
    address private referaddr=0xB23Bb04D743b3e5d99c9fBBC4Ffb8aBFc1A1b01c;
    ...
    constructor() public payable {
        ...
        decimals = 5;
        owner = msg.sender;
        _totalSupply = 7500000000 * 10 ** uint256(decimals);   // 24 decimals 
