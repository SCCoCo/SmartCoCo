...
/*
   _____         _____ _____   ____    _____ _   _ _    _ 
  / ____|  /\   |_   _|  __ \ / __ \  |_   _| \ | | |  | |
 | (___   /  \    | | | |  | | |  | |   | | |  \| | |  | |
  \___ \ / /\ \   | | | |  | | |  | |   | | | . ` | |  | |
  ____) / ____ \ _| |_| |__| | |__| |  _| |_| |\  | |__| |
 |_____/_/    \_\_____|_____/ \____/  |_____|_| \_|\____/ 
...
contract SAIDO is Context, IERC20, Ownable {
    ...
    string private _name = 'Saido Inu (t.me/saidoinu)';
    string private _symbol = 'SAIDO';
