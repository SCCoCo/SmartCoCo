...
library Constants {
    ...
    uint256 private constant VESTING_DURATION = 7; //180 days (6 months)
    uint32 private constant VESTING_INTERVAL = 1; //30 days (1 month)
    uint256 private constant STAKE_LOCKUP_DURATION = 60; //30 days (1 month)
