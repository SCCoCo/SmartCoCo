...
/**
 - Hello everyone, LightningPup Shiba Inu (PUPSHINA) are launching on Tuesday 15st June at 18:20 UTC!
 - Hooray, it happened! Guys, we want to create a 100% community token. The developers have collected 10 Ethers for the initial pool and 5 Ethers for tiktok promotion! 
 - We have not insisted on tokens for ourselves, we will buy this coin with our own money after an honest launch on UnisWap! We want to promote the meme movement in cryptocurrency
*/
...
contract PUPSHIBA is Context, IERC20, Ownable {
    ...
    string private _name = 'LightningPup Shiba Inu';
    string private _symbol = 'PUPSHIBA';
