...
contract Token {
    ...
    string public constant name = "Crowdfunding";
    string public constant symbol = "CFD";
    uint8 public constant decimals = 18;

    uint256 private constant INITIAL_SUPPLY = 80000000;
    uint256 public constant totalSupply = INITIAL_SUPPLY * 10 ** uint256(decimals);

    address public constant wallet = 0x8D626259956b54AD4626E47e19F0A44BDF63C9FD;
