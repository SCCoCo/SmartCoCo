...
// 🔥🔥 FLOKI IS ON FIRE!!! JOIN NOW, BRAND NEW LAUNCH 🔥🔥
// 🔥 DO NOT MISS BOOM FLOKI FINANCE!! This will be the BIGGEST Floki project so far! A combination of things will be happening – BE READY! We look to build a strong platform from the beginning and to reward our early community members with tokens and crypto rewards . The team have set out a full roadmap in what they wish to achieve in the upcoming months ahead and we look forward to you joining us on our journey .

// 🥤 1000x Potential 🥤
// ✅ Marketing Plans confirmed 
// ✅ Locked Liquidity 🔒 
// ✅ Verified contract!

// ✅ Telegram - https://t.me/boomflokifinance
// ✅ Website -  TBA
...
contract $BOOMFLOKI is Context, IERC20, Ownable {
    ...
    string private _name = 'Boom Floki Finance';
    string private _symbol = '$BOOMFLOKI';
