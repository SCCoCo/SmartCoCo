...
// File: contracts\tokens\ERC20BurnableAdmin.sol
...
// File: contracts\tokens\ERC20CapEnabler.sol
...
contract ERC20CapEnabler is ERC20Mintable, CreatorRole {
    ...
    /**
     * @dev Returns the cap control status.
     */
    function capEnabled()
        public
        view
    ...
    function mint(address account, uint256 value)
        ...
        onlyMinter
        returns (bool) {
            if (_capEnabled) require(totalSupply().add(value) <= _cap, "ERC20CapEnabler: cap exceeded");
...
// File: contracts\tokens\ERC20Operator.sol
...
// File: contracts\tokens\ERC20AccessList.sol
...
contract ERC20AccessList is ERC20Pausable, ERC20CapEnabler, ERC20Operator {
    ...
    function mint(address _to, uint256 _amount)
        ...
        returns (bool) {
            if (checkingAccessList) {
                require(accessList.checkEnabled(_to), "AccessList: address not authorized");
            }
    ...
    */
    function transfer(address _to, uint256 _value)
        ...
        returns (bool) {
            if (checkingAccessList) {
                require(accessList.checkEnabled(msg.sender, _to), "AccessList: address not authorized");
            }
    ...
    */
    function forcedTransfer(address _from, address _to, uint256 _value)
        ...
        returns (bool) {
            if (checkingAccessList) {
                require(accessList.checkEnabled(_from, _to), "AccessList: address not authorized");
            }
    ...
    function transferFrom(address _from, address _to, uint256 _value)
        ...
        returns (bool) {
            if (checkingAccessList) {
                require(accessList.checkEnabled(msg.sender, _from, _to), "AccessList: address not authorized");
            }
    ...
    function approve(address _spender, uint256 _value)
        ...
        returns (bool) {
            if (checkingAccessList) {
                require(accessList.checkEnabled(msg.sender, _spender), "AccessList: address not authorized");
            }
...
// File: contracts\tokens\ControlledToken.sol
 ...
 * The owner has the power to revoke and claim roles, as an emergency stop mechanism.
 */
...
contract ControlledToken is Ownable, ERC20Detailed, ERC20BurnableAdmin, ERC20AccessList {
    ...
    */
    ...
    /**
     * @dev revokes creator role from an address.
     * @param _address The address will be removed.
     */
    function revokeCreator(address _address)
        public
        onlyOwner {
     ...
     * @param _address The address will be removed.
     */
    function revokeOperator(address _address)
        public
        onlyOwner {
    ...
    /**
     * @dev revokes minter role from an address.
     * @param _address The address will be removed.
     */
    function revokeMinter(address _address)
        public
        onlyOwner {
    ...
    /**
     * @dev revokes burner role from an address.
     * @param _address The address will be removed.
     */
    function revokeBurner(address _address)
        public
        onlyOwner {
     ...
     * @param _address The address will be removed.
     */
    function revokePauser(address _address)
        public
        onlyOwner {
