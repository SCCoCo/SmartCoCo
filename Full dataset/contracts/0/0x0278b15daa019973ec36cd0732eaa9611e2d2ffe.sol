...
contract TREE is ERC20("tree.finance", "TREE"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "tree.finance::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "tree.finance::delegateBySig: invalid nonce");
        require(now <= expiry, "tree.finance::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "tree.finance::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "tree.finance::_writeCheckpoint: block number exceeds 32 bits");
