...
contract MrsGCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MrsGCoin() {
        ...
        name = "MrsGCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 6;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MGC";                                             // Set the symbol for display purposes (CHANGE THIS)
