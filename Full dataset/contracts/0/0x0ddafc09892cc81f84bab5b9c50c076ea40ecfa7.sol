...
contract BitdomToken is CappedToken, PausableToken {

    string public constant name = "Bitdom Token"; // solium-disable-line uppercase

    string public constant symbol = "BM"; // solium-disable-line uppercase
