...
/** @title Ownable - @dev The Ownable contract has an owner address, and provides basic authorization control
...
/** @title Standard ERC20 token - @dev Implementation of the basic standard token https://github.com/ethereum/EIPs/issues/20 */
