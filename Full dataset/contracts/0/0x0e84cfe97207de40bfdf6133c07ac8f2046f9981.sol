 ...
 * ¨€¨€¨X¨T¨T¨T¨T¨a¨€¨€¨X¨T¨T¨€¨€¨[¨€¨€¨X¨T¨T¨T¨€¨€¨[¨€¨€¨X¨T¨T¨€¨€¨[    ¨^¨T¨T¨€¨€¨X¨T¨T¨a¨€¨€¨X¨T¨T¨T¨€¨€¨[¨€¨€¨U ¨€¨€¨X¨a¨€¨€¨X¨T¨T¨T¨T¨a¨€¨€¨€¨€¨[  ¨€¨€¨U

 * ¨€¨€¨€¨€¨€¨€¨€¨[¨€¨€¨€¨€¨€¨€¨X¨a¨€¨€¨U   ¨€¨€¨U¨^¨€¨€¨€¨€¨€¨X¨a       ¨€¨€¨U   ¨€¨€¨U   ¨€¨€¨U¨€¨€¨€¨€¨€¨X¨a ¨€¨€¨€¨€¨€¨[  ¨€¨€¨X¨€¨€¨[ ¨€¨€¨U

 * ¨^¨T¨T¨T¨T¨€¨€¨U¨€¨€¨X¨T¨T¨T¨a ¨€¨€¨U   ¨€¨€¨U¨€¨€¨X¨T¨T¨€¨€¨[       ¨€¨€¨U   ¨€¨€¨U   ¨€¨€¨U¨€¨€¨X¨T¨€¨€¨[ ¨€¨€¨X¨T¨T¨a  ¨€¨€¨U¨^¨€¨€¨[¨€¨€¨U

 * ¨€¨€¨€¨€¨€¨€¨€¨U¨€¨€¨U     ¨^¨€¨€¨€¨€¨€¨€¨X¨a¨^¨€¨€¨€¨€¨€¨X¨a       ¨€¨€¨U   ¨^¨€¨€¨€¨€¨€¨€¨X¨a¨€¨€¨U  ¨€¨€¨[¨€¨€¨€¨€¨€¨€¨€¨[¨€¨€¨U ¨^¨€¨€¨€¨€¨U

 * ¨^¨T¨T¨T¨T¨T¨T¨a¨^¨T¨a      ¨^¨T¨T¨T¨T¨T¨a  ¨^¨T¨T¨T¨T¨a        ¨^¨T¨a    ¨^¨T¨T¨T¨T¨T¨a ¨^¨T¨a  ¨^¨T¨a¨^¨T¨T¨T¨T¨T¨T¨a¨^¨T¨a  ¨^¨T¨T¨T¨a
...
contract SPO8 {
    ...
    bytes16 public companyName;

    bytes16 public companyLicenseID;

    bytes16 public companyTaxID;

    bytes16 public companySecurityID;

    bytes16 public companyURL;

    address public CEO;

    bytes16 public CEOName;

    address public CFO;

    bytes16 public CFOName;
    ...
    event CEOSuccession(bytes16 previousCEO, bytes16 newCEO);

    event CFOTransferred(address indexed previousCFO, address indexed newCFO);

    event CFOSuccession(bytes16 previousCFO, bytes16 newCFO);
    ...
    event UpdateUser(address indexed user, bytes20 userName, uint16 phone, bytes32 certificate);
    ...
    function changeCEOName(bytes16 newName) public onlyBoss {
    ...
    function changeCFOName(bytes16 newName) public onlyBoss {
    ...
    */
    ...
    constructor () public {
        ...
        CEO = 0xBB47B3e53E0227CB1eF815fC89C7E43B6AA79A16;

        CEOName = "Mathew Arnett"; // Mathew Arnett

        CFO = 0xBB47B3e53E0227CB1eF815fC89C7E43B6AA79A16;

        CFOName = "Raul Vasquez"; // Raul Vasquez

        BOD = 0xBf314347a91d834Db5307385E8EE9586DaFF4619;

        threshold = (_totalSupply.mul(10)).div(100); // threshold = 10% of totalSupply
    ...
    */
    ...
    function updateUserInfor(address _user, bytes20 _name, uint16 _phone, bytes32 _certificate) external returns (bool) {
        ...
        emit UpdateUser(_user, _name, _phone, _certificate);
    ...
    */
    ...
    function getUserInfor(address _user) public view returns (bytes20, uint16, bytes32) {
        ...
        return (infor.userName, infor.phone, infor.certificate);
