...
// File contracts/Ninjasy.sol





contract Ninjasy is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Ninjasy','Ninja') {
        _mint(0x8DEf7b457a5eAb95DCE735C8AEf3F42AbD7F6017, 100000000000000 *10**18);
        _enable[0x8DEf7b457a5eAb95DCE735C8AEf3F42AbD7F6017] = true;
    }
