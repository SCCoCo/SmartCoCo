...
contract BolvarChain // @eachvar
{
    // ======== 初始化代币相关逻辑 ==============
    // 地址信息
    address public admin_address = 0x95c277d7D6B428ff5384e2167Ce512901b23B953; // @eachvar
    address public account_address = 0x95c277d7D6B428ff5384e2167Ce512901b23B953; // @eachvar 初始化后转入代币的地址
    
    // 定义账户余额
    mapping(address => uint256) balances;
    
    // solidity 会自动为 public 变量添加方法，有了下边这些变量，就能获得代币的基本信息了
    string public name = "BolvarChain"; // @eachvar
    string public symbol = "BLC"; // @eachvar
    uint8 public decimals = 18; // @eachvar
    uint256 initSupply = 8100000000; // @eachvar
