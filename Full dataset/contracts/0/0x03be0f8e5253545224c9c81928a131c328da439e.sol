...
contract Rahitiara is StandardToken {
    ...
    */
    ...
    uint public INITIAL_SUPPLY = 307310 * (10 ** decimals);
    string public Image_root = "";
    string public Note_root = "";
    string public DigestCode_root = "a01c2b18368c3b94eeb75fd1a1852bc07ade1de7a22b4187f66c6ad80f3c33a7";
    function getIssuer() public view returns(string) { return  "null"; }
    function getArtist() public view returns(string) { return  "https://swarm-gateways.net/bzz:/007c794d27d1ed262bf620766e75ccfbc7d89395caacfa950f7689acce6bed95/"; }
