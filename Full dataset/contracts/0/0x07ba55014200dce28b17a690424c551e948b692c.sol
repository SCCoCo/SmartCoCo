...
*/
// The newest baby anime token, this one will run, liq locked for 1 day, if mooon then 1 week, then further extended.
// good luck my fellow anime lovers
// please wait until liq lock before apeing 
// please don't bot you will be blacklisted
// tg will be created after stealth launch
// peace out :)
...
contract BabyPiccolo is Context, IERC20, Ownable {
    ...
    string private _name = "BabyPiccolooken";
    string private _symbol = "BPIC";
