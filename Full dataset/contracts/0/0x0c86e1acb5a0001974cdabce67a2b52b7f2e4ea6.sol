...
contract sAsgardERC20Token is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Staked Asgard", "sASG", 9) ERC20Permit() {
    ...
    /**
        @notice increases sASG supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sASG
