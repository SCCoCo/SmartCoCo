...
/*
// Presale Contract for BURNOX TOKEN.
...
contract Presale is Ownable {
    ...
    {
        token = BURNOX(0xfE1a92B45997b3641baAf68CdadE1D5C28Bd8Fa4); 
        startTime = 1629261243;   
    ...
    function buy(address beneficiary, address payable referral) public payable
    {
        ...
        require(weiAmount <5000000000000000001 , 'MAX_BUY_LIMIT is 5 ETH'); 
