...
contract HarvestQToken is DetailedERC20, CappedToken, PausableToken, Claimable, CanReclaimToken, TokenWithBlackList {
    ...
    DetailedERC20("HarvestQ", "HVQ", 18)

    CappedToken(1000 * 1000 * 1000 * (10 ** 18))
