...
/**
 Delta Variant V3...The Final Chapter
 
 https://www.deltavariant.io/

 https://t.me/DELTAVARIANTV3
...
contract DeltaV3 is Context, IERC20, Ownable {
    ...
    string private _name = 'Delta Variant V3';
    string private _symbol = 'DeltaV3';
    ...
    function _setCoronaFee(uint256 CoronaFee) external onlyOwner() {
        require(CoronaFee >= 1 && CoronaFee <= 14, 'CoronaFee should be in 1 - 14');
