...
contract EvenCoinPlus is StandardToken {

  string public constant name = "EvenCoinPlus";

  string public constant symbol = "EVNP";
  ...
  uint256 public constant total = 50 * (10**7) * 10**decimals;   // 20 *10^7 EVNP total



  function EvenCoinPlus() public {
