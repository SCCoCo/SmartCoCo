...
contract DTWDContractBase is Ownable {
    constructor() public {
	}
...
contract DTWDToken is Context, ERC20Burnable, ERC20Pausable, DTWDContractBase {
	uint8 public decs = 18;	
	uint256 public INITIAL_SUPPLY = 300000000000 * (10 ** uint256(decs));
	
	constructor() public ERC20("Digital New Taiwan Dollar Token", "DTWD"){
