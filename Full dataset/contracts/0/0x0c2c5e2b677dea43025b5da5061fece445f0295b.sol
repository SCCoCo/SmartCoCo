...
contract COVIDToken is ERC20, 
  ...
  TokenVesting {
    constructor () 
      ERC20('CoronaCoin', 'COVID')
      TokenVesting(msg.sender, block.timestamp, 0, 31556952, false)
      public {
          // world population, locked into the contract
          _mint(
              address(this), 
              7604953650 * (10 ** uint256(decimals()))
          );
          
          // for reparations (airdrop)
          _mint(
              0xe5d0510184A2B769fF7522eBdED2798AF2FE1075, 
              755206522 * (10 ** uint256(decimals()))
          );
  }
}