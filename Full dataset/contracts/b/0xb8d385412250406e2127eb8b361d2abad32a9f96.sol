...
contract ARTY is Context, IERC20, Ownable {
    ...
    string private _name = "Arty's World";
    ...
    uint256 public _nftpoolFee = 10;
    uint256 private _previousCharitypoolFee = _nftpoolFee;

    uint256 public _maxTxAmount = 1000000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 100 * 10**6 * 10**9;

    address payable public nftpoolAddress = 0xa97Cf9Eb83C431103F985BBFCAF2EC47D3873192; // Charity Wallet
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferCharitypoolETH(nftpoolAddress, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_nftpoolFee).div(
            10**2
        );
    }

    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _nftpoolFee == 0) return;

        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousCharitypoolFee = _nftpoolFee;
    ...
    function restoreAllFee() private {
        ...
        _nftpoolFee = _previousCharitypoolFee;
    }
