...
/* 
  ...
  cвободно конвертируемый в любые платежи по Беларуси через ЕРИП
   ...
   Комиссии при транзакциях (переводах) данного эквивалента уплачиваются сторонним майнерам Ethereum в валюте ETH, так как основаны на самом надежном бло��чейне Ethereum
  ...
  Переводы внутри системы невозможно отменить, в��рнуть или невозможно закрыть каким-либо участникам права на использование системы.
