...
/// @title MGGToken
///
/// @dev This is the contract for the MGG team token.
///
...
contract MTToken is AccessControl, ERC20("Mud Guild Game Team Token", "MTT") {
  ...
  modifier onlyMinter() {
    require(hasRole(MINTER_ROLE, msg.sender), "MTTToken: only minter");
    _;
  }
