...
contract CRYPTOSS_Test is ERC20Token, Owned {



    string  public constant name = "CRYPTOSS Test Token";

    string  public constant symbol = "CRYPTOSS";
    ...
    function CRYPTOSS() public {

		totalToken = 100000000000;
    ...
    function burn (uint256 _burntAmount) public returns (bool success) {
    	...
    	require (tokenDestroyed <= 100000000000);
