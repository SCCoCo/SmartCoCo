...
/**
WELCOME TO BOINKO'S PLAYHOUSE!
BOINK is BOINKO's deflationary (WE LIKE TO BURN!) staking token supported by 
Proof of Liquidity 
AND
Proof of BOINK
Find more on the boinkonomics at https://boink.dev/ !
*/
...
contract Boink {
	...
	uint256 constant private INITIAL_SUPPLY = 10e24; // 10Million BOINK
	uint256 constant private STAKE_FEE = 3; // 3% per tx
	uint256 constant private MIN_STAKE_AMOUNT = 1e19; // 10

	string constant public name = "BOINKTOKEN";
	string constant public symbol = "BOINK";
