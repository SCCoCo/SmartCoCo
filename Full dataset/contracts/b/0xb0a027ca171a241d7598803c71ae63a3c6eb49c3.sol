...
contract BondlyLaunchPad is Ownable {
    ...
    function subCardAmount(uint256 _cardId, uint256 _amount)
        public
        onlyOwner
        returns (bool)
    {
    ...
    function addCardAmount(uint256 _cardId, uint256 _amount)
        public
        onlyOwner
        returns (bool)
    {
        _cards[_cardId].currentAmount = _cards[_cardId].currentAmount.add(
            _amount
        );
