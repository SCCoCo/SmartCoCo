...
/**
  ...
  *
  * @notice Artdeco power :ArtPower contract
  * 
  */
 ...
 * the optional functions; to access them see ERC20infos.
 */
interface IERC20 {
    /**
...
contract APowerToken is Governance, ERC20, ERC20infos {
    ...
    constructor() public ERC20infos("ArtPower", "APWR", 18) {}
    ...
    function burnFrom(address account, uint256 _value) public {
        require(_value > 0);
        require(_value <= _balances[account]);
