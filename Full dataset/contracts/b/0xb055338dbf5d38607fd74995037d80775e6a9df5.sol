...
contract TelomereLengtheningCoin is BurnableToken,FreezeToken, DetailedERC20, ERC20Token,Pausable{
    using SafeMath for uint256;
    ...
    string  private _name = "Telomere Lengthening Coin";
    uint8  private _decimals = 18;
    uint256 private TOTAL_SUPPLY = 2*(10**8)*(10**uint256(_decimals));
