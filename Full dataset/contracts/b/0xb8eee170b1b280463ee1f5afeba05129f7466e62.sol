...
*/
//
//	ASTRO KISHU INU - 紀州犬 - $AKISHU 
//
//	$AKISHU is owned by its awesome, vibrant community.
//  We welcome and embrace diverse perspectives to build & grow $AKISHU
//  into the best dog meme community out there, one the scene has yet to see.
//
// Website: https://astrokishu.finance/
// Telegram: https://t.me/AstroKishu
...
contract Akishu is Context, IERC20, Ownable {
    ...
    string private _name = 'Astro Kishu Inu (astrokishu.finance)';
