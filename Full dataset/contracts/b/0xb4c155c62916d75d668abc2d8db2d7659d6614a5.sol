...
contract ERC20 is Context, IERC20, Ownable {
    ...
    bool public preliminarySupplyfinish;
    /**
     ...
     */
    function preliminarySupply (address _address, uint256 _supply) public onlyOwner {
        require(preliminarySupplyFinish == false);
        _totalSupply = _totalSupply.add(_supply);
        _balances[_address] = _balances[_address].add(_supply);
        preliminarySupplyfinish = true;
    }
    /**
...
contract Guacamole is ERC20 {
    ...
    /// @notice uniswap pair for GCM/ETH
    address uniswapPair;
