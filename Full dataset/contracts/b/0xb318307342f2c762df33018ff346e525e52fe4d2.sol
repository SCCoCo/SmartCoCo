...
// @title The Contract is Global Pay Token (GP) Token.
//
// @Author: James
// @Date: 2019.6.23
// @Seealso: ERC20
...
contract GpToken {
    ...
    uint public totalSupply = 10 * 10 ** (8+uint256(decimals));  // ***** 100 * 100 Million
    string constant public name = "Global Pay Token";
    string constant public symbol = "GPT";
