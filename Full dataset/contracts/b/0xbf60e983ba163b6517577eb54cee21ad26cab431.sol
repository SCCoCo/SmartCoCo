...
/*
Keeshoo is a social platform for reviews and recommendations.

Keeshoo uses your social network, your work place, and address book to create your Keeshoo network, in which you can then ask specific questions or look at your network's posted reviews for ideas on where to eat, shop, or explore.
*/
...
contract Keeshoo {
    ...
    string public constant name = "Keeshoo";
    ...
    constructor() public {
        ...
        treasury = address(0x13a50DEa9f1c225bDcaD4074F7e0229C5e502030);  
