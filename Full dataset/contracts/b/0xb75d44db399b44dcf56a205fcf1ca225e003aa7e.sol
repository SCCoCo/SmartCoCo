...
/**
 * A base token for the Ether Stake Token (or any other coin with similar behavior).
...
contract EtherStakeToken is BaseERC20Token {
  constructor() BaseERC20Token(1000000000000000, 5, "Ether Stake Token", "ETSK") public {
    // nothing else needed
  }
}