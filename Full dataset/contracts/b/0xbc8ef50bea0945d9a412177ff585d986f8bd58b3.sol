...
contract PlanethMoney  {
    ...
    uint RENEWAL_NOT_EARLIER = 30 days;
    ...
    constructor() public {
        ...
        // 0.03 - level price , 0.02 - commission for the first time entry
        LEVEL_PRICE[1] = 0.03 ether; 
        LEVEL_PRICE[2] = 0.05 ether;
        LEVEL_PRICE[3] = 0.10 ether;
        LEVEL_PRICE[4] = 0.40 ether;
        LEVEL_PRICE[5] = 1.00 ether;
        LEVEL_PRICE[6] = 2.50 ether;
        LEVEL_PRICE[7] = 5.00 ether;
        LEVEL_PRICE[8] = 10.00 ether;
    ...
    function () external payable {
        ...
        else if(msg.value == LEVEL_PRICE[1]+(0.02 ether)){
            level = 1;
        }
