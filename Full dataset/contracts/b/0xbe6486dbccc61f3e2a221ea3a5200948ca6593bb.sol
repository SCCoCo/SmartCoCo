...
//    }
    ...
    function sendBountyTokens(address target, uint amount) onlyOwner external {
        ...
        require(balances[owner]>=PoolBounty);//Количество токенов д��лжно быть больше или равно балансу основателя
    ...
    function buy() public payable returns(bool) {
        ...
        require(msg.sender != owner);//Осн��ватели не могут покупать токены
