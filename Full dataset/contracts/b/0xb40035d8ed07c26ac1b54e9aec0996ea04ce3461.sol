...
//LowRTT by drunkendog
//Official Discord: https://discord.gg/4VzxAPq
...
contract LowRTT {
	...
	uint256 constant private INITIAL_SUPPLY = 40000000; // 400K
	uint256 constant private BURN_RATE = 1; // 1% per tx
	uint256 constant private SUPPLY_FLOOR = 90; // 90% of 400K = 360K

	string constant public name = "Low Risk Tolerance Token";
	string constant public symbol = "LowRTT";
