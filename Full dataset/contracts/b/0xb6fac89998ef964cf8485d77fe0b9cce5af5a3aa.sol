...
//
//  Welcome to Saliva Drops,
//  Our token is fully ERC-20 compliant!
//____________________________________________________________________________________|



contract SalivaDrops
{


    address     owner = 0x8c4B7870Fc7Dff2cb1e854858533cEdDAF3eEBF4;


    string      public standard = 'Token 0.1';
    string      public name = 'Saliva Drops'; 
    string      public symbol = 'SLV';
    uint8       public decimals = 16; 
    uint256     public totalSupply = 162000000000000000000000;
    ...
    // Use it to get your real SLV balance
    // _______________________________________________________________________________
    ...
    // Use it to transfer SLV to another address
    // _______________________________________________________________________________
    ...
    // Transfer allowed amount of SLV tokens from another address
    // _______________________________________________________________________________
    ...
    // Allow someone to transfer SLV tokens from your address
    // _______________________________________________________________________________
