...
contract xMOBILECOIN is ERC20Detailed, ERC20Mintable {
  constructor() public ERC20Detailed("MobileCoin MOBILECOIN Futures", "xMOBILECOIN", 18) {
    uint total = 20000000 * (10 ** uint256(18));
