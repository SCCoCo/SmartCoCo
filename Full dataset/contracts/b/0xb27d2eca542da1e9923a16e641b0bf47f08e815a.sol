 ...
 */
contract Adcoin is StandardToken {

  string public constant name = "Adcoin"; // solium-disable-line uppercase
  string public constant symbol = "ADCOIN"; // solium-disable-line uppercase
