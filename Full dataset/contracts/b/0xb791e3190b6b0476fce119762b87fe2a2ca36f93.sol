...
contract HackataoNFT is ERC721Full, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721Full("Hackatao On-Chain", "TAO") public {
        fileIPFSReferenceURL = "https://gateway.pinata.cloud/ipfs/";
        fileArweaveReferenceURL = "https://arweave.rocks/";
        tokenReferenceURI = "https://HackataoNFT.azurewebsites.net/api/HttpTrigger?id=";
    }
