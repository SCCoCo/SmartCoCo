...
contract CompteCarboneFinancierToken is PausableToken {
    string  public  constant name = "Compte carbone financier token";
    string  public  constant symbol = "C-bone";
    ...
    function CompteCarboneFinancierToken( address _admin, uint _totalTokenAmount ) 
    {
