...
contract ANTICOVID is CappedToken, PausableToken, BurnableToken {

    string public constant name = "t.me/anticovidtoken";
    string public constant symbol = "ANTICOVID";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_CAP = 500000 * (10 ** uint256(decimals));
    uint256 private constant TOKEN_INITIAL = 500000 * (10 ** uint256(decimals));

    function ANTICOVID() public CappedToken(TOKEN_CAP) {
