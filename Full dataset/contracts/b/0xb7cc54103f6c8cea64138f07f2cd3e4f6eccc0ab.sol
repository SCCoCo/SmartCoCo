...
contract PizzaNFT is ERC721, ERC721Enumerable,ERC721URIStorage, Ownable {
   using Counters for Counters.Counter;
    ...
    uint256 public _startDate = 1629658800;

    constructor() ERC721("Pizzeria Pizza", "PIZZA") {
    }
    ...
    function giveawayMint(uint8 _quantityToMint) public onlyOwner{
        require(_quantityToMint >= 1, "Must mint at least 1");
        require(
            _quantityToMint <= getCurrentMintLimit(),
            "Maximum current buy limit for individual transaction exceeded"
