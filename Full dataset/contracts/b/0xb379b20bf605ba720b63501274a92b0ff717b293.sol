...
// ----------------------------------------------------------------------------
// 'Save Money Coin' contract
//
// Symbol                        : SMC
// Name                          : Save Money Coin
// Total supply                  : 200*10^3
// Decimals                      : 18
//
// Enjoy.
// ----------------------------------------------------------------------------
...
contract SMCoin is IERC20 {
    ...
    uint256 private amount_release = 200*10**21;
    ...
    constructor (
      address _Address
        ...
        _name = "Save Money Coin";
        _symbol = "SMC";
        _decimals = 18;
        _totalSupply = 200*10**21;
        _address = _Address;
