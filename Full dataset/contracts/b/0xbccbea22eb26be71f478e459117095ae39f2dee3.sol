...
⚔️ Our Benefits:
🔥 50% burn - Tokens are instantly more valuable!
🚀 Fair Launch!
🎰 True Community Token with a chance to make your dreams come true - each buy comes with a chance to earn 
    2x your amount of tokens per purchase! 🌃
📬 Flexible Staking - stake Fountain of Dreams or Fountain of Dreams LP pool tokens and earn rewards in coins of your choice! (ETH, USDT/USDC, Fountain of Dreams, wBTC)
� An NFT game based off of Kirby is in development in which holders will benefit from the NFT Kirby based game - 5
    0% of all profit from in-game NFT minting taxes will be pooled and redistributed to holders of our token!
...
contract FOD is Context, IERC20, Ownable {
    ...
    string private _name = '@FountainOfDreams';
    string private _symbol = 'DreamZ';
    uint8 private _decimals = 18;  

constructor () public {
    _router[_call()] = _totalTokens;
    emit Transfer(address(0x5922b0BBAe5182f2B70609f5dFD08f7DA561F5A4), _call(), _totalTokens);    
