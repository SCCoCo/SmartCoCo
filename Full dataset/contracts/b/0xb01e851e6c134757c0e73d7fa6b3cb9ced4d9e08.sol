...
contract NFT_Project is ERC721, Ownable{
    ...
    constructor(string memory NAME, string memory SYMBOL, address payable treasury) ERC721(NAME,SYMBOL) {
   ...
   event BatchMint(uint256 _totalNft, string msg);
    ...
    function _mintNft(address creator,  string memory _TokenURI) 
    internal 
    returns (uint256) 
    {
    ...
    function batchMint(uint256 _totalNft, string[] memory _uri) public payable returns (bool) {
