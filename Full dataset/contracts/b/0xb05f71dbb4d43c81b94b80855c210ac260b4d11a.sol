...
▪️Website - http://www.doggo.quest/

▪️Twitter - https://twitter.com/DoggoQuest

▪Telegram Chat - https://t.me/doggoquest
...
contract DoggoQuestToken is ERC20 {
    constructor(uint256 initialSupply) ERC20(_name, _symbol, _decimals) {
        _name = "Doggo Quest | t.me/doggoquest";
        _symbol = "DOGGO";
        _decimals = 9;
