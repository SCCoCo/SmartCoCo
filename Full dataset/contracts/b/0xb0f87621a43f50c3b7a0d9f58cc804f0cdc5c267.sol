 ...
 * 
 * RTKL3 is just like the standard RTK gun, but loaded with three bullets instead of one; it is used by players in Ruletka's Game Hub 
...
contract Ruletka is Context, Ownable, ERC20Detailed, GasPump {
    ...
    constructor() public ERC20Detailed("Ruletka L3", "RTKL3", 18) {    // For naming the token and specifying it's decimals
