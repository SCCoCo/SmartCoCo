...
// A5Roll helps your migrate your existing Uniswap LP tokens to KobeSwap LP ones
contract A5Roll {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'KobeSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'A5Roll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'A5Roll: INSUFFICIENT_B_AMOUNT');
    }
