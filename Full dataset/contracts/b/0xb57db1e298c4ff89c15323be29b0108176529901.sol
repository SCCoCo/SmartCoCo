...
contract Madacoin is StandardToken, Ownable {



    //token spec

    string public constant name = "Mada Coin"; // solium-disable-line uppercase

    string public constant symbol = "MD"; // solium-disable-line uppercase
