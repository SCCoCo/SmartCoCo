...
/**
   ...
   https://kingpigproject.com/
   
   https://t.me/KingPigCoin
   
   https://twitter.com/KingPigCoin
   
   10% fee auto add to the liquidity pool to locked forever.
   5% burning
...
contract KingPig is Context, IERC20, Ownable {
    ...
    string private _name = "KingPig";
    string private _symbol = "$KIPI";
