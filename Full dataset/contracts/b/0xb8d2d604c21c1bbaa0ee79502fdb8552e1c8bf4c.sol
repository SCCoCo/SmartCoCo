...
contract CHC is BurnableToken {

    string public constant name = "CHiC TOKEN";
    string public constant symbol = "CHC";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 2100000000000000000 * (10 ** uint256(decimals));
