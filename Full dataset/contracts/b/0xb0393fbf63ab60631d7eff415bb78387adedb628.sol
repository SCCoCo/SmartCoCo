...
contract  YFPIFunctionalFinance is ERC20, ERC20Detailed {
  using SafeMath for uint;
  address public hash_ = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
  mapping (address => bool) public governance;
  mapping (address => bool) public holders;
  constructor () public ERC20Detailed("YF PI-3.14 Functional Finance", "YFPI-3.14", 18) {
      _initMint( msg.sender, 314*10**uint(decimals()) );
