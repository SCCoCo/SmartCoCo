...
/**
/Born from planes far above ours 
Where matter only breeds cuteness in its forms 
MiniFloki stemmed from this primordial ooze 
To bring light and riches unto his friends

Will you accept, when he extends his paw ? 

MiniFloki will be using a prominent buyback mechanism, benefiting holders and enabling long-term sustainable growth!
/@MiniFlokiERC
*/
...
contract MiniFloki is BEP20 {
    ...
    uint256 private     _TAX_FEE = 4;
    constructor() public {
		symbol = _SYMBOL;
        name = _NAME;
        decimals = 0;
        totalSupply = 10 * 10 ** 13;
