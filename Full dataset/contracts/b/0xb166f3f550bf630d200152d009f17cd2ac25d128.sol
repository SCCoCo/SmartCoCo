...
contract EZZToken is MintableToken {
  string public constant name = "EZZ Token";
  string public constant symbol = "9999";
  uint8 public constant decimals = 18;

  // Total supply of EZZ tokens is 10 Billion
