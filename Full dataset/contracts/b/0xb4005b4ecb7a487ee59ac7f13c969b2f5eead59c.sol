...
contract DAYUToken is PausableToken {
    string  public  constant name = "DAYU";
    string  public  constant symbol = "DAYU";
    ...
    function DAYUToken(address _admin, uint _totalTokenAmount) public
    {
