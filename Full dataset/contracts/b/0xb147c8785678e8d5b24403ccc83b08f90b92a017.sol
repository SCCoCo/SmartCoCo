...
contract GITBIT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GitBit";
    string private constant _symbol = unicode"GITBIT🔮";
