...
contract MiniTRUMP  is Context, IERC20, Ownable {
    ...
    string private constant _name = "MiniTRUMP";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x425e3C1ac5186686C12E3aE33414C93a9685cFA4);
        _feeAddrWallet2 = payable(0x425e3C1ac5186686C12E3aE33414C93a9685cFA4);
        _feeAddrWallet3 = payable(0x425e3C1ac5186686C12E3aE33414C93a9685cFA4);
