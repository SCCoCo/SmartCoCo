...
contract ROCToken is StandardToken {
    string public name = "Rivers Ocean Coin";
    string public symbol = "ROC";
    uint public decimals = 18;
    uint public totalSupply = 1 * 1000 * 1000 ether;

    function ROCToken() public {
