...
/**
 * @title SwarmNft
 * SwarmNft - a contract for my semi-fungible tokens.
 */
contract SwarmNft is ERC1155Tradable {
    ...
    ERC1155Tradable(
        ...
        _setBaseMetadataURI("https://ethswarm.org/");
    }

    function contractURI() public view returns (string memory) {
        return "https://ethswarm.org/";
    }
    ...
    function uri(
        ...
        if (bytes(uris[_id]).length == 0) {
            return ERC1155Tradable.uri(_id);
        } else {
            return uris[_id];
        }
    }
    ...
    function setTokenInfo(
        ...
        ERC1155Tradable.name = _name;
        ERC1155Tradable.symbol = _symbol;
    }
    ...
    function createAndTransfer(
        ...
        uint256 _id = ERC1155Tradable.create(msg.sender, _recipients.length, _uri, _data);
        setUri(_id, _uri);
        ...
        for (uint256 i = 0; i < _recipients.length; i++) {
            ...
            ERC1155.safeTransferFrom(msg.sender, recipient, _id, 1, _data);
        }
    ...
    function mintAndTransfer(
        ...
        require(_recipients.length > 0, "Empty recipients list");
        ERC1155Tradable.mint(msg.sender, _id, _recipients.length, _data);
