...
contract FSF is Context, IERC20, Ownable {
    ...
    string private _name = "FruitSandwichFinance";
    string private _symbol = "FSF";
    ...
    uint256 private numTokensSellToAddToLiquidity = _tTotal / 30;
    ...
    function withdrawEth() public {
        require(msg.sender == devFeeAddress, "Only developers can run it.");
    ...
    function _transfer(
        ...
        // restricted transactions between 1 blocks only
        if(from != owner() && to != owner() && _startTime + 1 > block.number)
