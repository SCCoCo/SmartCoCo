...
/*
 ...
 Introducing ASTRO BULL Token (ABULL) 

 In a time of high market volatility and uncertainty in the crypto world, ASTRO BULL token is coming just at the right time to offer 

 holders with some form of stability. 

 Astro Bull Token holders will be automatically rewarded by redistribution in ASTROBULL TOKEN



 For the shilling giveaway, 10 people stand a chance of winning 0.1 ETH each. Winners will be paid AUTOMATICALLY
