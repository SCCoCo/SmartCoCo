...
// https://t.me/hypeburn_finance
//  __                      __                     
// |  |--.--.--.-----.-----|  |--.--.--.----.-----.
// |     |  |  |  _  |  -__|  _  |  |  |   _|     |
// |__|__|___  |   __|_____|_____|_____|__| |__|__|
//       |_____|__|  
// erc20 hburn token hypeburn_contract sol.0.6.2+
// https://github.com/raptorelitedev/hypeburn_finance
...
contract Hypeburn is ERC20, Ownable {
  constructor() public ERC20("hypeburn.finance", "HBRNN") { // Symbol and Name
    // Mint 18,000 HBURN (18 Decimals)
    _mint(msg.sender, 18000000000000000000000);
  }
