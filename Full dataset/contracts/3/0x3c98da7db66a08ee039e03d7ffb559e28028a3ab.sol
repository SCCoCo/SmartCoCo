...
contract ClocksToken is ERC20 {
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying TIMEs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "TIME::_writeCheckpoint: block number exceeds 32 bits");
