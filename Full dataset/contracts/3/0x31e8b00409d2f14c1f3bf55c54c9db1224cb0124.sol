...
// ----------------------------------------------------------------------------
// 'HAILING FREQUENCIES OPEN' token contract
//
// Symbol      : UHURA
...
contract UHURA is BurnableToken {

    string public constant name = "HAILING FREQUENCIES OPEN";
    string public constant symbol = "UHURA";
