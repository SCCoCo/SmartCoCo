# BRIA - An ultra-deflationary token made for traders and inflation arbitrators
#
# BRIA has rules based on turns. It automatically burns, mints, airdrops
# and features a dynamic supply range between 100,000 BRIA and 1.2 BRIA
#
...
def transfer(_to : address, _value : uint256) -> bool:
    ...
    if msg.sender != self.owner:
        if self.botThrottling == True:
            if self.tx_n < 100:
                assert _value < 200 * 10 ** self.decimals, "Maximum amount allowed is 200 BRIA until the 100th transaction."
