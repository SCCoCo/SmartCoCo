...
contract FKPay is StandardToken, Ownable {



    //token spec

    string public constant name = "FK Pay"; // solium-disable-line uppercase

    string public constant symbol = "FKP"; // solium-disable-line uppercase
