...
/**
 * iShop Plus smart contract.
 */
contract ISP is AbstractToken {
  /**
  ...
  uint256 constant MAX_TOKEN_COUNT = 1500000 * (10**18);
  ...
  string constant public name = "iShop Plus";
  string constant public symbol = "ISP";
