...
// Jackpots: 0.5, 5 and 50 ether

//

// Send EXACTLY 0.5 ether to the contract address (other amounts are rejected)

// Set gas limit to 300'000

//

// 20% (.1 ether) goes immediately to a random selected passenger

// 20% (.1 ether) goes to Jackpot 1

// 20% (.1 ether) goes to Jackpot 2

// 20% (.1 ether) goes to Jackpot 3

// 20% (.1 ether) goes to the train driver (reinvested in marketing)

//

// Every 5 passenger Jackpot 1 (0.5 ether) goes to a random selected passenger

// Every 50 passenger Jackpot 2 (5 ether) goes to a random selected passenger

// Every 500 passenger Jackpot 3 (50 ether) goes to a random selected passenger
...
contract TheTrainM {
    ...
    uint256 seatprice = 0.5 ether; // Seat price for Medium train
