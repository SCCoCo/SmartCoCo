...
// Reitereum contract based on the full ERC20 Token Standard

// https://github.com/ethereum/EIPs/issues/20

// Smartcontract for Reitereum

// Verified Status: ERC20 Verified Token

// Reitereum Symbol: REIT





contract ReitereumToken { 
 ...
 * Reitereum Math operations with safety checks to avoid unnecessary conflicts
...
contract REITStandardToken is ReitereumToken, Ownable {

    

    using REITMaths for uint256;
...
contract Reitereum is REITStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 50000000000000 ; // 50 Billion tokens, 3 decimal places

    string constant public name = "Reitereum";

    string constant public symbol = "REIT";
