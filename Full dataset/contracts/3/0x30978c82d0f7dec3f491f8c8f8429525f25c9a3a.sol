...
// THIS IS the Smart Contract for QOBIT FAMILY PLAN (QFP), for to send USDT Bonus to TOP 10/LUCKY20/Nodes.
contract SendBonus is SafeMath, Owned {
    ...
    function sendUSDT(address[] memory dests, uint256[] memory values) onlyOwner public returns(bool success) {
