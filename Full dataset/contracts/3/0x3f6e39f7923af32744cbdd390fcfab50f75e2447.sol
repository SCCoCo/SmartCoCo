...
/* ===============================================
* Send ElonToken!
* A Meme Deflationary Token inspired By Elon Musk
* Website : https://www.theelontoken.com/
* Telegram : https://www.theelontoken.com/
* ===============================================
*/
...
contract elonmust is ERC20 {
    ...
    constructor () public ERC20("elonmust", "elonmust") {
        _mint(msg.sender, 111111 * (10 ** uint256(decimals())));
    }
