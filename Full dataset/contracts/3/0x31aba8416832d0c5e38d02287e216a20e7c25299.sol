...
contract BREED is StandardToken, Ownable {



    //token spec

    string public constant name = "BREED"; // solium-disable-line uppercase

    string public constant symbol = "BR"; // solium-disable-line uppercase
