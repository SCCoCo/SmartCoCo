...
// Seedcoin contract based on the full ERC20 Token Standard
// https://github.com/ethereum/EIPs/issues/20
// Smartcontract for Seed-Coin
// Verified Status: ERC20 Verified Token
// Seedcoin Symbol: SEED


contract SeedcoinToken { 
...
/**
 * Seedcoin Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract SEEDStandardToken is SeedcoinToken, Ownable {
    
    using SEEDMaths for uint256;
...
contract Seedcoin is SEEDStandardToken {
    ...
    */
    ...
    string constant public name = "Seed-Coin";
