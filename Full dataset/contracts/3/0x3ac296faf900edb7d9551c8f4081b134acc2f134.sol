...
contract CHToken is UnboundedRegularToken {

    uint public totalSupply = 0.21*10**27;
    uint8 constant public decimals = 18;
    string constant public name = "CHAOS HASH token";
    string constant public symbol = "CHT";
