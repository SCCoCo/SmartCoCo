...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6BB828552D527c520E1C53fbaa11cFA9984270DA;
...
contract JBELFORT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x61D50BE247F9abDD2E950Cdaf1461a5B91159830;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 51000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "JBELFORT";
    string private _symbol = "JBFRT";
    ...
    uint256 public _maxTxAmount = 51000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 51000000 * 10**18;
