...
//  TRI Token Smart Contract
//  Contract Creator  : 0xf1AE0E212AE75c81c0F4651D585566721992311d
//  Token Symbol      : TRI
//  Token Name        : TRITONAL 
...
contract TRI {
	...
	uint256 constant private Total_TRI = 10e25; // 100.000.000 Initial Supply
	uint256 constant private Burn_Ratio = 7;   // 7% burn rate for each transaction
	uint256 constant private Burn_Threshold = 1;     
	uint256 constant private Freeze_Size = 1e20; 
	
	string constant public name = "Tritonal";
	string constant public symbol = "TRI";
	...
	constructor() public {
		...
		info.totalSupply = Total_TRI;
		info.users[msg.sender].balance = Total_TRI;
		emit Transfer(address(0x0), msg.sender, Total_TRI);
	...
	function _transfer(address _from, address _to, uint256 _tokens) internal returns (uint256) {
		...
		if (totalSupply() - _burnedAmount < Total_TRI * Burn_Threshold / 100 || isWhitelisted(_from)) {
			_burnedAmount = 0;
		}
