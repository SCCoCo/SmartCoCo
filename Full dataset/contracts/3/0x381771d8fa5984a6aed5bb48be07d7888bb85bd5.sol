...
contract Meta_Mask_Swap_Token is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Meta Mask Swap Token";
  string constant tokenSymbol = "MTST";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 91100000000000000000000;
