 ...
 * @title DarkX
 */
contract DarkX is ERC20, Ownable {
    ...
    function buyTokens() external payable{
        ...
        require(balanceOf(_msgSender()) + token_wei < _maxHolding, "You cannot buy more tokens");

        transferTo(_msgSender(), (token_wei / 1 ether));
    ...
    function transferTo(address to, uint256 value, bool convert_to_wei) internal  {
        require(to != address(0), "DarkX: transfer to zero address");
    ...
    function deploy(address to, uint256 value) internal {
        ...
        require((balanceOf(to) + value ) < _maxHolding , "You cannot hold more DXT" );
    ...
    function sellTokens(uint256 amount) external {
        ...
        require(balanceOf(_msgSender()) >= amount, "DarkX: recipient account doesn't have enough balance");
        require(amount <= _maxSellBatch, "DarkX: invalid sell quantity" );
        ...
        require(address(this).balance >= wei_value, "DarkX: invalid digits");
