...
PRECISION_MUL: constant(uint256[N_COINS]) = [1, 1, 1, 1]
# PRECISION_MUL: constant(uint256[N_COINS]) = [
#     PRECISION / convert(10 ** 18, uint256),  # wETH
#     PRECISION / convert(10 ** 18, uint256),   # eCRV
#     PRECISION / convert(10 ** 18, uint256),   # steCRV
#     PRECISION / convert(10 ** 18, uint256)]  # ankrCRV
