...
contract BBB is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyBrianBrooks";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x619a42350AcF0A1a5A0B76fe92a625DBe14A3376);
        _feeAddrWallet2 = payable(0x619a42350AcF0A1a5A0B76fe92a625DBe14A3376);
        _feeAddrWallet3 = payable(0x619a42350AcF0A1a5A0B76fe92a625DBe14A3376);
