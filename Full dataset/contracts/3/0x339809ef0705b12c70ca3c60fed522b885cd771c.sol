...
/**
Deployed by Ren Project, https://renbtc.finance 
...
contract renBTCFinanceToken is ERC20 {

    constructor() ERC20("renBTCFinance", "renBTCF") public {
        _mint( msg.sender, 17000 * (10 ** 18) );
    }
