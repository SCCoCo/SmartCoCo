...
/**
 * @title Tartarus-Node-Yellow
 * The supply of this token increases by 1 on every transfer/from, minting 1 token to the deployer wallet.
 * This token exists to support the Tartarus network by handling routing through UNI and COMP.
 *  
 */
...
contract Tartarus is ERC20Detailed {
  ...
  string constant tokenName = "TNodeYellow";
