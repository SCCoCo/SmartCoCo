...
// INSTAGRAM V2 - The new Instagram

// Time to take over social media while the King is down!

// Tokenomics:
// 0% Buy Tax
// 10% Sell Tax

// https://t.me/InstagramV2
...
pragma solidity ^0.6.12;
    ...
    contract InstagramV2 is Context, IERC20, Ownable {
        ...
        string private _name = 'InstagramV2';
        ...
        uint256 private _numOfTokensToExchangeForDevelopment = 2500 * 10**18;
        ...
        function sendETHToDevelopment(uint256 amount) private {
            _developmentWalletAddress.transfer(amount.mul(2).div(10));
            _marketingWalletAddress.transfer(amount.mul(6).div(10));
