...
contract Maia is StandardToken {



    string public constant name = "Maia";

    string public constant symbol = "MAIA";
    ...
    function Maia(address _owner) public {
    ...
    */
    ...
    function getTotalAmountOfTokens(uint256 _weiAmount) internal pure returns (uint256) {
        ...
        if( _weiAmount == 0.005 ether){
            ...
            amountOfTokens = 25 * 10**0 * (10**uint256(decimals));
