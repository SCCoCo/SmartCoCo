...
/**
 ...
 FIRSTMILLION is desgined to make as many millionaires as possible. Inspired by MM Token however their motto is "For millionaires, by millionaires" 
 We are for the common man, by the common man. We have a "Charity" Wallet which will gather ETH in fees and every 2 hours the ETH
 will be dispersed to all holders, without fail EVERY 2 hours. FIRSTMILLION 
 
 www.firstmillion.app
 t.me/firstmilliiontoken
...
pragma solidity ^0.6.12;
    ...
    contract FIRSTMILLION is Context, IERC20, Ownable {
        ...
        string private _name = 'First Million';
