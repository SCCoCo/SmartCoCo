...
contract RevDao is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "RevelationDAO";
  string constant tokenSymbol = "RDAO";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 210000000000000000000000000 ;
  uint256 public basePercent = 100;
  uint256 public baseCut = 1;
  ...
  function cut(uint256 value) public view returns (uint256)  {
    ...
    uint256 cutValue = roundValue.mul(baseCut).mul(basePercent).div(10000);
    return cutValue;
  }
