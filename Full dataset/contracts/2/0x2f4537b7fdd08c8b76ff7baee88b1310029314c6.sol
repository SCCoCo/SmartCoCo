...
// Introducing our revolutionary new DEFI architecture
// Highest yields available in the DEFI space are being reDEFIned

pragma solidity ^0.5.8;

contract reDEFIne {
    string public constant name = "reDEFIne Decentralised Finance";

    string public constant symbol = "RDF";
