...
|_____  ||       ||     |_ |_     _|
 _____| ||   _   ||    _  |  |   |  
|_______||__| |__||___| |_|  |___|  

No presale
CoinGecko apllication pending
Pool will be locked
Website in work - saky.finance
...
contract SafeKiyo is Context, IERC20, Ownable {
  ...
  string private _name = 'Safe Kiyo';
  string private _symbol = 'SAKY';
