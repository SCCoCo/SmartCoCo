...
contract CloutToken is ERC20("CloutToken", "CLOUT"), Ownable {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "CLOUT::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "CLOUT::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "CLOUT::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber =
            safe32(
                block.number,
                "CLOUT::_writeCheckpoint: block number exceeds 32 bits"
            );
