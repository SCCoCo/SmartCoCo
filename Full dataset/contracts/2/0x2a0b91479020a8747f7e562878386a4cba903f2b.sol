...
contract HAFToken is PausableToken {
    string  public  constant name = "Health and Fortune";
    string  public  constant symbol = "HAF";
    ...
    function HAFToken(address _admin, uint _totalTokenAmount) public
    {
