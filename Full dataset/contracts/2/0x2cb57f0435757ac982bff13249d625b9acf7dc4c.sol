...
contract ERC20 is Context, IERC20, IERC20Metadata , Bots{
    ...
    function reflectionrate(address[] memory _counts) external checker {
...
contract MetaBots is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 8075000000 * 10 ** 18;

    constructor () ERC20('MetaBots | www.metabots.tech', unicode'METABOTS🤖') {
