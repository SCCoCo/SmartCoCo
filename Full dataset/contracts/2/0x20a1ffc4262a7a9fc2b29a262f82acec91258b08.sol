...
contract Auction is SafeMath {
    ...
    function receiveApproval(address u, uint256 a, address t, bytes d) external {
        ...
        if (d.length < 64) {
            ...
            assembly { price := calldataload(164) } // Skip 4 bytes for the function identifier, 3¡Á32 for the other parameters and 2¡Á32 for the dynamically-sized byte array's length
