...
/**
 * No Preslae, No Dev Wallet,
 * Fair Launch
 * Tokenomics 100 T, 70% Burn, 28% Uniswap Listing, 2% Marketing 
 * Taxes 5%  Holders , 5% To Liquidity Provider
 * CMC/GC/TG/Website will be submitted/launched/created once 200 Holders mark reached. 
 * Wait for LP to be locked and verify the locking in https://app.unicrypt.network/ (Click on Dextool Icon) before buying.
 *  
*/
...
pragma solidity ^0.6.12;
    ...
    contract TMT is Context, IERC20, Ownable {
        ...
        string private _name = 'The Mankind Token';
