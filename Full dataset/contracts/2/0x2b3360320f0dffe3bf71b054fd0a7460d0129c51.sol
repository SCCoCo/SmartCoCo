...
contract FreezerRole is Ownable {
    ...
    modifier onlyFreezer() {
        require(isFreezer(msg.sender) || isOwner(msg.sender));
        _;
    }
...
contract PauserFreezerRole is FreezerRole {
    using Roles for Roles.Role;
 ...
 */
contract Pausable is PauserFreezerRole {
    event Pause();
    event Unpause();
...
*/
contract MAX is FreezableBurnablePausableERC20Token {
    ...
    **/
    string public constant name = "Maxima Token";
