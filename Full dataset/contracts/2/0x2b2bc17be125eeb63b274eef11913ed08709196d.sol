...
// File: contracts\SufficientCoin.sol
...
contract SufficientCoin is StandardToken, Ownable {



    string public constant name = "Sufficient Coin"; // solium-disable-line uppercase

    string public constant symbol = "SUF"; // solium-disable-line uppercase

    uint8 public constant decimals = 18; // solium-disable-line uppercase



    uint256 public constant INITIAL_SUPPLY = 1280000000 * (10 ** uint256(decimals));
