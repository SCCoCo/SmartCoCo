...
/**
 * @title Giggle Token
 * @dev Token representing Giggle Token.
 */
contract GiggleToken is BurnableToken {
  ...
  */
  constructor(address wallet) public {
    owner = wallet;
    totalSupply = uint(1111111111).mul(10 ** uint256(decimals)); //Update total supply with the decimal amount
    name = "Giggle Token";
    symbol = "GIG";
