...
contract ERC20 is Context, IERC20 {
    ...
    function batchTransfer(address[] memory addressList, uint256[] memory amountList) public  returns (bool) {
        ...
        require(length == amountList.length, "Inconsistent array length"); 
...
contract CBBCToken is ERC20Burnable {

    string internal constant _name = "CyberBank Coin";
    string internal constant _symbol = "CBBC";
    address public constant tokenWallet = 0x047572d7c46eb325064A849Abe69F7Ae46a5326C;
