 ...
 * of reward ERC20 tokens set by the owner of the contract
 * Also the owner of the contract can remove the tokens or the reward amount
 * Before who the claimer send the claim the contract must was funded with reward ERC20 token
 */
contract Airdrop is Ownable {
    /// @notice To use the SafeERC20 for IERC20
