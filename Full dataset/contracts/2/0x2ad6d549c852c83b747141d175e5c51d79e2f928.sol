...
Listed only @ichi.farm

Twitter : Avanti645
Burn % can be changed over time.
Ownership is given to the people over at ichi, once they tell me which address i should point it too.
Pooled against oneEth
Price target = ~
*/
...
contract iHope is ERC20, Ownable {
  constructor() public ERC20("iHope", "iHope") { // Name and Symbol
