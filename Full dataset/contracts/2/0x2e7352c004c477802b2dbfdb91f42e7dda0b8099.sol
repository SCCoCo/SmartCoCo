...
/*
 * Website  - https://armageddon.finance/
 * Twitter  - https://twitter.com/ArmageddonFin
 ...
 *
 */
contract ArmageddonToken is Governed, ERC20, ERC20Burnable {
    using SafeMath for uint256;
  
    // initialSupply variable initial state
    bool initialSupplyFinished = false;
  
    constructor() ERC20("armageddon.finance", "ARMA") {
