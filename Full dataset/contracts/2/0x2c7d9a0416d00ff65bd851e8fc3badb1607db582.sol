...
contract ForintBudapest is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ForintBudapest() {
        ...
        name = "ForintBudapest";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "FBU";                                             // Set the symbol for display purposes (CHANGE THIS)
