...
contract Ownable is Context {
    ...
    uint256 private _lockTime = block.timestamp;
...
contract Callisto is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3278956c7b21Da4d1E0D53bf3B0790104B87F1e0); // Marketing Address
    ...
    string private _name = "Callisto";
    string private _symbol = "C3000";
    ...
    uint256 public _buyBackRangeRate = 60;
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 10;
        _maxTxAmount = 24000000 * 10**6 * 10**9;
    }
