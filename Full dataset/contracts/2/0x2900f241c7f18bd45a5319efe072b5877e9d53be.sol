...
Telegram: https://t.me/PixelPussyToken
Website: pixelpussy.net
Twtiter: https://twitter.com/PixelPussyToken
...
contract PixelPussy is Context, IERC20, Ownable {
    ...
    string private _name = 'PixelPussy | t.me/PixelPussyToken';
    string private _symbol = 'PPUSSY';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 4; // 2% reflection fee for every holder and 2% burn for the dead address
