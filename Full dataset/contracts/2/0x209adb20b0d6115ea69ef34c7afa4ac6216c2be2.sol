...
// File: contracts\NSake.sol

pragma solidity ^0.6.12;



contract NSake is ERC721, Ownable {
    // for minters
     ...
     *
     */
    constructor(string memory _baseURI) public ERC721("NSake", "NSAKE") {
        _setBaseURI(_baseURI);
    }

    function mint(address to, uint256 tokenId) external returns (bool) {
        require(minters[msg.sender], "!minter");
        string memory tokenURI = _uint2str(tokenId);
        _mint(to, tokenId);
