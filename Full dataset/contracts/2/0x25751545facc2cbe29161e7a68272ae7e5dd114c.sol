...
contract One4All is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "OneForAll";                                           // name
    string private _symbol = "OFA";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x902B8115aF53fc68f7fe973385f001578BF6Af75);
