...
// File: contracts/CrowCoin.sol

pragma solidity ^0.5.11;

contract CrowCoin is IERC20, IMint, IBurn, Ownable, Freezer, Pauser, Locker, Minter {
    using SafeMath for uint256;

    string public constant name = "CrowCoin";
    ...
    function transfer(address to, uint256 value)
        ...
        returns (bool)
    {
        require(to != address(0), "CrowCoin/Not-Allow-Zero-Address");
    ...
    function transferFrom(address from, address to, uint256 value)
        ...
        returns (bool)
    {
        require(from != address(0), "CrowCoin/Not-Allow-Zero-Address");
        require(to != address(0), "CrowCoin/Not-Allow-Zero-Address");
    ...
    function burn(uint256 value) external isPause returns (bool) {
        require(value <= balances[msg.sender], "CrowCoin/Not-Allow-Unvalued-Burn");
    ...
    function approve(address spender, uint256 value) external isPause returns (bool) {
        require(spender != address(0), "CrowCoin/Not-Allow-Zero-Address");
