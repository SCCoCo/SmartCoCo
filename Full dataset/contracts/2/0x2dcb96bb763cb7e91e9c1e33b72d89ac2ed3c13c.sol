...
contract CommodityERC20Factory {
  ...
  function newCommodityERC20(string memory name, string memory symbol, uint256 init, address owner)
    public
    returns(address)
  {
...
/**
 * @dev Extension of ERC20 standard designed for simple 'commodity token' deployments with 1:1 redemption.
 */
contract CommodityERC20 is MinterRole, ERC20Burnable, ERC20Pausable {
    string public _name;
    ...
    constructor (string memory name, string memory symbol, uint256 init, address owner) public {
        _name = name;
        _symbol = symbol;
        _decimals = 0; // makes token nondivisible
        _owner = owner;
