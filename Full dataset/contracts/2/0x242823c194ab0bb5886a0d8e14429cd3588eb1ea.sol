...
contract UEECToken is PausableToken {

    string  public  constant name = "UEEC Constant Coin";

    string  public  constant symbol = "UEEC";
    ...
    function UEECToken( address _admin, uint _totalTokenAmount ) 

    {
        ...
        // assign the total tokens to UEEC
