...
contract MicroEthereum is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000 * 10**_decimals; // 1 Trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

   string private _name = "Bitcoin White";
    ...
    uint256 private minTokensBeforeSwap = 3000 * 10**_decimals; // 30m
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x8a827cF2CF3F865e7084E145cA59B44aD124182F); // Pancake
