...
// 'ALIVA' Token contract with following features
...
// Decimals    : 18
    ...
    contract TokenERC20 {
        ...
        constructor (
            ...
            uint256 tokensReserved  = 900000000 * (10**decimals); 

            uint256 tokensCrowdsale = 100000000 * (10**decimals); 
    ...
    contract ALIVA is owned, TokenERC20 {

    

        /* Public variables of the token */

        string private tokenName = "Aliva Token";

        string private tokenSymbol = "ALV";
