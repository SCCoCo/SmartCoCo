...
contract evault is PausableToken, FrozenableToken 
{

    string public name = "evault.finance";
    string public symbol = "ENCORE";
    uint256 public decimals = 18;
    uint256 INITIAL_SUPPLY = 10000 * (10 ** uint256(decimals));
