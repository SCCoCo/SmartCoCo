...
// LOOT FINANCE ERC20 contract with treasury/burn funcionality
// 
// https://lootx.finance
// https://t.me/lootx_finance
...
//          \/        \/         \/         
// 
// https://github.com/lootdevvy/lootfinance
...
// File: contracts/LootFinance.sol
...
contract LootToken is ERC20, Ownable {
  constructor() public ERC20("lootx.finance", "LOOT") { // Symbol and Name
    // Mint 24,0000 LOOT (18 Decimals)
    _mint(msg.sender, 24000000000000000000000);
  }
