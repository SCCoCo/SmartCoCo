...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    /* Origin address */
    address internal constant ORIGIN_ADDR = 0x4B5acFeB9219E4C4fE68c9a75e47a602e249A4b9;

    /* Flush address */
    address payable internal constant FLUSH_ADDR = 0x4B5acFeB9219E4C4fE68c9a75e47a602e249A4b9;
    ...
    uint256 private constant CC_PER_HEX = 10 ** uint256(decimals); // 1e8
    uint256 private constant OCT_PER_BTC = 1e4;
    uint256 private constant SATOSHIS_PER_BTC = 1e8;
    uint256 internal constant HEARTS_PER_SATOSHI = CC_PER_HEX / SATOSHIS_PER_BTC * OCT_PER_BTC;
    ...
    uint256 internal constant WAAS_LOBBY_SEED_HEARTS = WAAS_LOBBY_SEED_HEX * CC_PER_HEX;
    ...
    uint256 internal constant BPB_MAX_HEARTS = BPB_MAX_HEX * CC_PER_HEX;
