...
contract DeficliqStaking is AccessControl {
    ...
    constructor(address _stakedToken, address _CLIQ) {
        ...
        _definePackage("Silver Package", 45, 45, 9717881, 0); // in 30 days you receive: 1.740084% of staked token OR 0 cliq for 1 token staked || 6 decimals
        _definePackage("Gold Package", 60, 60, 14043476, 0); // 0 cliq for 1 token staked
        _definePackage("Platinum Package", 90, 90, 24466595, 0); // 0 cliq for 1 token staked
    }
