...
/**
// The one and only Dui Dog is here to safe the lives of all meme-dog coins.
// 
// WEBSITE - http://duidogtoken.com
// TELEGRAM - https://t.me/duitoken
// 
//
// TOKENOMICS
// 30% Burned
// 70% Listed on uniswap
// 5% Redistribution
// Fair stealth launch to keep minimal of bots.
//
//
// Check out Dui's instagram!
// https://www.instagram.com/nguyen_van_dui/
*/
...
pragma solidity ^0.6.12;
    ...
    contract DuiToken is Context, IERC20, Ownable {
        ...
        string private _name = 'Dui the superhero meme dog';
        string private _symbol = 'DuiToken';
