...
// ----------------------------------------------------------------------------
// 'XGPAY' Token contract with following features
//      => ERC20 Compliance
...
// Decimals    : 18
    ...
    contract TokenERC20 {
        ...
        constructor (
            ...
            uint256 tokensReserved  = 0 * (10**decimals); 
    ...
    contract AIGOPayment is owned, TokenERC20 {
    
        /* Public variables of the token */
        string private tokenName = "XGPAY Token";
        string private tokenSymbol = "XGPAY";
        uint256 private initialSupply = 200000000;  
