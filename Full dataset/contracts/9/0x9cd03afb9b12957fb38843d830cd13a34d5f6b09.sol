...
// OTTCOIN Token contract based on the full ERC 20 Token standard
// Symbol: ELR
// Status: ERC20 Verified

contract ELECTRICOINToken { 
...
/**
 * ElectriCoin Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract ELRStandardToken is ELECTRICOINToken, Ownable {
    
    using ELRMaths for uint256;
...
contract ELECTRICOIN is ELRStandardToken {
    ...
    */
    ...
    uint256 constant public decimals = 6; //How many decimals to show.
    uint256 public totalSupply = 10 * (10**7) * 10**6 ; // 100 million tokens, 6 decimal places
    string constant public name = "ElectriCoin"; //fancy name: eg ElectriCoin
    string constant public symbol = "ELR"; //An identifier: eg ELR
    string constant public version = "v2";       //Version 2 standard. Just an arbitrary versioning scheme.
    
    function ELECTRICOIN(){
