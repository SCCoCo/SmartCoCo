...
// * Luck Vegas - Casino crypto games, the future of online gambling.
...
contract LuckVegas {
    ...
    // There is minimum and maximum cap on bets.
    ...
    uint constant HOUSE_EDGE_MINIMUM_AMOUNT = 0.0005 ether;
    ...
    //                    by the croupier in the settleBet transaction. Supplying
    ...
    // in a situation like this, just contact the support, however nothing precludes you from invoking this method yourself.
