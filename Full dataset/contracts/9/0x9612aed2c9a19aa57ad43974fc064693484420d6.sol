...

{
    ...
    address public admin_address = 0x8f1e024a243761362032d33c4d78130aaAFb78a2; // @eachvar

    address public account_address = 0x8f1e024a243761362032d33c4d78130aaAFb78a2; // @eachvar 初始化后转入代币的地址
    ...
    string public name = "Health Factory computing currency"; // @eachvar

    string public symbol = "HFCC"; // @eachvar
