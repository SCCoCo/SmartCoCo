...
contract KumoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kumo Inu | t.me/KumoInu";
    string private constant _symbol = "Kumo Inu";
