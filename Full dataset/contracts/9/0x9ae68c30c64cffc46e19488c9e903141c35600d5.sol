...
contract KRWST is Ownable, SafeMath {

    /* Public variables of the token */

    string public name = 'Korea Rising World Stable Token';

    string public symbol = 'KRWST';

    uint8 public decimals = 8;

    uint256 public totalSupply =(20190701000  * (10 ** uint256(decimals)));
