...
contract JZFSYToken is Initializable, ERC20Detailed, ERC20Mintable, ERC20Pausable, ERC20Rewardable {
    ...
    function initialize() public initializer {
        Token_ID = "JZFSY";
        ArtistID = "NickyLee, EnikLin";
        ISRC = "";

        ERC20Detailed.initialize("", "JZFSY", 18);
