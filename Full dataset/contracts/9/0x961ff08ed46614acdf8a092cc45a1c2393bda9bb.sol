...
contract FecoreFixedStake is StakeTokenWrapper(0x7F811F1EB3Dc7eaC61abBc0F1D9F4D90bdD95E00), IGovernanceAddressRecipient {
    ...
    function stop() public onlyGovernanceAddress {
        ...
        FECORE.safeTransfer(address(0x489B689850999F751760a38d03693Bd979C4A690), remainingReward());
        stakeable = false;
        initReward = 0;
        rewardRate = 0;
    ...
    function depositReward(uint256 amount) public onlyGovernanceAddress {
        ...
        FECORE.safeTransferFrom(msg.sender, address(this), amount);
        initReward = amount;
    ...
    function getReward() public updateReward(msg.sender) checkStart {
        ...
        if (reward > 0) {
            ...
            FECORE.safeTransfer(msg.sender, reward);
