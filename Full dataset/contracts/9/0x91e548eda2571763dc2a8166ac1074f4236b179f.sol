...
contract IMCASHToken is ERC20Interface, Ownable{
    ...
    function IMCASHToken() public {

        symbol = "IMCASH";

        name = "Intelligent Manufacturing Cash";

        decimals = 18;

        _totalSupply = 1000000000 * 10 ** uint(decimals);	//10ÒÚÃ¶
