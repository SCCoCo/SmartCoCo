...
// ----------------------------------------------------------------------------
// 'Yarn.Money' Smart Contract
//
// OwnerAddress : 0x402C27341d13b0c23a01cF39794f875eF0887B16
// Symbol       : YMY
// Name         : Yarn Money
// Total Supply : 99800000 YMY
// Decimals     : 18
// Copyrights of 'Yarn.Money' With 'YMY' Symbol December 16, 2020.
// The MIT Licence.
// 
...
contract Owned {
    ...
    constructor() public {
        owner = 0x402C27341d13b0c23a01cF39794f875eF0887B16;
    }
...
// ----------------------------------------------------------------------------
contract YarnMoney is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "Yarn.Money";
        decimals = 18;
        _totalSupply = 99800000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 293500000; // 1 ETH = 29350 $YMY 
        DENOMINATOR = 10000;
