 ...
 * @notice  Rebalancing strategy for CCore Vault that maintains the two
...
contract PassiveStrategy is IStrategy {
    ...
    CCoreVault public immutable vault;
    IUniswapV3Pool public immutable pool;
    int24 public immutable tickSpacing;
    ...
    constructor(
        ...
        IUniswapV3Pool _pool = CCoreVault(_vault).pool();
        int24 _tickSpacing = _pool.tickSpacing();

        vault = CCoreVault(_vault);
        pool = _pool;
