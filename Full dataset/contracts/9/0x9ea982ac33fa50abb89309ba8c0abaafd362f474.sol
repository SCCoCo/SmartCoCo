...
/**
 .----------------.  .----------------.  .----------------.   .----------------.   .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. | | .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. |
| |  _________   | || |     ____     | || |  ____  ____  | | | |              | | | | _____  _____ | || |      __      | || |  _______     | || |    _______   | |
| | |  _   _  |  | || |   .'    `.   | || | |_  _||_  _| | | | |              | | | ||_   _||_   _|| || |     /  \     | || | |_   __ \    | || |   /  ___  |  | |
| | |_/ | | \_|  | || |  /  .--.  \  | || |   \ \  / /   | | | |    ______    | | | |  | | /\ | |  | || |    / /\ \    | || |   | |__) |   | || |  |  (__ \_|  | |
| |     | |      | || |  | |    | |  | || |    \ \/ /    | | | |   |______|   | | | |  | |/  \| |  | || |   / ____ \   | || |   |  __ /    | || |   '.___`-.   | |
| |    _| |_     | || |  \  `--'  /  | || |    _|  |_    | | | |              | | | |  |   /\   |  | || | _/ /    \ \_ | || |  _| |  \ \_  | || |  |`\____) |  | |
| |   |_____|    | || |   `.____.'   | || |   |______|   | | | |              | | | |  |__/  \__|  | || ||____|  |____|| || | |____| |___| | || |  |_______.'  | |
| |              | || |              | || |              | | | |              | | | |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' | | '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'   '----------------'   '----------------'  '----------------'  '----------------'  '----------------' 
*/
...
contract ToyWarS is ERC20 {
     ...
     */
    constructor () ERC20('Toy Wars', 'TWARS') {
