...
contract ECOPLocker is owned{
    ...
    uint256[] public MONTH_TIER = [55555,55555,55555,55555,55555,55555,55555,55555,55555,55555,55555,55555,55555,55555,55555,55555,55555,55565];
    uint256 constant public TOTAL_AMOUNT = 1000000*10**18;
    ...
    */
	...
	if(ts < (online_time+540*86400))
		return 0;
	uint256 time_span = ts.sub(online_time).sub(540*86400);
