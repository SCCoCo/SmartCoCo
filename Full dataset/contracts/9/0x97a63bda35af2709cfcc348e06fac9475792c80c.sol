...
contract KERRI is Pausable, StandardToken, BlackList {
    ...
    function KERRI(uint _initialSupply, string _name, string _symbol, uint _decimals) public {
    ...
    // Called when new token are minted
