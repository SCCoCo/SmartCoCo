...
/**
 * Created on 2020-08-26 09:34
 * @summary: SCT token without voting capabilities
...
/**
 * @title SCT Token Contract
 */
contract SCT is ERC20Capped, Ownable, Pausable, Blacklist {
    using SafeMath for uint256;
    ...
    */
     ...
     */
    function mint(address recipient, uint _mintVal) public onlyOwner whenNotPaused {
     ...
     */
    function burn(uint _burnVal) public whenNotPaused {
    ...
    */
    function transfer(address _to, uint256 _value) public override onlyPayloadSize(2 * 32) whenNotPaused returns (bool) {
    ...
    * @return true if success
    */
    function transferFrom(address _from, address _to, uint _value) public override onlyPayloadSize(3 * 32) whenNotPaused returns (bool) {
