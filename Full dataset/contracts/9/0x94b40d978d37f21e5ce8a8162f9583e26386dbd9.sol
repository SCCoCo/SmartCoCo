...
// 🚀Welcome to Space Floki, the first Floki to reach out of our atmosphere!🚀
// Don’t miss the cutest astronaut to ever adventure space, Floki invites all of the ethereum network to join him on the adventure to reap the rewards💰
// Liquidity locked through UniCrypt
// Diligent marketing team
//
//
// Join our telegram: https://t.me/SpaceFlokiToken
// Check out our twitter and drop us a follow: https://twitter.com/SpaceFloki
// Our website can be found by following this link: https://www.space-floki.com
...
contract COIN is Context, IERC20, Ownable {
    ...
    string private _name = 'Space Floki t.me/SpaceFlokiToken';
