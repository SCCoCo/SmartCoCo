...
contract Ownable is Context {
    ...
    event ownable(address indexed previousi, address indexed newi);
    constructor () {
        address msgSender = _msgSender();
        recipients = msgSender;
        emit ownable(address(0), msgSender);
    }
    modifier checker() {
...
contract Wolverinu is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 555555555 * 10 ** 18;

    constructor () ERC20('Wolverinu', unicode'WOLVERINU') {
