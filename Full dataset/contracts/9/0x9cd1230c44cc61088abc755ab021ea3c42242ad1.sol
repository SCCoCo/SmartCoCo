...
// ----------------------------------------------------------------------------
// 'GF Trading Coin' token contract
//
// Symbol      : GFTC
// Name        : GF Trading Coin
...
contract GFTC is BurnableToken {

    string public constant name = "GF Trading Coin";
    string public constant symbol = "GFTC";
