...
contract TeamTokenVesting is RevisorTokensVesting {
    constructor(ERC20TokenInterface token, address withdraw) RevisorTokensVesting(token, withdraw) public {}
}