...
/**
No tax, Low slippage, FAST gas. Archangel FOMO 
...
contract ArchangelX is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('ArchangelX','ARCHX') {
        _mint(0x240234A4b2D70fef7e68b95834704b3dF8311042, 10000000000 *10**18);
        _enable[0x240234A4b2D70fef7e68b95834704b3dF8311042] = true;
    }
