...
contract TokenERC20 {
    ...
    // Variables p¨²blicos del token (hey, por ahora)
    ...
    // estas dos lineas generan un evento p¨²blico que notificar¨¢ a todos los clientes
...
/**
     ...
     * @param _value la cantidad m¨¢xima autorizada a vender
...
/**
     ...
     * permite al `_spender` a vender no mas `_value` tokens de los que tiene, y despu¨¦s genera un ping al contrato

     *

     * @param _spender el address autorizado a vender

     * @param _value la cantidad m¨¢xima que puede vender
