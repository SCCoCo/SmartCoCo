...
contract AstroShib is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AstroShib | T.me/AstroShib";
    string private constant _symbol = unicode"AstroShib";
