...
contract Coinbase is Ownable {
    ...
    // generate new block every 6 hours. Halving coinbase at every 150 day

    uint256 public halvingPeriod = 4 * 150;
    ...
    function Coinbase(uint256 _decimals) public{
        ...
        coinbaseInit = 425000 * (10 ** uint256(decimals));
...
contract UKTCoinToken is MintableToken, PausableToken, Coinbase {

    string public constant name = "UKT Token"; 
    ...
    function UKTCoinToken() Coinbase(decimals) public{
