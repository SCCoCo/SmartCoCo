...
contract Paly is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Palestinian Inu';
    string  private constant _SYMBOL = 'PALY';
    ...
    uint256 private _tTotal = 1922072400 * _DECIMALFACTOR;
    ...
    uint256 private constant _MAX_TX_SIZE = 1922072400 * _DECIMALFACTOR;
    ...
    constructor () {
        ...
        address account = 0xaB16551C24FDB592A9Cbbc5B9E8F89f88562D465;//Charity donation
