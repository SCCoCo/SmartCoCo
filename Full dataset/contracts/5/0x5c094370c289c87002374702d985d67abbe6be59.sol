...
contract DeFiYearnFinaceDYF {
    // Public variables of the token
    string public name = "DeFi YEarn Finance";
    string public symbol = "DYF";
    uint8 public decimals = 18;
    // 18 decimals is the strongly suggested default
    uint256 public totalSupply;
    uint256 public DeFiYearnFinaceDYFSupply = 30000;
    uint256 public buyPrice = 20;
     ...
     */
    constructor() public {
        totalSupply = DeFiYearnFinaceDYFSupply * 10 ** uint256(decimals);  // Update total supply with the decimal amount
        balanceOf[msg.sender] = totalSupply;    // Give DeFiYearnFinaceDYFet Mint the total created tokens
        creator = msg.sender;
    }
    /**
