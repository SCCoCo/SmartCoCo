...
contract StrategyFortubeYFII {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    
    address constant public want = address(0xa1d0E215a23d7030842FC67cE582a6aFa3CCaB83); //YFII
    ...
    constructor() public {
        ...
        swap2TokenRouting = [output,usdt,weth,want];
        doApprove();
    }
