...
contract MetaMask_Swap_Official_Token is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "MetaMask Swap";
  string constant tokenSymbol = "MASK";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 33000000000000000000000;
