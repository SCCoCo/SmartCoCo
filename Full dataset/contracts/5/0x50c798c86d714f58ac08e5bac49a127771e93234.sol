...
// by he.guanjun, email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="731b165d175d175d001b121d331b1c071e121a1f5d101c1e">[email&#160;protected]</a>
// 2017-09-03
...
contract  Erc20TokenMarket is Base         //for exchange token
{
    ...
    function buyTokenFrom(address _seller, address _tokenAddress, uint256 _buyerTokenPrice) public payable returns(bool _result) {   
        ...
        if (bigger && sellerGuaranteeEther > 0){                                  //虚报可出售Token，要惩罚卖家
            ...
            else if (userEtherOf[_seller] > 0)     //Buyer可以恶意攻击，明知卖家���证金不足，就每次小金额的购买代币，让卖家账上始终小于保证金金额，这种情况其实买家也不划算，毕竟gas蛮贵,而保证金最高才0.1 ether，暂不处理！
            {
