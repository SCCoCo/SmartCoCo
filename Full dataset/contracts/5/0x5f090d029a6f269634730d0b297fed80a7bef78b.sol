...
|   __|     | . |  _| .'|  _| -_|  
|_____|_|_|_|___|_| |__,|___|___|  
                                   
                                   
     _____ _____ _____             
    |_   _|  |  |   __|            EmbracetheLight.US
      | | |     |   __|            @EmbracetheLightToken
      |_| |__|__|_____|            
...
💫 EMBRACE THE LIGHT is a high-yield frictionless farming token. 2% is distributed to EMBRACE THE LIGHT holders proportional to 
    the amount of EMBRACE THE LIGHT held. 
...
contract EmbracetheLight is ERC20{
    ...
    uint256 private _totalSupply = 400400400 * 10 ** 18;

    constructor () ERC20('ETL', unicode'💫 EMBRACE THE LIGHT') {
