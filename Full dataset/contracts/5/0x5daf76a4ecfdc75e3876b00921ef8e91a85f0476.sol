...
/**
* XCB (eXtensible Cross Border ) Contract
* Founders: Skynext Alliance & Orcopedia Organization
*/
...
contract XCB is Authorizable, TokenERC20 {
   ...
   /// no tokens can be ever issued when this is set to "true"
    ...
    constructor(
        ...
        tokenSaleHardCap =  20000000000 * 10**uint256(decimals); // Default Crowsale Hard Cap amount with decimals
