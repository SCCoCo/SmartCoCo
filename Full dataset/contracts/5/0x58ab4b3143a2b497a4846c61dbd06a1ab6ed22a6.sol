...
contract PartySkull is Ownable, Pausable{
    ...
    function createCranialBones(uint256 LeftParietalTokenId, uint256 RightParietalTokenId, uint256 LeftTemporalTokenId, uint256 RightTemporalTokenId, 
        uint256 FrontalTokenId, uint256 OccipitalTokenId, uint256 EthmoidTokenId, uint256 SphenoidTokenId) whenNotPaused
    	public
    	returns (uint256)
    {   
    ...
    function createAuditoryOssicles(uint256 LeftMalleusTokenId, uint256 RightMalleusTokenId, uint256 LeftIncusTokenId, uint256 RightIncusTokenId, 
        uint256 LeftStapesTokenId, uint256 RightStapesTokenId) whenNotPaused
    	public
    	returns (uint256)
    {   
        PartyBones partyBones = PartyBones(addressPartyBones);
    ...
    function createFacialBones(uint256[] memory MaxillaTokenIds, uint256[] memory ZygomaticTokenIds,
        ...
        uint256 LeftInferiorNasalConchaTokenId, uint256 RightInferiorNasalTokenId, uint256 LeftLacrimalTokenId, uint256 RightLacrimalTokenId, uint256 VomerTokenId) whenNotPaused
    	public
    	returns (uint256)
    {   
        PartyBones partyBones = PartyBones(addressPartyBones);
    ...
    function createSkull(uint256 FacialBonesTokenId, uint256 AuditoryOssiclesTokenId, uint256 CranialBonesTokenId) whenNotPaused
    	public
    	returns (uint256)
    {   
        PartyStructures partyStructures = PartyStructures(addressPartyStructures);
