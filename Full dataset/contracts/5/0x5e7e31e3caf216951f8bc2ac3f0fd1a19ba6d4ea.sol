...
// Root file: contracts/protocol/modules/AGIUpdateModule.sol
...
/**
 * @title AGIUpdateModule
 * @author Set Protocol
 *
 * Single use module to remove duplicated component from array.
 */
contract AGIUpdateModule is ModuleBase {
    ...
    function removeComponent() external onlyManagerAndValidSet(setToken) {
        ...
        setToken.editDefaultPositionUnit(component, 0);
