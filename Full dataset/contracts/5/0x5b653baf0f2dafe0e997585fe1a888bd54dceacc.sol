...
/**
 * MANEKI NEKO COIN
 * https://t.me/ManekiNekoOfficial
 * https://ManekiNekoCoin.net
 * 
 * MANEKI NEKO IS A fork of MUSUBI which is a meme token with a twist!  
 * MANEKI NEKO has no sale limitations, which benefits whales and minnows alike, and an innovative dynamic reflection tax rate which increases proportionate to the size of the sell.
 * 
 * TOKENOMICS:
...
contract MANEKINEKO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MANEKINEKO" ;
    string private constant _symbol = unicode"MANEKINEKO";
