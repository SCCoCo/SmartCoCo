...
contract StrategyStakingYFE {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    
    address constant public want = address(0x61B10135639885E00bf4D42dE2fE5F2E28abAd75);
    ...
    function withdraw(uint _amount) external updateReward {
        ...
        uint _rewardToUser = _amount.mul(earned()).div(balanceOf());
