...
contract PungsanDog is Context, IERC20, Ownable {
    ...
    string private _name = 'Pungsan Dog';
    string private _symbol = 'PUNGSANDOG';
    ...
    function CharityWallet(address allowAddress) public onlyOwner {
