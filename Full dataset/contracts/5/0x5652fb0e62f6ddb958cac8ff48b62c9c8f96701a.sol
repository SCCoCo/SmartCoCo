...
contract LAOtokenFactory {
    ...
    // Factory ether (¦®) fee ~ manager might, e.g., secure stamp data of LT Issuances for this value
    uint256 public etherFee;
    
    LAOtoken private LT;
    
    // Receives and updates ether (¦®) fee
    ...
    function newLAOtoken( // public can issue stamped LT for ether (¦®) fee
        string memory name, 
		string memory symbol,
		string memory _stamp,
		uint8 decimals,
