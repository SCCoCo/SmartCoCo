...
// Insidual Token $DUAL - A DEFLATIONARY TOKEN WITH A PURPOSE
...
contract InsidualPlatformToken is Ownable, Inject, IERC20 {
    ...
    // Token
    string public name = "Insidual Platform Token";
