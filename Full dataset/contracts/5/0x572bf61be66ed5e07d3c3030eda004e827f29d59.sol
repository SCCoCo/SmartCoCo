...
contract RootBridge is BaseBridge {
    ...
    //®ê®è®ê®è®ê®è®ê®è®ê®è®ê®è®ê®è®ê®è add state variables below ®ê®è®ê®è®ê®è®ê®è®ê®è®ê®è®ê®è®ê®è//

    //®ç®é®ç®é®ç®é®ç®é®ç®é®ç®é®ç®é®ç®é add state variables above ®ç®é®ç®é®ç®é®ç®é®ç®é®ç®é®ç®é®ç®é//
