...
contract FRONTRUNN3R is Ownable {
  using SafeMath for uint256;

  string public constant name = "FRONTRUNN3R";
  string public constant symbol = "FT3R";
  uint256 public constant decimals = 18;
  // the supply will not exceed 5,000 FT3R
  uint256 private constant _maximumSupply = 5000 * 10 ** decimals;
