...
contract FMT is StandardToken, Ownable {
  using SafeMath for uint256;
  string public name = "FULL MOON TOKEN";
  string public symbol = "0xFM";
  ...
  uint256 public regStartTime = 15198480; // 28 AUG 2019 20:00 GMT
