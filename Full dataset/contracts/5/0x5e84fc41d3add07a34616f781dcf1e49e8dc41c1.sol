...
contract LPTokenWrapper {
    ...
    IERC20 public lp = IERC20(0xFe7308D6Ba8A64a189074f3c83a6cC56Fc13B3aF);
...
contract Unipool is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    modifier notLocked() {
        require(block.timestamp >= periodFinish, "notLocked: Staking has not been released!");
        _;
    }
    ...
    function withdraw(uint256 amount) public notLocked updateReward(msg.sender) {
    ...
    function lockedDetails() external view returns (bool, uint256) {
        bool locked = periodFinish >= block.timestamp;
        return (locked, periodFinish);
    }
}