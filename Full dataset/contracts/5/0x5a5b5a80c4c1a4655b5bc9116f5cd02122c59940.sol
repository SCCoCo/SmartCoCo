...
// File: contracts\token\MedinomicsHealthToken.sol

// contracts/token/MedinomicsHealthToken.sol
...
contract MedinomicsHealthToken is ERC20,
    ERC20Capped,
    ERC20Burnable,
    ERC20Pausable,
    Ownable {
    ...
    constructor(
        ...
        address wallet2,
        address wallet3
    ) public ERC20("Medinomics Health Token", "MHT") ERC20Capped(100000000 * (10**uint256(8))) {
        _setupDecimals(8);
        _mint(wallet1, 10000000 * (10**uint256(8)));
        _mint(wallet2, 20000000 * (10**uint256(8)));
        _mint(wallet3, 70000000 * (10**uint256(8)));
    }
