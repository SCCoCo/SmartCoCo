...
{using SafeMath for uint256;
   string public constant symbol = "Nestle.SA(SWX:NESN)";
     string public constant name = "Nestle.SA(SWX:NESN).Nestl¨¦ S.A. is a Swiss multinational food and drink processing conglomerate corporation headquartered in Vevey, Vaud, Switzerland. It is the largest food company in the world";
