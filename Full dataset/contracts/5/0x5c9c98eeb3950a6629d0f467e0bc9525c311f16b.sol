...
Crypto is a foggy place. Come join us to ride out the storm while we get ready to fly to the moon!

A community trusted coin that rewards its holders with a staking system bringing in great rewards per hour! Staking system is in development and will be released within the week.

ℹ️ What we provide:
→ Fair Launch - No Buy/Sell Fees 🚀
→ Staking Program due to be released within the week along with a Lottery-based system 💰
→ Whitepaper released tomorrow! 📔
→ Locked Liquidity and Renounced Ownership - know that your funds are safe and the contract is owned by the community 🔐
...
contract StormyFinance is Context, IERC20, Ownable {
    ...
    uint256 private _totalTokens = 50000000000000 * 10**18;
    string private _name = 'Stormy.Finance';
    string private _symbol = 'STORM⛈';
    uint8 private _decimals = 18;    
    uint256 private rTotal = 50000000000000 * 10**18;
