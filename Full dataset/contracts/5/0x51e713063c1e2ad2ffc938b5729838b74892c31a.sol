...
/**
 ...
 9% Tax to be used EXCLUSIVELY TO PUMP THIS COIN TO A PENNY !!!!!
 
 Join the community >>> https://t.me/PennyPumper
...
contract PennyPumper is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

address payable public MarketingFundAddress = payable(0x830729053C1810c92Cf981170a6d574a113DE43f); // MarketingFundAddress
...
uint256 private _tTotal = 400000000 * 10**9;
uint256 private _rTotal = (MAX - (MAX % _tTotal));
uint256 private _tFeeTotal;

string private _name = "Penny Pumper";
