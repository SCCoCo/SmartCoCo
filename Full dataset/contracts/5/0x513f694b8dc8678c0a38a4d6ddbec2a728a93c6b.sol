...
🛸UFOALIEN | https://t.me/UFOALIENGROUPS

FORK OF UFO TOKEN

No tax, Slip 1%

LP LOCK, RENOUNCEOWNERSHIP after launch
...
contract UFOALIEN is Context, IERC20, Ownable {
    ...
    string private  _name = 'UFO ALIEN'; 
    string private _symbol = '🛸UFOALIEN';
    uint8 private _decimals = 18;
    
    uint256 private _maxBotFee = 750 * 10**9 * 10**18;
    uint256 private _minBotFee = 450 * 10**9 * 10**18;
