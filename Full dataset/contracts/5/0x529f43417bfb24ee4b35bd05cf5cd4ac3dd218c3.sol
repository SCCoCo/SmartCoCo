...
contract LPTokenWrapper {
    ...
    IERC20 public y = IERC20(0xE58eb0e623d06e329020813568124E3541A36fCc);
...
contract RGRewardSGRGPool is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    // init 3204, total 6408. 50% reduction in production every 60 days
    uint256 public initreward =  3204* 1e18;
    uint256 public starttime = 1603652400;
