...
contract could is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "could";                                  // name
    string private _symbol = "could";                                // symbol
    uint256 private _tTotal = 20000000 * 10**uint256(_decimals);    // total supply
