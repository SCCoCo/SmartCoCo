...
*/ 
// Welcome to RaidenInu. This is purely a community project and I will be watching from the gifting from the shadows...
// Rules and terms are as follows:
// 5 eth liquidity, 2.5% max buy for first 5 minutes.
// If there is traction lock will be extended from a day to a week!
// Bots who buy on block 0 will be blacklisted before ownership is renounced
// 1% dev wallet address
// Ownership will be renounced

// GIFTS - I will be watching... :
// First person to create telegram under the name 'RaidenInuToken' and moderate it will be gifted 1% circulating supply.
// First person to create twtiter under the name 'RaidenInuToken' and moderate it will be gifted 1% circulating supply. 
// This will come from a preloaded 2% wallet
...
contract RaidenInu is Context, IERC20, Ownable {
    ...
    string private _name = "RaidenInu";
