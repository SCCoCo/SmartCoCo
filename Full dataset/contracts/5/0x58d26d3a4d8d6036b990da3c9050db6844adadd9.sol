...
contract uFragments is ERC20, Ownable {
    ...
    /// @notice Creates `_amount` token to `_to`. Must only be called by the monetaryPolicy (Farm).
...
// MasterChef is the master of Sushi/USDCow. He can make Sushi/USDCow and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once SUSHI/USDCow is sufficiently
...
contract MasterChef is Ownable {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of SUSHIs/USDCows/USDCs
    ...
    // The SUSHI/USDCow TOKEN!
    uFragments public sushi;
    // Dev address.
    address public devaddr;
    // SUSHI/USDCow tokens created per block.
    ...
    // The block number when SUSHI/USDCow mining starts.
    ...
    // Update the given pool's SUSHI/USDCow allocation point. Can only be called by the owner.
