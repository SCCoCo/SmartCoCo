...
contract GXNToken is MintableToken {

  string public constant name = "GXN";

  string public constant symbol = "GXN";

  uint8 public constant decimals = 18;



  // Total supply of gxn tokens is 10 Billion
