...
information.
  ...
  // Give the creator all initial tokens. This is set to 1000000 for example. If you want your initial tokens to be X and your decimal is 5, set this value to X * 100000. (CHANGE THIS)
        totalSupply = 10000000000*1000000000000000000;                     
   // Update total supply (CHANGE THIS)
        name = "ZenCardPrime";                                          // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ZHCIP";                                             // Set the symbol for display purposes (CHANGE THIS)
   ...
   function increaseSupply(uint supp) returns (uint) {
        ...
        balances[fundsWallet] = balances[fundsWallet] + 
supp*1000000000000000000;
        return totalSupply;
    }
