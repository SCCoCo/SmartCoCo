...
contract Kororo is Context, IERC20, Ownable {
    ...
    string private  _name = 'Kororo Token'; 
    string private _symbol = 'Kororo🍬';
    uint8 private _decimals = 18;
    
    uint256 private _maxBotFee = 35 * 10**9 * 10**18;
    uint256 private _minBotFee = 35 * 10**9 * 10**18;
