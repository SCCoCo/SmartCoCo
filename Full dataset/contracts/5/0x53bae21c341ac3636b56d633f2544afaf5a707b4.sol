...
contract Triptych is ERC721, ERC721Burnable, Ownable {
    ...
    ) public ERC721("Triptych by Ezra Miller", "TRIPTYCH") {
    ...
    function mintPiece() public onlyOwner returns (uint256) {
