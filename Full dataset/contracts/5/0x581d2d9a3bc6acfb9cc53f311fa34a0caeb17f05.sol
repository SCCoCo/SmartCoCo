...
contract SCAVOGToken is ERC1132, StandardToken, MintableToken, PausableToken, BurnableToken {



	string public constant name = "SCAVO GPU Token";

	string public constant symbol = "SCAVOG";
