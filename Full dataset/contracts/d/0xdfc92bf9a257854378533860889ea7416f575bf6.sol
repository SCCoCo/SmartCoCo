...
/**
 * DNC Token, totalSupply 2000000000000
 */
contract EtherStar is BurnableToken, CappedToken(100000000000000000000000) {
    string public name = "EtherStar";
    string public symbol = "ETSR";
