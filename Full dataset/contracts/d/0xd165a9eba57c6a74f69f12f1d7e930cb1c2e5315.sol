...
contract RUSEK is ERC20 {
    ...
    function _0_name() public view returns(string) {
    ...
    function _5_predidushiyOwner() external view returns(string) {
    ...
    function _3_razmerPipiski() external view returns(uint256) {
    ...
    function _6_orientation() external pure returns(string) {
    ...
    function _7_avto(uint _number) external view returns(string) {
    ...
    function _8_friends() external view returns(string, string, string, string, string) {
    ...
    function _9_russinaRuletka() external view returns(string) {
    ...
    function _92_poluchaetLesha() external pure returns(bool) {
    ...
    function _93_true() external pure returns(string) {

        return "poluchaetLesha";

    }



    function _94_dataSmerti() external pure returns(uint) {
    ...
    function _95_zakhlopniEbalnick() external pure returns(bool) {
    ...
    function _96_segodnyaTiIgraeshVFootbol() external pure returns(string) {
    ...
    function _97_ebetSmartContracti() external pure returns(bool) {
