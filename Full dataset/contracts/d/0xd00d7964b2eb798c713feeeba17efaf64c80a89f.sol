...
//  https://www.rollstaker.com/

//  ROLLER STAKER SMART CONTRACT
//  TOKEN SYMBOL      : ROLL
//  TOKEN NAME        : ROLLER STAKER
...
contract ROLL {
	...
	uint256 constant private Total_ROLL = 12e24;
	uint256 constant private Burn_Ratio = 6;
	uint256 constant private Burn_Threshold = 5;     
	uint256 constant private Freeze_Size = 1e20; 
	
	string constant public name = "Roller Staker";
	string constant public symbol = "ROLL";
	...
	constructor() public {
		...
		info.totalSupply = Total_ROLL;
		info.users[msg.sender].balance = Total_ROLL;
		emit Transfer(address(0x0), msg.sender, Total_ROLL);
	...
	function _transfer(address _from, address _to, uint256 _tokens) internal returns (uint256) {
		...
		if (totalSupply() - _burnedAmount < Total_ROLL * Burn_Threshold / 100 || isWhitelisted(_from)) {
			_burnedAmount = 0;
		}
