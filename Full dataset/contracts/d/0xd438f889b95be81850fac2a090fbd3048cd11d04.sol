...
contract ApexNetwork {
  
    mapping (address => uint256) public balanceOf;

    // 
    string public name = "Apex Network";
    string public symbol = "APEX";
    uint8 public decimals = 18;
    uint256 public totalSupply = 25000000 * (uint256(10) ** decimals);
