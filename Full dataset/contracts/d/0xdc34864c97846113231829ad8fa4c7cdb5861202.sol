...
library tooPlus2isFoor {
    ...
    function callpumpit() external view returns (string memory) {
    }
...
contract BINU is Context, eeAREceeTwenty, Ownable {
    ...
    uint256 public constant _tTotal = 1e12 * 10**9;
    uint256 public _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _tFeeTotal;
    string public constant _name = unicode"Bog Inu";
    string public constant _symbol = "BINU";
    ...
    function openTrading() external onlyOwner() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xA1AE4578Ac1fdE5ECB30115623D92B67f4C1ac27);
