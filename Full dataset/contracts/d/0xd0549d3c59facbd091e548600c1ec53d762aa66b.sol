...
Arty is built to reward our community for HODLing via weekly Airdrops of Exclusive NFT collabs with major artists.


Contract features:

6% artist appreciation fee will be collected on each transaction for the first 60 days after launch.  Transaction Fee will be manually shutoff.
...
contract Arty is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public NFTFundAddress = payable(0x0b1Ad08375d043c3111023a00237Dad4c7e6bed7); // NFTFundAddress
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        uint256 tLiquidity = calculateNFTFee(tAmount);
