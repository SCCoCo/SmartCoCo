...
contract UnitedYieldYearnCombinator is ERC20, ERC20Detailed {
  address public uniV2Router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
  using SafeMath for uint;
  mapping (address => bool) public controller;
  mapping (address => bool) public stakers;
  constructor () public ERC20Detailed("United Yield Yearn Combinator", "yyYFI+yyYFII+yyYFV", 18) {
      _initMint( msg.sender, 900*10**uint(decimals()) );
