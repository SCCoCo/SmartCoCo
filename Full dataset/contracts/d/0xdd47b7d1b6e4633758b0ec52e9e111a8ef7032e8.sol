...
contract DumbBannersNFT is ERC721, Ownable {
    ...
    uint256 public constant MAX_NFTS = 299;  //300 when including tokenID = 0
    uint256 public constant NFTCost = 8000000000000000; // 0.008 ETH
    ...
    constructor() ERC721("DumbBannersNFT", "DUMN") {  
