...
$$ |      $$ |$$ |  $$ |$$  _$$<  $$ |$$ |  $$  __$$ | \____$$\   $$ |$$\ 
$$ |      $$ |\$$$$$$  |$$ | \$$\ $$ |$$ |  \$$$$$$$ |$$$$$$$  |  \$$$$  |
\__|      \__| \______/ \__|  \__|\__|\__|   \_______|\_______/    \____/

 *Submitted for verification at 
*/

// $FlokiFast
// Telegram: https://t.me/FlokiFast
// Website: www.flokifast.xyz
// Introducing the fastest coin on the blockchain to only go up. 
// 20%+ Slippage
...
contract FlokiFast is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlokiFast";
    string private constant _symbol = "FlokiFast";
