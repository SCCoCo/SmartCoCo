...
contract YTrustStaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // YTrust.finance token contract address
    address public constant tokenAddress = 0x602cEEB08ad20A73312bbF8fd32B559915EaB15F;
    ...
    uint public constant cliffTime = 72 hours;   // Minimum Staking Period is 3 Days
    ...
    // Project Staking upto 30,000 YFID     // 18 Decimals
