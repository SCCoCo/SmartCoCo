...
contract XPVToken is MintableToken, PausableToken, BurnableToken {
    string public name = "Mark XPV";
    string public symbol = "mXPV";
    uint8 public decimals = 18; 
    uint256 public  initialSupply = 8000000000 * (10 ** uint256(decimals));
    // Constructor
    constructor() public {
    ...
    function () external payable {
        revert("XPVToken: Don't accept ETH");
    }
      // Only owner can kill
