...
/*****************************************************************************
 * @title LSDFinance
 * @dev LSDFinance is an ERC20 implementation of the LSDFinance ecosystem token. 
...
contract LSDFinance is Ownable, ERC20Pausable {
    string public constant name = "LSD Finance";
    string public constant symbol = "LSD";
    uint8 public constant decimals = 18;

    uint256 public constant initialSupply = 13000*10**uint256(decimals);
