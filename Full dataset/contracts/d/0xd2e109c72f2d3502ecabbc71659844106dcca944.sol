 ...
 */
contract TNFMToken is ERC20Mintable, ERC20Detailed {
    ...
    constructor(address initialOwner, address recipient) public ERC20Detailed("New Format", "TNFM", 6) Ownable(initialOwner) {
        _mint(recipient, 34200e6);
    }
