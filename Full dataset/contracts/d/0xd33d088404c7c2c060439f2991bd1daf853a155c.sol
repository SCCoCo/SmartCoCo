...
// File: contracts/STCL_ChristiePunks.sol

contract STCL_ChristiePunks is ERC721, Ownable {
    string public constant name = "The Christies";
    string public constant symbol = "CHЯISTIE";
    ...
    function mintPunk( string calldata _name, string calldata _json, string calldata _img ) external onlyOwner returns (uint) {
