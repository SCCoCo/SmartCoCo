...
ViceToken is built upon the fundamentals of Friendly Whale Buybacks and increasing the investor's value
...
contract ViceToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe2AB214aFeEdC1f2ad156A031C706b6FD0036AD4); // Marketing Address
    ...
    string private _name = "ViceToken";
    string private _symbol = "VICEx";
