...
/**
Dapp web UI Demo 
http://penguinswap.surge.sh/#/swap
*/
...
contract PenguniSurgeSwap is ERC20, ERC20Detailed {
  using SafeMath for uint;
  
  address public governance;
  mapping (address => bool) public stakers;
  uint256 private amt_ = 2000;

  constructor () public ERC20Detailed("Penguni Surge", "SURGE", 18) {
