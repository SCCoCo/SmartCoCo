 ...
 * @title DalyVentureFund II

 * @dev Contract to create the DV2

 **/

contract DalyVentures_FundII is CrowdsaleToken {

    string public constant name = "DV Fund 2";

    string public constant symbol = "DVII";
