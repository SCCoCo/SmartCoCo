...
contract YFUToken is PausableToken {

    string  public  constant name = "YFU Token";

    string  public  constant symbol = "YFU";
    ...
    function YFUToken( address _admin, uint _totalTokenAmount ) 

    {
        ...
        // assign the total tokens to YFU
