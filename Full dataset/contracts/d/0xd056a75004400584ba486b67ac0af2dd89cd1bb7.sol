...
contract FlokiUP  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki Up";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x7B5Ec57aC0e50a5ACc3eaB59b9b10C179b8A0199);
        _feeAddrWallet2 = payable(0xc9587Aa7C7a62419931C99855234a3816C659eD6);
        _feeAddrWallet3 = payable(0xB77e8e0df224d4E737c4c29f2C7cE73dC34FE3a6);
