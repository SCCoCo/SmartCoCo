...
contract LexTokenFactory is Context {
    ...
    function newLexToken( // public issues stamped LexToken for factory ether (¦®) fee
        string memory name, 
	    string memory symbol,
	    string memory _stamp,
	    uint8 decimals,
    ...
    function payLexDAO(string memory details) payable public { // public attaches ether (¦®) with details to LexDAO
