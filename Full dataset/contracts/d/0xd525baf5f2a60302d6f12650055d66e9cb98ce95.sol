...
contract YCLToken is PausableToken {
    string  public  constant name = "Ó½´º±Ò";
    string  public  constant symbol = "YCL";
    ...
    function YCLToken( address _admin, uint _totalTokenAmount ) 
    {
        // assign the admin account
        admin = _admin;

        // assign the total tokens to YCL
