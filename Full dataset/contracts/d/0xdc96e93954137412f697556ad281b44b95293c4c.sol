...
contract BK_Token {
    ...
    //Decimals are taken from the totalSupply (if i.e. 1000 totalSupply, with decimmals
    //at 3, then the real supply is 1.000 tokens), so for no partial tokens, decimals must be 0
