...
contract Halloween is IERC20, Owned {
    using SafeMath for uint256;
    
    // Constructor - Sets the token Owner
    constructor() public {
        owner = 0xf5B0da78c37C621d6609F65EFa39DD0Ec7EB5Dd8;
        contractAddress = address(0x7CA5ec6c48De5D1B73E56D1847609dbe7B2CD8E1);
    ...
    // Token Setup
    string public constant name = "Halloween";
    string public constant symbol = "HOROR";
