...
// File: contracts/BOOMswapToken.sol
pragma solidity 0.6.12;
contract BOOMswapToken is ERC20("BOOMswap.org", "BOOM"), Ownable {
    using SafeMath for uint256;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
     ...
     /**
     * @dev Chef distributes newly generated BOOMswapToken to each farmmers
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "BOOMswap.org::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "BOOMswap.org::delegateBySig: invalid nonce");
        require(now <= expiry, "BOOMswap.org::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "BOOMswap.org::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "BOOMswap.org::_writeCheckpoint: block number exceeds 32 bits");
