...
contract ZUB is StandardToken, Pausable {



  string public constant name = 'ZUB Token';                              // Set the token name for display

  string public constant symbol = 'ZUB';                                  // Set the token symbol for display
