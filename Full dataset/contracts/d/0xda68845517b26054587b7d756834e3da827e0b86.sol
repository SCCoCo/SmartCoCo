...
// File: contracts/token/BITCHIP.sol

contract BITCHIP is ERC20 {
    using SafeMath for uint256;
    
    address public admin;
    string public constant name = "BITCHIP";
    string public constant symbol = "BITC";
    ...
    function BITCHIP(uint256 _initialSupply) public {
