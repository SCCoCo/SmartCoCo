...
contract StarLinkDogelon is Context, IERC20, Ownable {
    ...
    string private _name = 'StarLink Dogelon | https://t.me/starlinkdogelon';
    string private _symbol = 'STARLDOGE';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256, uint256,uint256,uint256) {
        ...
        _localVal[2]/**tholder*/ = tAmount.div(100).mul(25);
