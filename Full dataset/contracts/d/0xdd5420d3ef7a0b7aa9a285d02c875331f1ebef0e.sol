...
contract MJCOIN is Ownable, StandardToken, InvestorsFeature  {
    

  string public constant name = "MJCOIN";
  string public constant symbol = "MJC";
  uint8 public constant decimals = 8;
  
  uint256 public constant INITIAL_SUPPLY = (1000 * (10**6)) * (10 ** uint256(decimals));
  uint public constant weiPerToken = 1 ether / (3000 * (10 ** uint(decimals)));
  
  
  
  function MJCOIN() public {
