...
contract MAV is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MAV() {
        ...
        name = "MAV";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MAV";                                             // Set the symbol for display purposes (CHANGE THIS)
