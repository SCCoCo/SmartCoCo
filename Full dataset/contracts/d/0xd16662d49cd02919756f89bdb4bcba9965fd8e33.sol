...
/*
    ...
    @@@@@@@@@@@@@@@@@@@@@@@@@OOOOOOOO[.                              ,[[email protected]@@@@@@@@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@@@@@OOOOOO/`                                        ,\[email protected]@@@@@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@@OOOOOO[        ,]OOOO`                                .[[email protected]@@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@OOOOO[        ,OOOOOOOO^                                   .\[email protected]@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@OOOO/.        .OOOO[..=OOO                                      ,[email protected]@@@@@@@@@@@@@
    @@@@@@@@@@@@@OOOO/          ,OOO^.....OOO.                                       .\[email protected]@@@@@@@@@@@
    @@@@@@@@@@@OOOO/           .OOO^......\OO^    ,]/OOO^                              .\[email protected]@@@@@@@@@
    @@@@@@@@@OOOOO.            =OOO.......=OOOOOOOOOOOOOO.                               ,[email protected]@@@@@@@@
    @@@@@@@@OOOO^              =OOO........OOOOO/[....OOO^                                 \[email protected]@@@@@@
    @@@@@@@OOOO.               .OOO`.................*OOO.                                  ,[email protected]@@@@@
    @@@@@@OOO/                  =OOO`................/OO^                                    [email protected]@@@@
    @@@@@OOO/                   ,OOOO^.............,OOO/                                      [email protected]@@@
    @@@@OOO/                  ,OOOO[............,/OOOO`                                        [email protected]@@
    @@@OOOO                 ,OOOO`.....,/OOOOOOOOOOO`                                           [email protected]@
    @@OOOO.               ,OOOO`.....,ooOOOO[[[[`.                                               ,[email protected]
    @@OOO^               /OOO`.....,ooooOOO^                                                      [email protected]
    ...
    @OOO\          =OOOo*............................................................=OO^          OOOO
    @OOOO`         .OOOo\..................*OO\......................................=OO^         [email protected]
    @@OOOO          =OOOo\.................=OOO...,OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO^        [email protected]
    @@@OOO^          \OOOo\................=OOO    [OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO^        /[email protected]@
    @@@OOOO^          \OOOoo`....]]........=OOO       .....=OO^....=OO^....=OO^......OOO.       [email protected]@@
    @@@@OOOO`          \OOOooo`.=OOO\......=OOO           .OOO`   .OOO`    OOO`   ../OO^       [email protected]@@
    @@@@@OOOO`          ,OOOOooo],OOOO\*...=OOO           /OO^    /OO^    /OO/   ../OO/       [email protected]@@@
    @@@@@@OOOO^          .\OOOOoooo/OOOOO\`=OOO         .OOO/    OOO/    /OO/   .,OOO/       /[email protected]@@@@
    @@@@@@@OOOO\.          ,OOOOOooOOOOOOOOOOOO         .OO^    .OO^    .\O^  ../OOO`      ,[email protected]@@@@@@
    @@@@@@@@@OOOO`           ,OOOOOOOO`   ,[OOO                             .,OOOO/       /[email protected]@@@@@@@
    @@@@@@@@@@OOOOO.           ,\OOOO]                                   .,/OOOO`       ,[email protected]@@@@@@@@
    @@@@@@@@@@@@OOOO\.            ,OOOOO\]                           .,/OOOOO/.       ,[email protected]@@@@@@@@@@
    @@@@@@@@@@@@@@OOOO\.             ,\OOOOOOO\]`.            .,]/OOOOOOO/`         ,[email protected]@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@OOOOO`               .[\OOOOOOOOOOOOOOOOOOOOOOOO/[.           ][email protected]@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@OOOOOO`                    .[[[[[[[[[[[`.                ,[email protected]@@@@@@@@@@@@@@@@
    @@@@@@@@@@@@@@@@@@@@@OOOOOO].                                          .][email protected]@@@@@@@@@@@@@@@@@@@
