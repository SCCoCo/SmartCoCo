...
contract Balancer is IExchange, AdapterStorage {
        ...
        override
    {
        ...
        IBalancerProxy(exchangeProxy).multihopBatchSwapExactIn{value: value}(
            data.swaps,
            fromToken,
            toToken,
            fromAmount,
        ...
        override
    {
        ...
        IBalancerProxy(exchangeProxy).multihopBatchSwapExactOut{value: value}(
            data.swaps,
            fromToken,
            toToken,
            fromAmount
    ...
    function getKey() public override pure returns(bytes32) {
      return keccak256(abi.encodePacked("Balancer", "1.0.0"));
    }
