...
contract GAMERDevRewards is Ownable {
    ...
    function claimRewards() public onlyOwner {
        ...
        uint256 trueRewards = reward.mul(scalingFactor).div(10**18);
        gamer.mint(msg.sender, trueRewards);
        emit RewardPaid(trueRewards);
    }
}