...
contract whitelistICO is Crowdsale {
    ...
    constructor(address _AS, address _multisig, uint _priceETH, uint _startWhiteListUNIX, uint _periodWhitelistSEC, uint _indCap) public {
        ...
        multisig = _multisig; // §Ñ§Õ§â§Ö§ã §Õ§Ý§ñ §á§à§Ý§å§é§Ö§ß§Ú§ñ §ï§æ§Ú§â§à§Ó

        bonuses1 = 50; // §Ò§à§ß§å§ã§ß§í§Û §á§â§à§è§Ö§ß§ä §ß§Ñ §ï§ä§Ñ§á§Ö §á§â§Ö§ã§Ö§Û§Ý§Ñ

        startWhitelist = _startWhiteListUNIX; // §Ó§â§Ö§Þ§ñ §ß§Ñ§é§Ñ§Ý§Ñ §á§â§Ö§ã§Ö§Û§Ý§Ñ UNIX

        periodWhitelist = _periodWhitelistSEC; // §ã§â§à§Ü §á§â§Ö§ã§Ö§Û§Ý§Ñ §Ó §ã§Ö§Ü§å§ß§Õ§Ñ§ç

        rateInUsd = 10; // §ã§ä§à§Ú§Þ§à§ã§ä§î §ä§à§Ü§Ö§ß§Ñ §Ó §è§Ö§ß§ä§Ñ§ç
...
contract preICO is Crowdsale {
    ...
    constructor(address _AS, address _multisig, uint _priceETH, uint _startPreIcoUNIX, uint _periodPreIcoSEC, uint _indCap) public {
        ...
        bonuses2 = 20; // §Ò§à§ß§å§ã§ß§í§Û §á§â§à§è§Ö§ß§ä §ß§Ñ §ï§ä§Ñ§á§Ö preICO

        startPreIco = _startPreIcoUNIX; // §Ó§â§Ö§Þ§ñ §ß§Ñ§é§Ñ§Ý§Ñ preICO UNIX

        periodPreIco = _periodPreIcoSEC; // §ã§â§à§Ü preICO §Ó §ã§Ö§Ü§å§ß§Õ§Ñ§ç
...
contract mainICO is Crowdsale {
    ...
    constructor(address _AS, address _multisig, uint _priceETH, uint _startIcoUNIX, uint _periodIcoSEC, uint _indCap) public {
        ...
        startIco = _startIcoUNIX; // §Ó§â§Ö§Þ§ñ §ß§Ñ§é§Ñ§Ý§Ñ ICO UNIX

        periodIco = _periodIcoSEC; // §ã§â§à§Ü ICO §Ó §ã§Ö§Ü§å§ß§Õ§Ñ§ç
