 ...
 * overflow check, thereby saving gas. This does assume however correct usage, in that the underlying `value` is never
 * directly accessed.
 */
library Counters {
...
/**
 * @title ArtCar
 * ArtCar - a contract for my non-fungible ArtCars.
 */
