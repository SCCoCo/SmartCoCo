...
Twitter: @pitquidity
Website: www.pitquidity.io
Whitepaper: https://12bfe257-cf0c-5f93-140b-249f8e8aa6ac.filesusr.com/ugd/c51a34_629bd0edff0343fb83362e728280fef1.pdf?index=true
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xc1d5D6c3557bDaB520d564D987eaA40652f60dbd), 1000);
        m_DidDeploy = true;
    }
...
contract Pitquidity is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000 * 10**9;
    string private m_Name = "Pitquidity";
    string private m_Symbol = "PITQD";
    ...
    function addLiquidity() external onlyOwner() {
        ...
        FTPLiqLock(m_LiqLockSvcAddress).lockTokens(m_UniswapV2Pair, block.timestamp.add(360 days), msg.sender);
