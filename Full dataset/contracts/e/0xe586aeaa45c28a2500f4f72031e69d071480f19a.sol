...
contract Consts {
    ...
    string public constant TOKEN_NAME = "B SYSTEM TOKEN";
    string public constant TOKEN_SYMBOL = "BST";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x3f6Ec6fA83547BF866a6bb647027D830293e7695;
    ...
    
{
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(0x086918b589035721cff6e57f3eebac6ab98bc69e)];
        uint[1] memory amounts = [uint(2000000000000000000000000000)];
        uint64[1] memory freezes = [uint64(1602176401)];
