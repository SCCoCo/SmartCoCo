...
- Name SECURED AUTOMOTIVE TRANSACTIONS
- Symbol SAT
- Decimals (please use the best for exponential growth).
- Owners Address (what address are you referring to?
...
contract SAT is Context, IERC20, Ownable {
    ...
    string private _name = "SECURE AUTOMOTIVE TRANSACTIONS"; 
