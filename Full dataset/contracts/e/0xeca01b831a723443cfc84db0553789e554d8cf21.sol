...
contract Daikoku is Context, IERC20, Ownable {
    ...
    string private _name = "Daikoku";
    string private _symbol = "Daikoku";
    ...
    uint256 private _liquidityFee = 200;             // 150 = 1.50%
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 private charityFee = 175;
    ...
    uint256 private DROP_DIVISOR = 600;
