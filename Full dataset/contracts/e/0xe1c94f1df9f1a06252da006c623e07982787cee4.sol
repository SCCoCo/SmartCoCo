...
interface IFeeApprover {
    ...
    function setfuelTokenAddress(address _fuelTokenAddress) external;
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    uint256 public constant initialSupply = 400e18; // 400
    ...
    function initialSetup() internal {
        ...
        _mint(address(msg.sender), 600e18);
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developers and affiliated parties of the fuel team are not responsible for your funds";
    ...
    function addLiquidityToUniswapfuelxWETHPair() public {
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                IfuelVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
...
contract fuel is NBUNIERC20 {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying fuel tokens (not scaled);
