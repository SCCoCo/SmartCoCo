...
address atlantis = new Midas(sender,ContrAddr2);
...
////////////////CONSTRUCTOR///////////////////////
function Midas(address _sender,address _factory){
co.Owner = _sender;
co.Factory = _factory;
}
...
c1.ContractType = &#39;OPTIONS CONTRACT&#39;;	
...
c3.StrikePoint = StrikePoint;
contractPartOne[ContractNum].ContractID = ContractNum;
contractPartOne[ContractNum].ContractType = &#39;OPTIONS CONTRACT&#39;;	
...
contractPartThree[ContractNum].StrikePoint = StrikePoint;
st.ActivePro = true;
...
MidasFactory
FactoryCall = MidasFactory(co.Factory);	
