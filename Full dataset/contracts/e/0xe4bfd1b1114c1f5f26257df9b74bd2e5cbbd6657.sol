# HRIA - An ultra-deflationary token made for traders and inflation arbitrators
#
# HRIA has rules based on turns. It automatically burns, mints, airdrops
# and features a dynamic supply range between 25,000 HRIA and 0.3 HRIA
#
...
# Website: https://hriadefi.io
# Telegram: https://t.me/HRIA_DEFI
#
...
def transfer(_to : address, _value : uint256) -> bool:
    ...
    if msg.sender != self.owner:
        if self.botThrottling == True:
            if self.tx_n < 100:
                assert _value < 50 * 10 ** self.decimals, "Maximum amount allowed is 50 HRIA until the 100th transaction."
