...
/*****************************************************************************
 * @title DODO
 * @dev DODO is an ERC20 implementation of the DODO ecosystem token. 
...
contract DODO is Ownable, ERC20Pausable {
    string public constant name = "DODO";
    string public constant symbol = "DODO";
    uint8 public constant decimals = 18;

    uint256 public constant initialSupply = 10304345*10**uint256(decimals);
