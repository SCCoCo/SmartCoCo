...
pragma solidity ^0.6.12;
    ...
    contract RunItUp is Context, IERC20, Ownable {
        ...
        string private _name = 'Run It Up';
        string private _symbol = 'RunUp';
        ...
        function _setTaxFee(uint256 taxFee) external onlyOwner() {
            require(taxFee >= 1 && taxFee <= 6, 'taxFee should be in 1 - 10');
            _taxFee = taxFee;
        }

        function _setCharityFee(uint256 charityFee) external onlyOwner() {
            require(charityFee >= 1 && charityFee <= 4, 'charityFee should be in 1 - 11');
