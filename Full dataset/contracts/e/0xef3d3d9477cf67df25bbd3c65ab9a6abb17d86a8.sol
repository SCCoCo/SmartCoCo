...
contract DONOTBUY is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "DONOTBUYTEST";                                                // name
    string private _symbol = "DONOTBUY";                                             // symbol
    ...
    address payable public marketingWallet = payable(0x8d1C858710aA8A6Ad00a305F310029B7560DeD77); // marketing wallet
