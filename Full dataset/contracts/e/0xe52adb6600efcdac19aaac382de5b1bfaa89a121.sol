...
contract WSCToken {
    ...
    string public name = "Wine Supply Chain";  //代币名称
    string public symbol = "WSC"; //代币标识
    uint8  public decimals = 8; //代币位数
    uint256 public totalSupply = 200000000 * 10 ** uint256(decimals); //代币发行总量
	...
	uint256 public burnedLimit = 10000000 * 10 ** uint256(decimals); //销毁代币到1千万,停止销毁
