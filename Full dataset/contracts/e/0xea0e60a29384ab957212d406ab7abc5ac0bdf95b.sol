...
contract Rover is Ownable {
    ...
    uint256 public constant vestingTime = 30*24*60*60; // 1 month
    ...
    constructor () public {
        basedGod = IBasedGod(0x3ec8552ef28912fcC1cAd7068a1df73C83bd6b00);
        rewardToken = IERC20(basedGod.weth());
        based = IERC20(basedGod.based());
        swapModule = 0xC0C07629d25c233aBdBfb4F5F28f6C026473c8d6;
        ...
        uint[] memory amountsOut = ISwapModule(swapModule).getAmountsOut(10**10, _path);
