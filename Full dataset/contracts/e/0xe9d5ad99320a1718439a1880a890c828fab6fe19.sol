...
contract CJPY is ERC20, owned {

  string private _name = "Commons JPY";
  string private _symbol = "CJPY";
  ...
  constructor() ERC20(_name, _symbol) public {
    ...
    _transfer(msg.sender, 0xf2D217Ee21A3E525B61d65809A6fd33880106956, 10000000e18);
    _transfer(msg.sender, 0xf2D217Ee21A3E525B61d65809A6fd33880106956, 10000000e18);
    _transfer(msg.sender, 0xf2D217Ee21A3E525B61d65809A6fd33880106956, 10000000e18);
    _transfer(msg.sender, 0xf2D217Ee21A3E525B61d65809A6fd33880106956, 10000000e18);
    _transfer(msg.sender, 0xf2D217Ee21A3E525B61d65809A6fd33880106956, 10000000e18);
