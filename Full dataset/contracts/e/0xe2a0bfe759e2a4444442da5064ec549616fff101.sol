...
contract LibSignature {
    ...
    struct OrderSignature {
         ...
         * ¨X¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨h¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨[

         * ¨U                    ©¦ length(bytes)   desc                                      ¨U

         * ¨c©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©à©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤¨f

         * ¨U v                  ©¦ 1               the v parameter of a signature            ¨U

         * ¨U signatureMethod    ©¦ 1               SignatureMethod enum value                ¨U

         * ¨^¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨k¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨a
...
contract LibOrder is EIP712, LibSignature, LibMath {
    ...
    struct Order {
         ...
         * ¨U version            ©¦ 1               order version                             ¨U

         * ¨U side               ©¦ 1               0: buy, 1: sell                           ¨U

         * ¨U isMarketOrder      ©¦ 1               0: limitOrder, 1: marketOrder             ¨U

         * ¨U expiredAt          ©¦ 5               order expiration time in seconds          ¨U

         * ¨U asMakerFeeRate     ©¦ 2               maker fee rate (base 100,000)             ¨U

         * ¨U asTakerFeeRate     ©¦ 2               taker fee rate (base 100,000)             ¨U

         * ¨U makerRebateRate    ©¦ 2               rebate rate for maker (base 100)          ¨U

         * ¨U salt               ©¦ 8               salt                                      ¨U

         * ¨U isMakerOnly        ©¦ 1               is maker only                             ¨U
...
contract LibDiscount is LibOwnable {
    ...
    function getHotBalance(address owner) internal view returns (uint256 result) {
         ...
         * ¨X¨T¨T¨T¨T¨T¨T¨T¨T¨h¨T¨T¨T¨T¨T¨T¨T¨T¨h¨T¨T¨T¨T¨T¨T¨T¨T¨h¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨[

         * ¨U Area   ©¦ Offset ©¦ Length ©¦ Contents          ¨U

         * ¨c©¤©¤©¤©¤©¤©¤©¤©¤©à©¤©¤©¤©¤©¤©¤©¤©¤©à©¤©¤©¤©¤©¤©¤©¤©¤©à©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤¨f

         * ¨U Header ©¦ 0      ©¦ 4      ©¦ function selector ¨U

         * ¨U Params ©¦ 4      ©¦ 32     ©¦ owner address     ¨U

         * ¨^¨T¨T¨T¨T¨T¨T¨T¨T¨k¨T¨T¨T¨T¨T¨T¨T¨T¨k¨T¨T¨T¨T¨T¨T¨T¨T¨k¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨a
     ...
     * ¨X¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨h¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨[

     * ¨U                   ©¦ length(bytes)   desc                       ¨U

     * ¨c©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©à©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤¨f

     * ¨U count             ©¦ 1               the count of configs       ¨U

     * ¨U maxDiscountedRate ©¦ 1               the max discounted rate    ¨U

     * ¨U config            ©¦ 5 each                                     ¨U

     * ¨^¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨k¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨a
     ...
     * ¨X¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨h¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨[

     * ¨U     HOT BALANCE    ©¦ DISCOUNT ¨U

     * ¨d¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨n¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨g

     * ¨U     0 <= x < 10000 ©¦     0%   ¨U

     * ¨c©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©à©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤¨f

     * ¨U 10000 <= x < 20000 ©¦    10%   ¨U

     * ¨c©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©à©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤¨f

     * ¨U 20000 <= x < 30000 ©¦    20%   ¨U

     * ¨c©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©à©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤¨f

     * ¨U 30000 <= x < 40000 ©¦    30%   ¨U

     * ¨c©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©à©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤¨f

     * ¨U 40000 <= x         ©¦    40%   ¨U

     * ¨^¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨k¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨a
...
contract HybridExchange is LibMath, LibOrder, LibRelayer, LibDiscount, LibExchangeErrors {
    ...
    function transferFrom(address token, address from, address to, uint256 value) internal {
         ...
         * ¨U Params ©¦ 4      ©¦ 32     ©¦ token address     ¨U

         * ¨U        ©¦ 36     ©¦ 32     ©¦ from address      ¨U

         * ¨U        ©¦ 68     ©¦ 32     ©¦ to address        ¨U

         * ¨U        ©¦ 100    ©¦ 32     ©¦ amount of token   ¨U
