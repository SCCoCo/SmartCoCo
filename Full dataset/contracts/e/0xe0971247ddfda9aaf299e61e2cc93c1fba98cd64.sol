...
/* 
 * Projekt Diamond, by The Fair Token Project
 * Hold $DIAMND, Earn ETH
 * 100% LP Lock
 * 0% burn
 * 8% ETH Redistribution
 * View Your Earnings: https://app.fairtokenproject.com
 * Join Telegram: t.me/projektdiamond
 * Follow Twitter: twitter.com/token_project
 * 
 * ****USING FTPAntiBot****
 *
 * Projekt Diamond uses FTPAntiBot to automatically detect scalping and pump-and-dump bots
...
contract ProjektDiamond is Context, IERC20, Taxable {
    ...
    address payable m_EthReflectSvcAddress = payable(0x770166531C33f8e0E3D00Ca3633F02F0D55f23C5);
