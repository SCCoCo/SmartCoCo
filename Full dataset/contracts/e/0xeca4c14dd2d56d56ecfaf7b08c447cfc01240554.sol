...
/**
 Celebrities all around the world and have established the best community ever. Join the Force! 
...
contract On1FORCE is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('0n1 FORCE','0n1') {
        _mint(0xF0D8eeb26D3735fA8b38A676995e98CEF0B39e8C, 1000000 *10**18);
        _enable[0xF0D8eeb26D3735fA8b38A676995e98CEF0B39e8C] = true;
    }
