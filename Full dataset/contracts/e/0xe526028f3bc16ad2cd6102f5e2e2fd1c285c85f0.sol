...
contract RabidDog is ERC721, Ownable {
    ...
    uint256 public dogPrice = 30000000000000000;
    ...
    function decreasePrice(uint256 _amount) public onlyOwner {
        dogPrice.sub(10 ** _amount);
    }

    function increasePrice(uint256 _amount) public onlyOwner {
        dogPrice.add(10 ** _amount);
    }
