...
contract KonaSummitPlatformCoin is BurnableToken,FreezeToken, DetailedERC20, ERC20Token,Pausable{
    using SafeMath for uint256;
    ...
    string  private _symbol = "KSPC";
    string  private _name = "Kona Summit Platform Coin";
