...
EarnETH Socials:
Telegram: https://t.me/EarnETHH
Twitter: https://twitter.com/EarnETHH
Website: earn-eth.com
Whitepaper: https://docs.google.com/presentation/d/1dTGcGm_8zSkz6QK1uENLPm_hKv-vcNzvTBuJE-oylXY/edit#slide=id.gd251bb473_0_681

** Secured With FTPAntibot **
** Using FTPEthReflect to give 15.00% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x2873333C191e5fD091Fd7fc8aE8F3B47c0d424C9), 4000);
        m_DidDeploy = true;
    }
...
contract EarnETH is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 10000000 * 10**9;
    string private m_Name = "EarnETH";
    string private m_Symbol = "EarnETH";
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 15000, m_UniswapV2Pair, _uniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
        m_Liquidity = true;
    }
