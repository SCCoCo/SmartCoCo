...
// CryptoRocket is the first decentralized virtual space development project and 100% community owned project, controlled via the DAO. $CRF is a governance token of CryptoRocket Ecosystem. Join the moon mission..

// ✅ Telegram: https://t.me/crypto_rocket_fin

// ✅ Website: https://cryptorocket.finance/
...
contract CryptoRocket is Context, IERC20, Ownable {
    ...
    string private _name = 'cryptorocket.finance';
    string private _symbol = 'CryptoRocket 🚀';
