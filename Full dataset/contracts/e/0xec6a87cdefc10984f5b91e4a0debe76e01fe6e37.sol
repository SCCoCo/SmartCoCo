...
contract TDMToken is MintableToken {
  string public constant name = "Tandem";
  string public constant symbol = "TDM";
  uint8 public constant decimals = 18;

  // Total supply of TDM tokens is 10 Billion
