...
/*
   ...
   Shibillion - Shiba Billion
   
   $Shibillion
   
   A Decentralized Digital Currency for
...
contract Shibillion is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shibillion | t.me/Shibillion";
    string private constant _symbol = "Shibillion";
