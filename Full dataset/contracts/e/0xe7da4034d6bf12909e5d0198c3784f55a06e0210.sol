...
/**
 *Submitted for ............ at Etherscan.io on 2019-10-12
*/
 ...
 * @dev Token representing Cash on Delivery.
 */
contract CashOnDelivery is BurnableToken {
  ...
  */
  constructor(address wallet) public {
    owner = wallet;
    totalSupply = uint(2500000000).mul(10 ** uint256(decimals)); //Update total supply with the decimal amount
