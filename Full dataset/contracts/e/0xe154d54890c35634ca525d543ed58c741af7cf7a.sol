...
// File: contracts/token/MEDIKEY.sol

contract MEDIKEY is ERC20 {
    using SafeMath for uint256;
    
    address public admin;
    string public constant name = "MEDIKEY";
    string public constant symbol = "MKEY";
    ...
    function MEDIKEY(uint256 _initialSupply) public {
