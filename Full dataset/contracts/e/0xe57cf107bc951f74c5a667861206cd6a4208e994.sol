...
/**
 *Submitted for verification at Etherscan.io on 2019-11-18, 11:15 PM, GMT+5:30
*/
...
// Symbol      : IONS
// Name        : IONS
// Total Supply: 27 Million (27000000)
// Decimals    : 18
// Price       : 1 USD
// RATE        : 100 (1 ETH = 181.81818 IONS)
...
contract Owned {
    ...
    constructor() public {
        owner = 0x9Ae01c0eA29981374E10596c61078Dc3F9074eAf;
    }
...
// ----------------------------------------------------------------------------
contract IONS is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "IONS";
        decimals = 18;
        _totalSupply = 27000000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 1818181; // 1 ETH = 1818 IONS
        DENOMINATOR = 10000; // 1 ETH = 181.81818 IO
