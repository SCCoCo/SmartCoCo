...
contract DigitalTradingCoin is StandardToken {



    string public constant name = "Digital Trading Coin";

    string public constant symbol = "DTCX";
    ...
    function DigitalTradingCoin(address _owner) public {
