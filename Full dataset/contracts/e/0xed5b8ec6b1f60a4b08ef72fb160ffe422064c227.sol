...
// Yield Token for Staking and Governance
...
// File: contracts/TrenderingYield.sol
...
/**
 * @title TrenderingYield
 * @author C based on source by https://github.com/vittominacori
 * @dev Implementation of the TrenderingYield
 */
contract TrenderingYield is ERC20Capped, ERC20Burnable, Roles, TokenRecover {
     ...
     */
    modifier canMint() {
        require(!_mintingFinished, "TrenderingYield: minting is finished");
        _;
    }
    ...
    modifier canTransfer(address from) {
        require(
            ...
            "TrenderingYield: transfer is not enabled or from does not have the OPERATOR role"
        );
        _;
    }
        ...
        ERC20(name, symbol)
    {
        require(
            ...
            "TrenderingYield: if finish minting, cap must be equal to initialSupply"
        );
