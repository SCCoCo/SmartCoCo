...
/*
 * 
 *  BitStash (STASH) token smart contract
...
/**
 * @title BitStash
 * @dev Implementation of the BitStash STASH erc20 token
 */
contract BitStash is ERC20Capped, ERC20Mintable, ERC20Burnable, ERC1363, TokenRecover, Roles {
