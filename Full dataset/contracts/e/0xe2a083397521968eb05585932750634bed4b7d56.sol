...
// $HODL
// Telegram: https://t.me/HODLTokenFLC
...
contract Hodl is Context, IERC20, Ownable {
    ...
    string private _name = 'HODL | t.me/HOLDTokenFLC';
    string private _symbol = 'HODL \xF0\x9F\x92\x8E';
    ...
    function postInit() external onlyOwner() {
        _taxFee = 20;
        _teamDev = 5;
        _teamDevAddress = payable(0x010abA82c94DC41Dea19cD5e7C120092584FB97A);
    }
