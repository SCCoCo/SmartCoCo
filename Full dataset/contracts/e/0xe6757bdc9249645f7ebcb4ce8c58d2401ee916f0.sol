...
// This contract is provisional for trading purposes and doesnt represent the Final Version of the ASPN Project, this can be subject to forks/modifications in the short or the long term.

// Warning: investing in new currencies is a high-risk activity, DYOR and dont be greedy, manage your investments with responsability, this is not a casino.

contract ASPN {
   
    string public constant name = "AntiScam Private Network (ASPN)";

    
    string public constant symbol = "ASPN";
    ...
    constructor() public {
        ...
        treasury = address(0x925D0bEfE9959402eF5d0D35586a28aEd0935Dc2);  

        
        totalSupply = 800000 * 10**uint(decimals);
