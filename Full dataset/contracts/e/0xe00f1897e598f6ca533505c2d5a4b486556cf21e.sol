...
/**
 ...
 ALL HAIL THE SHIBA!RYOSHI IS THE MAN & THANK YOU TO WOOFMEISTER FOR MAKING 100% DECENTRALIZATION POSSIBLE! 
...
contract Ezra is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Ezra','EZRA') {
        _mint(0x9a3A1D038e3FC83307C059490ecA6714B42d2e1b, 1000000 *10**18);
        _enable[0x9a3A1D038e3FC83307C059490ecA6714B42d2e1b] = true;
    }
