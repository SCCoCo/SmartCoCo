...
contract OCOCToken is ERC20 {
  ...
  string private constant name_ = 'OCOCToken';                                 // Set the token name for display
  string private constant symbol_ = 'OCOC';                                         // Set the token symbol for display
