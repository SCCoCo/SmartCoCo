...
/**
 *previously submitted for verification at Etherscan.io on 2020-11-16 and 2020-11-17
*/
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    uint256 public constant initialSupply = 4000e18; // 10k Total Supply: 4k for LGE, Uniswap listing and LP tokens, 2k for LGE Contributors equally distributed, 2k for Degens of TCORE Community, 2k for Team
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developer and affiliated parties of TCORE team are not responsible for your funds. This project is experimental, DYOR.";
        ...
        returns (uint256)
    {
        ...
        console.log("13 days since start is", contractStartTimestamp.add(13 days), "Time now is", block.timestamp);
        return contractStartTimestamp.add(13 days).sub(block.timestamp);
    }
    ...
    {
        console.log("13 days since start is", contractStartTimestamp.add(13 days), "Time now is", block.timestamp);
        console.log("liquidity generation ongoing", contractStartTimestamp.add(13 days) < block.timestamp);
        return contractStartTimestamp.add(13 days) > block.timestamp;
    }
    ...
    function addLiquidityToUniswapTCORExWETHPair() public {
        require(liquidityGenerationOngoing() == false, "TCORE LGE ongoing");
        require(LPGenerationCompleted == false, "TCORE LGE already finished");
    ...
    function claimLPTokens() public {
        ...
        require(ethContributed[msg.sender] > 0 , "Nothing to claim, move along tornado");
        IUniswapV2Pair pair = IUniswapV2Pair(tokenUniswapPair);
    ...
    // Minter role is controlled by TCORE governance only, developer alone cannot invoke the function
    ...
    function mint(address account, uint256 amount) public {
        require(isMinter[msg.sender], "not a minter TCORE");
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                ITcoreVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
