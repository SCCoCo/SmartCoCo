...
contract SYN is StandardToken, Pausable {
   ...
   constructor () public {
        ...
        symbol = "SYN";
        decimals = 18;
        totalSupply_ = 85e6 * 10  **  uint256(decimals); //85 millions
...
contract Sale is SYN{
    ...
    uint256 public tokenCostPrivate = 3; //3 cents i.e., .3$
    //price of token in cents
    uint256 public tokenCostPre = 4; //4 cents i.e., .4$
    //price of token in cents
    uint256 public tokenCostPublic = 5; //5 cents i.e., .5$
    ...
    */
    ...
    /*
    * To finish all sale, shoudl be executed only when no new sale needs to be started
    */
