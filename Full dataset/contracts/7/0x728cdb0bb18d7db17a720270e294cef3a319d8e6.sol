...
contract Token {
    ...
    string public constant name = "Edo Nihonbashi Premium Club";
    string public constant symbol = "ENPC";
    uint8 public constant decimals = 8;

    uint256 private constant INITIAL_SUPPLY = 150000000;
    uint256 public constant totalSupply = INITIAL_SUPPLY * 10 ** uint256(decimals);

    address public constant wallet = 0x7920b46Df541F926f304DAE58ea49F9e90Fd0841;
