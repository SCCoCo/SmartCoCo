...
contract LionaireToken is ERC20Interface, SafeMath {
    string constant public name = "Lionaire Token";
    string constant public symbol = "LNRE";
    uint8 constant public decimals = 18;
    uint256 constant public _totalSupply = 1000000*(10**uint256(decimals));
