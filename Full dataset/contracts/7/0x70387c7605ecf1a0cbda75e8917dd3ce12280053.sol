...
// File: contracts\PetrochainToken.sol



/**

 * @title Petrochain  Token

 * @dev Petrochain  Token - Token code for the Petrochain icoProject
...
contract PetrochainToken is CappedToken, PausableToken {



    string public constant name                 = "Petrochain Token";
...
contract Crowdsale {
  ...
  // So, if you are using a rate of 1 with a DetailedERC20 token with 3 decimals called PCT
...
// File: contracts\PetrochainCrowdsale.sol



/**

 * @title Petrochain ico Crowdsale Contract

 * @dev Petrochain ico Crowdsale Contract

 * The contract is for the crowdsale of the Petrochain  Token. It is:
...
contract PetrochainCrowdsale is 
     ...
     * @param _rate uint256 initial rate PCT for 1 ETH
     ...
     * @param _token PetrochainToken our token
     ...
     * @dev Perform the initial token distribution according to the Petrochain icocrowdsale rules
    ...
    */
    ...
    function finalization() internal {
        ...
        PetrochainToken PCTToken = PetrochainToken(token);

        PCTToken.finishMinting();
...
// File: contracts\PetrochainPresale.sol



/**

 * @title Petrochain icoPresale Contract

 * @dev Petrochain icoPresale Contract

 * The contract is for the private sale of the Petrochain  Token. It is:
