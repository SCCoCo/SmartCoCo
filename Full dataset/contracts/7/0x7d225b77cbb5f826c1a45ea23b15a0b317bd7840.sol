...
contract OBC is StandardToken{
    string public constant name = "Own Blockchain";
    string public constant symbol = "OBC";
    ...
    function OBC(address _target){
        owner = msg.sender;
        totalSupply = 78408*(10**4)*(10**decimals); //init planed totalnumber
