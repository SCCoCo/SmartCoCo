...
website: ebiswap.io
 ...
 _____ ____ ___ ____ _   _ _____ _____ 
| ____| __ )_ _/ ___| | | | ____|  ___|
|  _| |  _ \| | |   | |_| |  _| | |_   
| |___| |_) | | |___|  _  | |___|  _|  
|_____|____/___\____|_| |_|_____|_|    
...
contract EbiToken is StandardToken, Ownable {
    ...
    string public constant name = "Ebiswap.io";
    string public constant symbol = "EBI";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 1200000 * (10 ** uint256(decimals));
