...
// File: packages/contracts/src/ERC721Metadata.sol
...
// File: packages/contracts/src/MagicPixels.sol
...
contract MagicPixels is ERC721, ERC721Metadata, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721Metadata("MagicPixels", "MPX") public {
      _setBaseURI("http://magicjpeg-api.com/metadata/pixel/");
    }
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 16000) {
          return 1000000000000000000; // 16000 - 16384 1 ETH
        } else if (currentSupply >= 12000) {
          return 100000000000000000; // 12000  - 15999 0.1 ETH
        } else if (currentSupply >= 8000) {
          return 60000000000000000; // 8000 - 11999 0.06 ETH
        } else if (currentSupply >= 4000) {
          return 30000000000000000; // 4000 - 7999 0.03 ETH
        } else {
          return 10000000000000000; // 1000 - 3999 0.01 ETH
        }
    }
