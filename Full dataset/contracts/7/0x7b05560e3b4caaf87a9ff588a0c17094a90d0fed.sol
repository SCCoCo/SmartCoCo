...
contract DFQCToken is PausableToken {

    string  public  constant name = "DongFangQiChen Coin";

    string  public  constant symbol = "DFQC";
    ...
    function DFQCToken( address _admin, uint _totalTokenAmount ) 

    {
        ...
        // assign the total tokens to DFQC
