...
contract NftRelay is Governance{
    ...
    address private _randseed = address(0x2eE24b976564f9625de80dCd7b96c3306ff7607B);
    ...
    uint256 public apwr_amount = 8* 1e15;   // 0.008
    
    uint256 public _claimdays = 100 days;
    ...
    function setPoweramount( uint256 amount ) external onlyGovernance
    {
        apwr_amount = amount;
    }
