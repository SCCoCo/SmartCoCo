...
// File contracts/CryptoMaidsBody.sol
...
contract CryptoMaidsBody is ERC721Permit("CryptoMaids:Body") ,Ownable, ERC721URIStorage, AccessOperatable, IERC721Mintable{
    ...
    address public constant devAddress = 0xF0447B9722Accc3436e70c419e9d056DecFD1c29;
    ...
    function _mintMaid(address to) private {
        _supply++;
