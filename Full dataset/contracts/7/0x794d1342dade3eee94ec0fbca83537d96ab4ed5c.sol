...
contract MakinShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MakinShiba | T.me/MakinShiba";
    string private constant _symbol = unicode"MakinShiba";
