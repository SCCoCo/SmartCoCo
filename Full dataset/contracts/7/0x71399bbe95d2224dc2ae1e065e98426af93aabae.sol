...
// File: contracts/SB_scripts/mainnet/Main0032_reserve_transfer.sol

contract Main0032_reserve_transfer {
    ...
    function execute(Main0032_reserve_transfer /* self, not used */) external {
        ...
        AUGMINT_RESERVES.migrate(TARGET_ADDRESS, ethAmount);
    }
}