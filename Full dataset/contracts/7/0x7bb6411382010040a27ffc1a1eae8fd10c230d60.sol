...
contract StrategyTUSDCurve {
    ...
    address constant public y = address(0xfE170Dd8F4C0f335326dF1892D75de47c8d2CBC1);
    address constant public ycrv = address(0xdF5e0e81Dff6FAF3A7e52BA697820c5e32D806A8);
    address constant public yycrv = address(0x444b9167A7cA884725AF4c09961c6B4A62A59eB9);
    address constant public curve = address(0x45F783CCE6B7FF23B2ab2D70e416cdb7D6055f51);
    
    address constant public dai = address(0x6B175474E89094C44Da98b954EedeAC495271d0F);
    address constant public ydai = address(0xfE170Dd8F4C0f335326dF1892D75de47c8d2CBC1);

    address constant public usdc = address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
    address constant public yusdc = address(0xfC64d0bF54351d4383713172090F070836748590);

    address constant public usdt = address(0xdAC17F958D2ee523a2206206994597C13D831ec7);
    address constant public yusdt = address(0x0Ea9f8C451f472e9f9463d76097b8D0821CF1A55);

    address constant public tusd = address(0x0000000000085d4780B73119b644AE5ecd22b376);
    address constant public ytusd = address(0x6e53F8fa0D17eDA0412cBBcA8f7732D5ED28c9f8);
