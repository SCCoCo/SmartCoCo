...
contract TAAKIN is Ownable, ERC20Burnable {
  using SafeMath for uint256;

    string public name = "TAAKIN";
    string public symbol = "TAAKIN";
    uint public decimals = 18;

    uint public INITIAL_SUPPLY = 21 * (10**6) * (10 ** uint256(decimals)) ; // 21 Million
