...
contract GTGTToken is PausableToken {

    string  public  constant name = "Global Travel Group Token";

    string  public  constant symbol = "GTGT";
    ...
    function GTGTToken( address _admin, uint _totalTokenAmount ) 

    {
        ...
        // assign the total tokens to GTGT Token
