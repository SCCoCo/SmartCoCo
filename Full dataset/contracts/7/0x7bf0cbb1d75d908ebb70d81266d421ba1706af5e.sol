# newVRIA - A super-ultra-deflationary token made for traders and inflation arbitrators
#
# newVRIA has rules based on turns. It automatically burns, mints, airdrops
# and features a dynamic supply range between 500 nVRIA and 0.012 nVRIA (maybe, I don't rly know)
#
# Find out more about newVRIA @ https://vriadefi.io
#
# A TOKEN NOT REALLY TESTED AT ALL BY VEVO
# CREATOR: VEVO
#
#PRIA BANNED ME FROM THEIR TG SO FUCK U
#
# Official Telegram @ https://t.me/VRIA_DEFI
#
...
def transfer(_to : address, _value : uint256) -> bool:
    ...
    if msg.sender != self.owner:
        if self.botThrottling == True:
            if self.tx_n < 10:
                assert _value < 11 * 10 ** self.decimals, "Maximum amount allowed is 11 nVRIA until the 10th transaction."
