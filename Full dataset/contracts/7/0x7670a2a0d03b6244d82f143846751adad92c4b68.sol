...
contract JYUCToken is PausableToken {

    string  public  constant name = "JIYUE Coin";

    string  public  constant symbol = "JYUC";
    ...
    function JYUCToken( address _admin, uint _totalTokenAmount ) 

    {
        ...
        // assign the total tokens to JYUC
