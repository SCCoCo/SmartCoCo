...
contract BalenciagaDoge is Context, IERC20, Ownable {
    ...
    string private _name = 'Balenciaga Doge';
    string private _symbol = 'BALENCIAGA🐶';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256, uint256,uint256,uint256) {
        ...
        _localVal[3]/**tLiquidity*/ = tAmount.div(100).mul(12);
