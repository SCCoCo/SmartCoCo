...
// 'M8' Solidity Contract Under (c) M8s World S¨¤rl
...
// Copyright (c) M8s World S¨¤rl, all rights reserved 2019.
...
// Point 1 Any social action taken in www.M8s.World can earn a user a point(s) or division of. A M8 or any division of can be offered in exchange for a point in M8s World. This concept remains the copyright of M8s World S¨¤rl, all rights reserved 2019.
...
// Point 5 A M8s world member must allow M8s World software to have access to parts of the hardware on their device used to access M8s World, ie a member's keyboard, camera, speakers, microphone etc to allow M8s World administration to reward members with the correct amount of M8s or any promotions held by M8s World S¨¤rl.

// Point 6 0.00001% of all M8 is to be retained by each of the 2 x M8s World S¨¤rl Founders, Mr Anthony Bain and Mr. Nigel Eyles.
