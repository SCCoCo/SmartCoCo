...
library Utils {
    ...
    function ethAddress() external pure returns (address) {return ETH_ADDRESS;}

    function maxUint() external pure returns (uint256) {return MAX_UINT;}
    ...
    */
    function refundGas(address gasToken, uint256 initialGas, uint256 mintPrice) external {
    ...
    */
    function freeGasTokens(address gasToken, uint256 tokens) public {
