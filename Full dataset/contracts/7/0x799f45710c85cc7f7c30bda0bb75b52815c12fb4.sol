...
interface SewerRats
{
    function ratIndexToAddress (uint256 ratIndex) external view returns (address);
}
...
function mintWithRat(uint256 ratId) public payable  {
    require(ratsContract.ratIndexToAddress(ratId) == msg.sender, "Not the owner of this rat.");
