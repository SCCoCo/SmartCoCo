...
contract YCQLToken is PausableToken {
    string  public  constant name = "y¨¯ng ch¨±n qu¨¢n";
    string  public  constant symbol = "YCQL";
    ...
    function YCQLToken( address _admin, uint _totalTokenAmount ) 
    {
        // assign the admin account
        admin = _admin;

        // assign the total tokens to YCQL
