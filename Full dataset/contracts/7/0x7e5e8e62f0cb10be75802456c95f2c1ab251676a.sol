...
// ----------------------------------------------------------------------------
// 'LABCOIN' token contract
//
// Deployed to : 0x7AE7F76C18928EC5A21fac5b532b6B61022f6300
// Symbol      : LAC
// Name        : LAB COIN
...
//
//
// Adapted by Pedro Enrique Bravo IT Consulting, Sep 2019 
// To Proyectos Petrosupply, C.A.
...
contract LABCOIN is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "LABCOIN";
  string constant tokenSymbol = "LAC";
  uint8  constant tokenDecimals = 8;
  uint256 _totalSupply = 5000000000000000000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    address fundAccount = 0x0B1C6b19eb977BADB724116278D235fcdb4Ec999;
