...
contract Consts {
    ...
    string public constant TOKEN_NAME = "ZeroSumCost";
    string public constant TOKEN_SYMBOL = "ZSC";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0xcDEadD95b168b1d78995885e88Bf10089c1bA9d5;
    
    uint public constant START_TIME = 1549035600;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[2] memory weiRaisedStartsBounds = [uint(2500000000000000000),uint(0)];
        uint[2] memory weiRaisedEndsBounds = [uint(6000000000000000000),uint(22000000000000000000000)];
        uint64[2] memory timeStartsBounds = [uint64(1549035600),uint64(1549036800)];
        uint64[2] memory timeEndsBounds = [uint64(1553870395),uint64(1549640400)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(1000 * TOKEN_DECIMAL_MULTIPLIER, 0x3431b4Bee9761ec86A6ac018c973eaE477525083, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1553870400)
        CappedCrowdsale(22000000000000000000000)
