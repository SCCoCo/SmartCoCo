...
contract VestingTeam is VestingBase {
    ...
    constructor(CovaToken _cova, uint256 _releaseTime) public {
        ...
        beneficiaryAddress = 0xAa1167D50325438EE65a0A873332E4cFDaa9c6b6;

        totalClaimable = 975000000 * (10 ** 18);

        beneficiaryClaims.push(Claim(false, 1250, SIX_MONTHS, false));

        beneficiaryClaims.push(Claim(false, 1250, SIX_MONTHS.mul(2), false));

        beneficiaryClaims.push(Claim(false, 1250, SIX_MONTHS.mul(3), false));

        beneficiaryClaims.push(Claim(false, 1250, SIX_MONTHS.mul(4), false));

        beneficiaryClaims.push(Claim(false, 1250, SIX_MONTHS.mul(5), false));

        beneficiaryClaims.push(Claim(false, 1250, SIX_MONTHS.mul(6), false));

        beneficiaryClaims.push(Claim(false, 1250, SIX_MONTHS.mul(7), false));

        beneficiaryClaims.push(Claim(false, 1250, SIX_MONTHS.mul(8), false));
