...
// ----------------------------------------------------------------------------
// BXTB token contract for BXTB PoC Utility Token
//
// Symbol      : BXTB
// Name        : BXTB PoC Utility Token
// Total supply: 21,980,000,000.000000
// Decimals    : 6
// ----------------------------------------------------------------------------
...
// fixed supply
// ----------------------------------------------------------------------------
contract BXTBToken is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "BXTB PoC Utility Token";
        decimals = 6;
        _totalSupply = 21980000000 * 10**uint(decimals);
