...
🎰 Every day at 9:00 PM Eastern Standard Time and 10:00 PM Eastern Time, the wheel is spun.
- On the first spin, a random buyer is chosen to 5x their amount of tokens!
- On the 10:00 PM EST spin, a database of buys is entered into a spinning wheel on livestream. 
* This wheel will have three spins and three holders will have a chance to win!
1️⃣ First prize - 1 ETH
2️⃣ Second prize - 0.5 ETH
3️⃣ Third prize - 0.25 ETH

Each buy is entered into our database. The larger your purchase is, the larger your chance is to win!

We feature locked liquidity to guarantee that this is a true decentralized project! 

💰 FEES:
There are only fees on selling - please make sure you set adequate slippage to 6% when you are selling to do so.
2% is sent to the wheel wallet, and 4% is sent to reward all holders as an additional benefit!

Join the fun at 
@WheelofFortuneToken

View the livestream spin at 
https://twitch.tv/wheeloffortunespin
*/
...
contract WheelOfFortune is Context {
...
contract ERC20 is Context, IERC20, IERC20Metadata , WheelOfFortune{
...
contract WHEELOFFORTUNE is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 100000000 * 10 ** 18;

    constructor () ERC20(unicode'🎡Wheel oF Fortune', unicode'WOF') {
