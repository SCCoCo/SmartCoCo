...
// Swaprex $SWX
// Website: https://swaprex.com
// Telegram: https://t.me/swaprex
...
contract Swaprex is Context, IERC20, Ownable {
    ...
    // Owner cannot transfer out swaprex from this smart contract
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out swaprex!");
