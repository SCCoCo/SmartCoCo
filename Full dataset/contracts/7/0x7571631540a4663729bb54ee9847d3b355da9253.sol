...
GAMING + BLOCKCHAIN + FRANCHISING on ETH

ethermon.io/token
twitter.com/Ethermon_NFT

Presale on UniSwap 18.05.2021
...
contract Ethermon is Context, IERC20, Ownable {
  ...
  string private _name = 'EMON';
  string private _symbol = 'ethermon.io/token';
