...
/**
 *  __    __       ___   .___________.    _______. __    __  .__   __.  _______     __  .__   __.  __    __
 * |  |  |  |     /   \  |           |   /       ||  |  |  | |  \ |  | |   ____|   |  | |  \ |  | |  |  |  |
 * |  |__|  |    /  ^  \ `---|  |----`  |   (----`|  |  |  | |   \|  | |  |__      |  | |   \|  | |  |  |  |
 * |   __   |   /  /_\  \    |  |        \   \    |  |  |  | |  . `  | |   __|     |  | |  . `  | |  |  |  |
 * |  |  |  |  /  _____  \   |  |    .----)   |   |  `--'  | |  |\   | |  |____    |  | |  |\   | |  `--'  |
 * |__|  |__| /__/     \__\  |__|    |_______/     \______/  |__| \__| |_______|   |__| |__| \__|  \______/
 * 
 * Hatsune Inu
 * https://t.me/Hatsune Inu
 * hatsuneinu.com
 *
 * Hatsune Inu is a meme token with a twist!
 * Hatsune Inu has no sale limitations, which benefits whales and minnows alike, and an innovative dynamic reflection tax rate which increases proportionate to the size of the sell.
 *
 * TOKENOMICS:
...
contract HATSUNE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Hatsune Inu";
