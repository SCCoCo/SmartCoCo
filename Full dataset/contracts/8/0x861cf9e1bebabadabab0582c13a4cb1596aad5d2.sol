...
contract TokenERC20 is owned{
    ...
    string public name = "streaming Token";
    string public symbol = 'STMT';
    ...
    constructor(
        ...
        name = "streaming Token";                                   // Set the name for display purposes
        symbol = "STMT";                               // Set the symbol for display purposes
    }
...
contract streamingToken is owned, TokenERC20 {
