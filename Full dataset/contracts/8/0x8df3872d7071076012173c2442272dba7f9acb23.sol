...
contract GemToken is ERC20, Ownable, Pausable {
    using SafeMath for uint256;
    ...
    {
        setMinDeltaTwap(120);
        initialDistributionAddress = 0x54A112BD627DD7C26E219bf70CaeA19e5a4B7b8C;
        _distributeTokens(0x54A112BD627DD7C26E219bf70CaeA19e5a4B7b8C);
        _initializePair();
        _pause();
    }
    ...
    internal
    {
        _mint(address(_initialDistributionAddress), 800 * 1e18);
    ...
    function _initializePair() internal {
        ...
        setWhitelistedSender(uniswapV2Factory, true);
    }
        ...
        whenNotPausedOrInitialDistribution()
    {
        if (!_isWhitelistedSender(sender)) {
            ...
            if (currentAmountOutPerEth < INITIAL_TOKENS_PER_ETH) {
                ...
                uint256 maxBurnPct = BURN_PCT * scaleFactor;
                currentBurnPct = currentBurnPct > minBurnPct ? currentBurnPct > maxBurnPct ? maxBurnPct : currentBurnPct : minBurnPct;
            }
