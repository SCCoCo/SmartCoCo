...
// (c) by Hang Wu on behalf of the DigitalCoin LLC. in NYC. transferAnyERC20Token
...
contract DiUSDToken is ERC20Interface, Owned, SafeMath {
    ...
    function DiUSDToken() public {
        ...
        _totalSupply = 100000000*10**18; //Ê®ÒÚ´ú±Ò
