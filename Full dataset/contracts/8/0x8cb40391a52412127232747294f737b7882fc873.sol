...
contract ClickToken is AccountBalanceFrozen, OwnableAsset, WhitelistedAccount, Burning, Pausable, Mintable, Meltable {
    using SafeMath for uint256;

    string public name = "1ClickToken";
    string public symbol = "1CT";
