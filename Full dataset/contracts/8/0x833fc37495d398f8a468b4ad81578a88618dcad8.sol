...
// Arrowtoken Token contract based on the full ERC 20 Token standard

// https://github.com/ethereum/EIPs/issues/20

// Smartcontract for Arrowtoken, for more information visit https://Arrowtoken.io
 ...
 * ArrowtokenToken Math operations with safety checks to avoid unnecessary conflicts
...
contract ARRStandardToken is ArrowtokenToken, Ownable {

    

    using ARRMaths for uint256;
...
contract Arrowtoken is ARRStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 5000 * (10**6) * 10**8 ; // 5.000.000.000 tokens, 8 decimal places

    string constant public name = "Arrowtoken"; //fancy name: eg Arrowtoken

    string constant public symbol = "ARR"; //An identifier: eg ARR
