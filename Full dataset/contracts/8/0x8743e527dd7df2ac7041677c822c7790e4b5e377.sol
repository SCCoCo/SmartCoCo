...
/*
 ...
 Todi Inu is a new ETH token that sets launch upon community input. Join the adventure. 
...
contract  TodiInu is Context, IERC20, Ownable {
    ...
    string private _name = ' Todi Inu  ';
    string private _symbol = ' Todi Inu';
