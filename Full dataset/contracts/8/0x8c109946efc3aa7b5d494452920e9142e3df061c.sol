...
contract EnCrypto is ERC20 {
    ...
    string public constant name = "EnCrypto";
    ...
    function EnableDistribution() onlyOwner canDistr public returns (bool) {
    ...
    function burnEncrypto(uint256 _value) onlyOwner public {
