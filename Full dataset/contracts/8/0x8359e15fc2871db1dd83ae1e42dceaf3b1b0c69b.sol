...
contract EU21_BurnContract is Ownable {
    ...
    uint256 tokens = 0;
    uint256 relaseTime = 36500 days; // 100 years locked
    uint256 timing ;
    ...
    function withdraw() public onlyOwner{
        ...
        require(block.timestamp.sub(timing)>relaseTime, "Not yet"); // 100 years locked
