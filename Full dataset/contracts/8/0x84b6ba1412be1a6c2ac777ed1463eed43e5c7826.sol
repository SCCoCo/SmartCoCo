...
//Smart Contract code of DIC Token

//Developed By NodeBerry Blockchain Solutions
...
{ using SafeMath for uint256;
    ...
    uint public _totalsupply = 50000000 * 10 ** 18; // 50 Millon inculding decimal precesion
    ...
    mapping(address => mapping(address => uint)) allowed;
     ...
     address ethFundMain = 0x227816a99FBebBD8a5E19cA18C5e7a3B3859309F; 
...

    {
        ...
        balances[owner] = 0 * 10 **18;  // No tokens given to contract
