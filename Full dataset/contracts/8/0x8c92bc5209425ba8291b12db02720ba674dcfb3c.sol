...
contract YAPToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function YAPToken() {
        ...
        name = "YAPToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "YAP";                                             // Set the symbol for display purposes (CHANGE THIS)
