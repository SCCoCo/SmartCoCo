...
contract Kaitum is ERC20 {
    string public constant name = "Kaitum"; // solium-disable-line uppercase
    string public constant symbol = "KTM"; // solium-disable-line uppercase
