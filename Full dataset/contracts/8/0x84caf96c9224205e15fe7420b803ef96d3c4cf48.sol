...
contract Token is Governance, ERC20Detailed{
    ...
    //todo reward pool!
    address public _rewardPool = 0x1e1c982F650B3C50782829F3E22E877444e29DA1;
    //todo burn pool!
    ...
    */
    ...
    constructor () public ERC20Detailed("Swarm ETH Token", "BZZ", _decimals) {
        uint256 _exp = _decimals;
         _maxSupply = 62500000 * (10**_exp);
    }
