...
BabyHoge - the son of Hoge is a community-driven, meme theme decentralized token. Hoge was originally built on the Ethereum network, therefore Baby Hoge will follow his father's road, but this time with much better tokenomics.

https://t.me/BabyHogeCommunity
...
pragma solidity ^0.6.12;
    ...
    contract BHOGE is Context, IERC20, Ownable {
        ...
        string private _name = 'BabyHoge.com';
        string private _symbol = 'BHOGE';
