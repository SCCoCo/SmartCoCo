...
contract CBL is ERC20Interface, Tokenlock, UserLock{//is inherently ERC20
    ...
    */
    ...
    string constant public name = "CBL";

    string constant public symbol = "CBL";

    uint8 constant public decimals = 6;

    uint256  _totalSupply = 3.8e14; // 10вк
