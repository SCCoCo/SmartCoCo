...
contract OTSToken is PausableToken {

    string  public  constant name = "Online Travelling Streaming";
    ...
    function OTSToken( address _admin, uint _totalTokenAmount ) 

    {
        ...
        // assign the total tokens to OTS Token
