...
Zero Exchange
 to connect the z-tokens to BSC & ETH’s ERC20 tokens! We will gradually expand our scope to enable more assets from different bridges. At the same time, we will list our governance token, $GVA, both in Pangolin and Zero Exchange.
Governance Token: $GVA
Governor’s governance token is $GVA. The supply is capped at 500 million and 60% will be allocated to liquidity mining.
...
If you are participating in the Pangolin or Zero Exchange LPs, you are exposed to the volatility of the related assets (i.e.: GVA, AVAX, ZERO) and impermanent loss.
If you are participating in GVA staking, you are exposed to the volatility of GVA.
...
The contracts are available at https://github.com/GovernorAPP
