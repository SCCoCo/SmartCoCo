...
contract E01Token is MintableToken {
  string public constant name = "Eleven01";
  string public constant symbol = "E01";
  uint8 public constant decimals = 18;

  // Total supply of E01 tokens is 5.5 Billion
