...
contract ANONREVOLUTION is Context, IERC20, Ownable {
    ...
    address payable public NFTFundAddress = payable(0x150133bfb402955146D1C59B2a29eFa3a561BDE2); // NFTFundAddress
    ...
    string private _name = "AnonRevolution";
    string private _symbol = "ANON";
    uint8 private _decimals = 9;


    uint256 private _taxFee = 4; //taxfee cannot be raised
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _NFTFee = 7;
