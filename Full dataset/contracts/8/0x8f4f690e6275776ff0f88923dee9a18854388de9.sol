...
contract MNYWrapper is MintableToken, BurnableToken {

  using SafeMath for uint256;



  string public constant name = "MNY-Wrapper";

  string public constant symbol = "MNY-W";
  ...
  // call approve(MNYWrapper address, amt) first
  ...
  function swapForNote(uint _amt) public {
    ...
    ERC20(MNY).transfer(msg.sender, wrappers.div(rate));
