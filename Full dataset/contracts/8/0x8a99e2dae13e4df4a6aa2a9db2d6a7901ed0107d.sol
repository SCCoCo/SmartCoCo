...
contract Owned {
    ...
    constructor() public {
        owner = 0x68D235a835eB3d467fE9569242527eE54E32aEB4;
    }
...
// ----------------------------------------------------------------------------
contract Vibrant_Finance is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        decimals = 18;
        _totalSupply = 314159266 * 10**uint(decimals);
        balances[owner] = _totalSupply;
         RATE = 39000000; // 1 ETH = 3900 ViFi // 1 ViFi = 0.10 USD
        DENOMINATOR = 10000;
