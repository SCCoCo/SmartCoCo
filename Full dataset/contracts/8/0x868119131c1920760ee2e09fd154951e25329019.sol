...
🔊$YUKON The first token offering $RVP Rewards to holders!🔊
You do NOT want to miss this gem! 💰💰 ☄️☄️

Site: Yukontoken com
Twitter:  TheYukonCrypto
TG:  t.me YukonOfficial

ERC20 Token Launching on Uniswap September 30. We will provide an exact time closer to launch - we want to avoid gas wars with other projects.

Basic Tokenomics:
6% to Marketing Wallet
6% Redistribution to holders in RVP
3% to Liquidity
LP will be locked upon launch. 
...
contract YUKON is Context, IERC20, Ownable {
    ...
    string private _name = 'YUKON';
    string private _symbol = 'YUKON';
