...
contract synthetix_unipool_strategy is ERC20 {
    ...
    address constant _u = address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48); // UDSC
    address constant _y = address(0x27392910FC7921aC3B451E6a4568906371941df8); // Mining pool
    address constant _t = address(0x368B3a58B5f49392e5C9E4C998cb0bB966752E51); // BDO
