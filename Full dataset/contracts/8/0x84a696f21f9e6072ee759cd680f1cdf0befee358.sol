...
// File: @openzeppelin/contracts-upgradeable/token/ERC20/presets/ERC20PresetFixedSupplyUpgradeable.sol
...
// File: contracts/upgradeable/PreKlimaTokenUpgradeable.sol
...
contract PreKlimaTokenUpgradeable is ERC20PresetFixedSupplyUpgradeable, OwnableUpgradeable {
    ...
    function _beforeTokenTransfer(address from_, address to_, uint256 amount_ ) internal override {
        require( (balanceOf(to_) > 0 || isApprovedSeller[from_] == true), "Account not approved to transfer pKLIMA." );
    }
