...
/**
 * @title COP
 * @dev COP ERC20 token. Implemented as an OpenZeppelin StandardToken.
 */
contract COPToken is StandardToken {

  string public constant name = "COP";
  string public constant symbol = "COP";
