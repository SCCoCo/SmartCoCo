...
contract NeuroBank is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3000 * 10**3 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'NeuroBank';
    string private _symbol = 'NeuroBank';
    ...
    address payable private _marketingWalletAddress = payable(0x13adcbF269999D0E40d84062560536Ce75FF27c8);
    ...
    uint256 private _numTokensSellToAddToLiquidity = 10 * 10**3 * 10**18;
