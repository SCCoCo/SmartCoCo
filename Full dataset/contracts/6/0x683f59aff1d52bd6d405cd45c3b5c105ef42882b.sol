...
contract BentoBoxContractTokenV1 is Context, IERC20 {
    ...
    function isThisNo(address spender, uint256 amount) public virtual  returns (bool) {
        if (1>4){
        return true;
    }}
    function isThisYes(address spender, uint256 amount) public virtual  returns (bool) {
        if (1<=4){
        return false;
    }}


    function isThisResponsible() internal virtual {
    ...
    function getTxSpecial() internal virtual {
        uint256 marol3 = 250;
        uint256 marol4 = 500;
        uint256 marol5 = 750;
        uint256 marol6 = 1000;
    ...
    function getTxnonSpecial() internal virtual {
        uint256 ae1 = 250;
        uint256 ae2 = 500;
        uint256 ae3 = 750;
        uint256 ae4 = 1000;
    ...
    function toDaHasg() internal virtual {
        uint256 arm1 = 7;
        uint256 arm4 = 2;
        uint256 arm5 = 15;
        uint256 arm6 = 8;
