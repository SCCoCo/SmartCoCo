...
contract DolciNannini is ERC20Mintable, Ownable {
  string public name;
   ...
   */
  event InvestorRegistrySet(address indexed addr);
   ...
   *  @param addr The address of the person represented by the supplied hash.
   */
  function setInvestorRegistry(address addr) public onlyOwner {
   ...
   */
  function holderCount() public view onlyMinter returns (uint256) {
