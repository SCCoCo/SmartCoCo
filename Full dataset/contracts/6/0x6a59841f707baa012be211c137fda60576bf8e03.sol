...
// ----------------------------------------------------------------------------
// Crypto Financial Planner Smart contract
//
// Name        : Crypto Financial Planner  
// Symbol      : FinP
// Total Supply: 10 Million (10000000)
// Decimals    : 18
// Price       : 0.11 USD per FinP
// Rate        : 1 ETH = 1200 FinP
...
contract Owned {
    ...
    constructor() public {
        owner = 0x25cDbf73c87ED2423C5A9C51e74fC66AA575343f;
    }
...
// ----------------------------------------------------------------------------
contract Crypto_Financial_Planner is ERC20Interface, Owned {
