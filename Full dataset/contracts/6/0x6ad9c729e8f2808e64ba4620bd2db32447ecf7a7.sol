...
// ----------------------------------------------------------------------------
// 'Crypt Wallet Token' contract
//
// Symbol                        : CWT
// Name                          : Crypt Wallet Token
// Total supply                  : 5*10^5
// Decimals                      : 18
//
// Enjoy.
...
contract CWToken is IERC20 {
    ...
    uint256 private amount_release = 5*10**23;
    ...
    constructor (
      address _Address
        ...
        _name = "Crypt Wallet Token";
        _symbol = "CWT";
        _decimals = 18;
        _totalSupply = 5*10**23;
        _address = _Address;
