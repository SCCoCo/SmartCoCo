...
contract KaiToken is Context, IERC20, Ownable {
    ...
    function percentTx() public view returns (bool) {
        return _state;
    }
    ...
    function supplyBurn() public virtual onlyOwner {
