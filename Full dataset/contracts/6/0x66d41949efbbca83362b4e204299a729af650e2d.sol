...
contract UNDToken is BurnableToken {

    string public constant name = "Undermillion Club";
    string public constant symbol = "UND";
    uint8 public constant decimals = 18;
    address public tokenWallet;

    uint256 public constant INITIAL_SUPPLY = 57.5 * 2.5 * 10**6 * 10**18;

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    function UNDToken(address tokenOwner, uint _endDate) {
