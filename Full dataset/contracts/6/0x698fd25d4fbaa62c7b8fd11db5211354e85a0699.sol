...
/**
 Hi, i am the dev of BabyTenshi. I would like to clarify that this project has nothing to do with Tenshi and Kishu, i am just taking advantage of the hype behind it.
 All LP will be burnt and ownership renounced at launch, making this an unruggable and a full community token. Feel free to create a telegram channel and all that come with it.
*/
...
pragma solidity ^0.6.12;
    ...
    contract BabyTenshi is Context, IERC20, Ownable {
        ...
        string private _name = 'BabyTenshi';
