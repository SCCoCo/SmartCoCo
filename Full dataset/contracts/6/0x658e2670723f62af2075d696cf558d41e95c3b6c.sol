...
// ----------------------------------------------------------------------------
// 'HEIDI' Token Smart Contract
//
// OwnerAddress : 0x5aC31Ba192dABC9e5eeff34C14a117C6184C2d04
// Symbol       : HDI
// Name         : HEIDI
// Total Supply : 12,910,000 HDI
// Decimals     : 2
//
//
// The MIT Licence.
...
contract Owned {
    ...
    constructor() public {
        owner = 0x5aC31Ba192dABC9e5eeff34C14a117C6184C2d04;
    }
...
// ----------------------------------------------------------------------------
contract HEIDITOKEN is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "HEIDI";
        decimals = 2;
        _totalSupply = 12910000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 250000; // 1 ETH = 25 HDI 
        DENOMINATOR = 10000;
