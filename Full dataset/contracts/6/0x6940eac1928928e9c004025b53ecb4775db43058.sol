...
contract SourceCommumity is ERC20 {
    ...
    string public constant name = "SourceCommumity";

    string public constant symbol = "SCOM";
    ...
    modifier onlyPayloadSize(uint size) {
     ...
     function SourceCommumity (address _owner,bytes32 _key) public {
