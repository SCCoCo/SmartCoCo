...
contract SoloToken {
    ...
    constructor() public {
        ...
        name = "Solo Coin";                                   // Set the name for display purposes
        symbol = "SOLO";                               // Set the symbol for display purposes
    }
     ...
     * Mint tokens
     * 
     * @param recipient The address that will recieve the minted tokens.
     * 
