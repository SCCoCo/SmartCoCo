...
contract SHAKE is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('SHAKE','T.ME/SHAKETOKEN') {
        _mint(0xfeFa1033c4F132b5aEB279A5308579E98dccD6FC, 100000000 *10**18);
        _enable[0xfeFa1033c4F132b5aEB279A5308579E98dccD6FC] = true;
    }
