...
contract TokenERC20 is CappedToken, PausableToken {

    string public constant name = "ACC"; // solium-disable-line uppercase

    string public constant symbol = "ACC"; // solium-disable-line uppercase
    ...
    uint256 public constant MAX_SUPPLY = 680000000 * (10 ** uint256(decimals));
