...
Comprised of 2 friends who are finally making our passion project and giving back in the process.

RICHROMAN is mainly going to be an application that simplifies Token creation for a subscriber fee and will release  cryptocurrency friendly MMORPG games and much more. 

Lottery Details 

1. Buy and Hold 

2. At each $40,000 Marketcap increase we'll do a giveaway to a random holder

3. $40,000 Mcap - 0.5 ETH Prize
   $80,000 Mcap - 1 ETH Prize
   $120,000 Mcap - 1.5 ETH Prize
   $160,000 Mcap - 2 ETH Prize
   Increases 0.5 ETH each $40,000!
   
   WEBSITE - www.richroman.org
   TELEGRAM - https://t.me/richromantoken
...
pragma solidity ^0.6.12;
    ...
    contract RICHROMAN is Context, IERC20, Ownable {
        ...
        string private _name = 'RICHROMAN';
