...
// File: contracts/Boomvtoken.sol
pragma solidity 0.6.12;
contract BurningFarm is ERC20("Burning.Farm", "BARM"), Ownable {
    using SafeMath for uint256;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
     ...
     /**
     * @dev Chef distributes newly generated BoomFinanceToken to each farmmers
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "Burning.Farm::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "BoomFinance.org::delegateBySig: invalid nonce");
        require(now <= expiry, "BoomFinance.org::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "BurningFarm.org::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "Burning.Farm::_writeCheckpoint: block number exceeds 32 bits");
