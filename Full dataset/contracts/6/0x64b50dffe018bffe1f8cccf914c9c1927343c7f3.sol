...
/*****************************************************************************
 * @title YDexFinanceTokenOfficial
 * @dev YDexFinanceTokenOfficial is an ERC20 implementation of the YDexFinanceTokenOfficial ecosystem token. 
...
contract YDexFinanceTokenOfficial is Ownable, ERC20Pausable {
    string public constant name = "ydex.finance (Official)";
    string public constant symbol = "YDEXF";
