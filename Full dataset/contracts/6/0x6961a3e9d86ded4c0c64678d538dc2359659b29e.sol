...
contract Owned {
    ...
    constructor() public {
        owner = 0x137CB7a6FC0d2Da00cEE57F643b3A2741a4CA931;
    }
...
// ----------------------------------------------------------------------------
contract Qbean is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "Qbean";
        decimals = 18;
        _totalSupply = 80000000000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 40000000; // 1 ETH = 4000 LATAM
        DENOMINATOR = 10000;
