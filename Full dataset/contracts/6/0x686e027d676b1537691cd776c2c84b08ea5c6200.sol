...
// ----------------------------------------------------------------------------
// 'yPAX Gold' Smart Contract
//
// OwnerAddress : 0x935d115d8CE04C19e49654C3710490CDFC446651
// Symbol       : yPAXG
// Name         : yPAX Gold
// Total Supply : 38000 yPAXG
// Decimals     : 18
// Copyrights of 'yPAX Gold' With 'yPAXG' Symbol November 08, 2020.
// The MIT Licence.
// 
...
contract Owned {
    ...
    constructor() public {
        owner = 0x935d115d8CE04C19e49654C3710490CDFC446651;
    }
...
// ----------------------------------------------------------------------------
contract yPAXGold is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "yPAX Gold";
        decimals = 18;
        _totalSupply = 38000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 10000; // 1 ETH = 1 yPAXG 
        DENOMINATOR = 10000;
