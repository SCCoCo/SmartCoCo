 ...
 * 
 * RTKL5 is just like the standard RTK gun, but loaded with five bullets instead of one; it is used by players in Ruletka's Game Hub 
...
contract Ruletka is Context, Ownable, ERC20Detailed, GasPump {
    ...
    constructor() public ERC20Detailed("Ruletka L5", "RTKL5", 18) {    // For naming the token and specifying it's decimals
