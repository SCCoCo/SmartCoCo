...
contract IPCTToken is StandardToken {

  string public constant name = "IP CHAIN TOKEN";
  string public constant symbol = "IPCT";
  uint8 public constant decimals = 8;

  uint256 public constant INITIAL_SUPPLY = 159000000 * (10 ** uint256(decimals));
