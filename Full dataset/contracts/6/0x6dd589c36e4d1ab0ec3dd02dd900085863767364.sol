...
// File: contracts/LucoBTCVault.sol

pragma solidity ^0.6.10;

contract LucoBTCVault is Ownable {
    using SafeMath for uint256;
    ...
    // Constructor will set the address of LUCO/BTC LP token
    ...
    // Function that updates LUCO/BTC LP pool
    ...
    // Function that lets user stake LUCO/BTC LP
    ...
    // Function that lets user unstake Luco/BTC LP in system
