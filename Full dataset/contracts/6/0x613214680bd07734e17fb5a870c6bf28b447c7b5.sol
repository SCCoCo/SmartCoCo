...
contract ALFASSA is StandardToken {
    string public constant name = "ALFASSA";
    string public constant symbol = "ALFA";
    uint256 public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY = 120000000 * (10**decimals);
