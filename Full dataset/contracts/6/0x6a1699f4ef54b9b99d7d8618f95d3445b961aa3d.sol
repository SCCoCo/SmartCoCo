 ...
 * Loki Finance became extremely tired of sitting in his brother's shadow, and said f*ck it. 
 * The finale ending was great, and now Loki has decided to bless us with another gift.
 * Therefore, Loki finance has emerged and decided to go to the moon!
 * Our project is 100% safe by a based dev 😊 Verified Contract will be released at launch to avoid sniper bots
 * 🛡 Join our community and go to the moon! 🌙
 * 📥 Web: https://lofitoken.net
 * 📥 Telegram: https://t.me/lofitoken
*/
...
contract $LOFI is Context, IERC20, Ownable {
    ...
    string private _name = 'LOKI FINANCE 💵 t.me/lofitoken';
