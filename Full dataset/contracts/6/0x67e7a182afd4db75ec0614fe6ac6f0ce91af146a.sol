...
contract AtroProtocol is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AtroProtocol() {
        ...
        name = "Atro Protocol";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ATRO";                                             // Set the symbol for display purposes (CHANGE THIS)
