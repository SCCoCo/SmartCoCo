...
contract StakingRewardsFactory is Ownable {
    ...
    function setRewardAmount(address stakingToken, uint rewardAmount) public onlyOwner {
        StakingRewardsInfo storage info = stakingRewardsInfoByStakingToken[stakingToken];
        require(info.stakingRewards != address(0), 'StakingRewardsFactory::setRewardAmount: not deployed');
        
        info.rewardAmount = rewardAmount;
        notifyRewardAmount(stakingToken);
    }
