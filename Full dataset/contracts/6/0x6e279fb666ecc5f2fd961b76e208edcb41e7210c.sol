...
// We have our own website and dashboard that lets holders reinvest their reflection back into EverETH without having to pay a 10% transaction fee.

// Tokenomics: 10% tax on all transactions that goes into a (locked) liquidity pool which is then redistributed to every wallet based on their respective holdings Claim ETH or reinvest ETH back into EverETH for cheap A 10,000,000,000 token fixed daily limit (24hrs) of transfers or sale to (hopefully) avoid big volatility during down trends Impossible for front running bots due to the transaction fees Endless possibilities for utility in the near future.

// Website: https://evereth.cash
// Claim rewards: https://evereth.cash/dashboard 
// Telegram: https://t.me/ever_eth 

// HODL $EVERETH - Earn Eth 💎
...
contract EVERETH is Context, IERC20, Ownable {
    ...
    string private _name = 'EverETH';
    string private _symbol = 'EVERETH';
