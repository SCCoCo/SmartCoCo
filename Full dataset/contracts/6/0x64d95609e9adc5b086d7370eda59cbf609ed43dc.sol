...
/**   .----------------.  .----------------.  .----------------.  .----------------.   .----------------.  .-----------------. .----------------. 
*   | .--------------. || .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. |
*   | |   ______     | || |      __      | || |   ______     | || |  ____  ____  | | | |     _____    | || | ____  _____  | || | _____  _____ | |
*   | |  |_   _ \    | || |     /  \     | || |  |_   _ \    | || | |_  _||_  _| | | | |    |_   _|   | || ||_   \|_   _| | || ||_   _||_   _|| |
*   | |    | |_) |   | || |    / /\ \    | || |    | |_) |   | || |   \ \  / /   | | | |      | |     | || |  |   \ | |   | || |  | |    | |  | |
*   | |    |  __'.   | || |   / ____ \   | || |    |  __'.   | || |    \ \/ /    | | | |      | |     | || |  | |\ \| |   | || |  | '    ' |  | |
*   | |   _| |__) |  | || | _/ /    \ \_ | || |   _| |__) |  | || |    _|  |_    | | | |     _| |_    | || | _| |_\   |_  | || |   \ `--' /   | |
*   | |  |_______/   | || ||____|  |____|| || |  |_______/   | || |   |______|   | | | |    |_____|   | || ||_____|\____| | || |    `.__.'    | |
*   | |              | || |              | || |              | || |              | | | |              | || |              | || |              | |
*   | '--------------' || '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' |
*    '----------------'  '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------' 
*/
...
/** 
 * https://t.me/babyinuoff
 * 60% UNISWAP LIQUIDITY LAUNCH 
 * 35% INITIAL BURN 
 * BABY INU $BABYINU 
 * ANTI BOT MECHANISM 
