...
contract EasySmart is Ownable {
    ...
    constructor() public {
        ...
        LEVEL_PRICE[2] = 0.45 ether;
        LEVEL_PRICE[3] = 1.35 ether;
        LEVEL_PRICE[4] = 4.05 ether;
        LEVEL_PRICE[5] = 12.15 ether;
        LEVEL_PRICE[6] = 36.45 ether;
        LEVEL_PRICE[7] = 109.35 ether;
		LEVEL_PRICE[8] = 328.05 ether;
    ...
    function () external payable {
        ...
        if(users[msg.sender].isExist){
            ...
            revert("Please buy first level for 0.15 ETH");
        }
    }
