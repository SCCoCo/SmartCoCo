...
contract Owned {
    ...
    constructor() public {
        owner = 0x857D2f08C72019FAbaF4d32C53a826543Eb905Cf;
    }
...
// ----------------------------------------------------------------------------
contract OBIDUA is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "OBIDUA";
        decimals = 18;
        _totalSupply = 99400000000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 20000000; // 1 ETH = 2000 OBD
        DENOMINATOR = 10000;
