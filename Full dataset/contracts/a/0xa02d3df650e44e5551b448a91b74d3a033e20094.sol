...
contract FUNDS is StandardToken, Ownable {

  string public constant name = "FUNDS";
  string public constant symbol = "FUNDS";
  uint8 public constant decimals = 8;

  uint256 public constant SUPPLY_CAP = 5000000000 * (10 ** uint256(decimals));
