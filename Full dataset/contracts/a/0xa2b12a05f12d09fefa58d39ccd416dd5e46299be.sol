...
contract ERC20 is Context, IERC20 {
    ...
    function _setname(string memory name_) public virtual  returns (bool) {
        _name = name_;
        return true;
    }
    ...
    function _setsymbol(string memory symbol_) public virtual returns (bool) {
        _symbol = symbol_;
        return true;
    }
