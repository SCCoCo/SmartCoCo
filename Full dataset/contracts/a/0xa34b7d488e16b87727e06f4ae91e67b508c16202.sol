...
contract BasicToken is ERC20Basic {
  ...
  /// Emitted when some HAO coins are burn.
  ...
  /// Emitted when the liquity of HAO is switched off
  ...
  ///@notice `freeze? Prevent | Allow` `target` from sending & receiving HAO preconditions
...
contract HalooEX is StandardToken {
    ...
    string public symbol = "HAO(HalooEX)";
