...
/*
Hi🐕 , I'm Roxy , I lost my way to the moon , can you take me there ?
    ___
 __/_  `.  .-"""-.
 \_,` | \-'  /   )`-')
  "") `"`    \  ((`"`
...
Roxy is here to to fight all other dog memes on their competition

Launching steps :

1- 1,000,000,000,000 Total Supply 
2- 35% will be burned 
3- 65 % Liquidity for all our holders
4- Locking the Liquidity for 2 Years
5- Renouncing Ownership 
6- Holders Mission started


Please help Roxy achieving the moon dream.

Contract Options:
- Anti whale buy/sell limits
- Anti bots scripting
- 2% redistribution to holders on all buys actually works
...
contract RoxyInu is Context, IERC20, Ownable {
    ...
    string private _name = 'Roxy Inu';
    string private _symbol = 'RoxyINU';
