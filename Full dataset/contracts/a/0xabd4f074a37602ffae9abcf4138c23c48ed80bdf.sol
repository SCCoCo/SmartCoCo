...
contract Token is UpgradeableToken, BurnableToken {
    ...
    constructor (address zmrWallet, address _upgradeMaster, uint256 _INITIAL_SUPPLY)
...

    {
        ...
        balances[zmrWallet] = INITIAL_SUPPLY;

        emit Transfer(address(0), zmrWallet, INITIAL_SUPPLY);
