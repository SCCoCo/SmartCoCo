...
contract Configurable {            
    uint256 public constant cap = 30000*10**8;
    uint256 public constant basePrice = 100*10**8; // tokens per 1 ether
    uint256 public tokensSold = 0;
    
    uint256 public constant tokenReserve = 30000*10**8;
 ...
 **/
contract Yearn_Finance_Token is CrowdsaleToken {
    string public constant name = "Yearn Finance Token";
