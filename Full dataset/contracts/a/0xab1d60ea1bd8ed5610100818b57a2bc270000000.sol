...
contract StableFund is Ownable {
    ...
    modifier onlyMonetaryPolicy() {
        require(msg.sender == monetaryPolicy, "Not Monetary Policy");
        _;
    }
     ...
     */
    function rebase(uint256 totalSupply) public onlyMonetaryPolicy {
     ...
     */
    function mint(address to, uint256 value) public onlyMonetaryPolicy {
     ...
     */
    function burn(address from, uint256 value) public onlyMonetaryPolicy {
        uint256 gonValue = value.mul(_gonsPerFragment);
