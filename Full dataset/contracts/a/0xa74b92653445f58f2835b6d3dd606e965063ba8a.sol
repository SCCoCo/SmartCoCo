 ...
 * Magnetics token smart contract.

 */

contract MagneticsToken is AbstractToken {
   ...
   * Create new Magnetics token smart contract, with given number of tokens issued
  ...
  function MagneticsToken (uint256 _tokenCount) public {
