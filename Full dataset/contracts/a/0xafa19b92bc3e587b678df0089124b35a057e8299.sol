...
// MoonDogOne is Fair launched DeFi Token, the team has focused its efforts on giving back to the community through engaging in long-term hold semantics that encourages holding, feeds liquidity, and reflect unto the community as a whole.

// ✅ Telegram: https://t.me/moondogone
//✅ Website: https://www.moondog.one/
...
contract  MoonDogOne is Context, IERC20, Ownable {
    ...
    string private _name = 'MoonDog.One';
    string private _symbol = 'MoonDogOne';
