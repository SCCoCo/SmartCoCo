...
contract Share is ERC20Burnable, Operator, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(address _governance) public ERC20('YFL Synthetic', 'sYFL') 
    {
        governance = _governance;
        
        _totalSupply = 5000000 * 10**18;
        _balances[msg.sender] = 2500000 * 10**18;
        _balances[governance] = 2500000 * 10**18;
    }
