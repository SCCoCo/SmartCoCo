...
contract VendingMachine is Ownable {
    ...
    function redeem(uint256 card) public {
        ...
        require(LPAddress.balanceOf(msg.sender) >= cardCosts[card], "Not enough points to redeem for card");
        require(RMU.totalSupply(card) < RMU.maxSupply(card), "Max cards minted");

        LPAddress.transferFrom(msg.sender,0x0000000000000000000000000000000000000000, cardCosts[card]);
