...
contract AntexToken is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "ANTEX";
    string private _symbol = "ANT";
    uint8 private _decimals = 8;
    address public routerAddress = payable(address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D));
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) > 0, 'Error: must own ANT to claim reward');
