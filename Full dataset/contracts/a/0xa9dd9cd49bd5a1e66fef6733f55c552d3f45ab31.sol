...
contract PoaToken is PoaCommon {
  ...
  *********************************/
...

  {
    ...
    */
    ...
    /**
      ...
      per token payout is / 1e18 at time of usage for actual ¦® balances

      `unclaimedPayoutTotals` are stored as actual ¦® value no need for rate * balance
  ...
  /// @notice send ¦® to contract to be claimed by token holders
