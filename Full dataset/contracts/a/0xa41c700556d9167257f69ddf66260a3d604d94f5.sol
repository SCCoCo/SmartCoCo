...
//info_concealed (String ASCII convertie en Hex) = 3 premieres lettres du nom du client - premiere lettre du nom du client - 4 derni¨¨res lettres du nom du client - 2 premiers chiffres du code postal du client - 4¨¨me chiffre du code postal du client - 2 premi¨¨res lettres de la ville du client

//client_full (String ASCII convertie en Hex) =  Identit¨¦ du client au format PNCEE (NOM;PRENOM pour un particulier RAISON SOCIALE;SIRET pour un professionnel) encod¨¦e avec l'alogorithme MD5

//address_full (String ASCII convertie en Hex) = Adresse du client au format PNCEE (NUMERO DE VOIE NOM DE VOIE;CODE POSTAL; VILLE) encod¨¦e avec l'alogorithme MD5

//declared_for (String ASCII convertie en Hex) = Adresse de l'oblig¨¦ dans la blockchain (e.g. MGNS. primary address = 0x62073c7c87c988f2Be0EAF41b5c0481df98e886E)
...
//5: Entr¨¦e en relation sans RCAI

//6: Mise ¨¤ jour fiche

//7: RCAI Ant¨¦rieur 

//8: Entr¨¦e en Relation Arbitrage sans RCAI

//9: RCAI Bloc Actuel 



//Exemple Entr¨¦e en relation de MGNS. avec lettre d'engagement envoy¨¦e par mail ¨¤ M. Lucien Renard, 88 impasse du Colonel De Gaulle, 13001 MARSEILLE
