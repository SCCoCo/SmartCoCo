...
// Ethelon
// Telegram: https://t.me/EthElonToken
 ...
 * $$ |      $$ |$$\ $$ |  $$ |$$   ____|$$ |$$ |  $$ |$$ |  $$ |
 * $$$$$$$$\ \$$$$  |$$ |  $$ |\$$$$$$$\ $$ |\$$$$$$  |$$ |  $$ |
 * \________| \____/ \__|  \__| \_______|\__| \______/ \__|  \__|
 */
...
contract EthelonToken is Context, IERC20, Ownable {
    ...
    string private _name = 'EthElon | t.me/EthElonToken';
    ...
    address payable private _marketingWalletAddress = payable(0x5CEEE37626764266610753ef7ae75d115A048DB2);
    ...
    function _removeInitialTradeLimits() external onlyOwner() {
        ...
        _maxTxAmountSell = 1000000000000000000;
    }
