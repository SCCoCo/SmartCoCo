...
contract priya is StandardToken {

  string public constant name = "priya";

  string public constant symbol = "pri";
  ...
  uint256 public constant total = 50 * (10**7) * 10**decimals;   // 20 *10^7 ETHR total



  function priya() public {
