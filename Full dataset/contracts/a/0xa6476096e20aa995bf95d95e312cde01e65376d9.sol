...
Website:  https://SolisGame.online

Telegram: https://t.me/SolisGameToken
...
contract SolisGameToken is ERC20, ERC20Burnable, Administrable, ERC20Payable {
    using SafeMath for uint256;
    ...
    constructor(address router, address factory, uint256 initialSupply) ERC20 (_name, _symbol) {
        ...
        _name = "Solis Game Token | t.me/SolisGameToken";
        _symbol = "SOLIS";
        ...
        gameRewardsAddress = 0x87AAc2a38eF8cA2964011e7EfcE388d4F8982274;
        _rewards = true;
