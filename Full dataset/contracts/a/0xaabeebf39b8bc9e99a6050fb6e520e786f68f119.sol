...
// token transfers
// ----------------------------------------------------------------------------
contract CSLToken is ERC20Interface, Owned, SafeMath {
    string public name = "Consel";
    string public symbol = "CSL";
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function CSLToken(address multisig, uint tokens) public {
        _totalSupply = tokens;
