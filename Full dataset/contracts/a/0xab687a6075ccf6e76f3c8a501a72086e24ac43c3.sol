...
contract EMC is StandardToken, Ownable {
  string public constant name = "Exploitation Mine Chain"; // solium-disable-line uppercase
  string public constant symbol = "EMC"; // solium-disable-line uppercase
  uint8 public constant decimals = 8; // solium-disable-line uppercase
  
  uint256 constant MAX_SUPPLY = 3600 * 10000 * (10 ** uint256(decimals));
  ...
  */
  ...
  function mint(uint256 mintedAmount) public onlyOwner returns (bool success){
