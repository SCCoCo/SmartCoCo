...
//
  ...
  function changePrice(uint _id, uint _price) public virtual returns (bool) {
      require(hasRole(MINTER_ROLE, _msgSender()), "CantaloupeIsland: must have minter role to change price");
      price[_id] = _price;
      return true;
  }
