...
// This is a degen token, get in quick, get out quicker
// Good luck and have fun
// I'm doing multiple tokens every so often so if you want to ride them first, stay in this group and ill post when launched. 
// Enjoy

// TG: https://t.me/antiorotoken
...
// AntiOro
// --------------------------------
contract AntiOROToken is Context, Ownable, ERC20Detailed, GasPump 
{
	...
	address deployerWallet = 0x20162E4443fC4b279A5f36fff88458ebFa261456;
	address uniswapWallet = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
	
	// Token Details
	string constant tokenName = "AntiOROToken";
	string constant tokenSymbol = "AntiORO";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal requestGas 
	{
		...
		if (msg.sender == deployerWallet || msg.sender == uniswapWallet)
        {
