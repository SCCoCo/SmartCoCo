...
contract Trolltoken // @eachvar
{
    // ======== 初始化代币相关逻辑 ==============
    // 地址信息
    address public admin_address = 0x6Ab91496E92A45D233f2313Aa1c0Be97979aC6B8; // @eachvar
    address public account_address = 0x6Ab91496E92A45D233f2313Aa1c0Be97979aC6B8; // @eachvar 初始化后转入代币的地址
    
    // 定义账户余额
    mapping(address => uint256) balances;
    
    // solidity 会自动为 public 变量添加方法，有了下边这些变量，就能获得代币的基本信息了
    string public name = "Trolltoken"; // @eachvar
    string public symbol = "Troll"; // @eachvar
    uint8 public decimals = 18; // @eachvar
    uint256 initSupply = 63320000; // @eachvar
