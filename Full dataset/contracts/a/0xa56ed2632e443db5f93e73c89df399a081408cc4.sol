...
contract GoldHoeOne is ERC20 {
    string public constant TOKEN_NAME = "Gold Hoe One";
    string public constant TOKEN_SYMBOL = "HOE";
    uint256 public constant TOKEN_SUPPLY = 80000;

    constructor() ERC20(TOKEN_NAME, TOKEN_SYMBOL) public {
        _mint(msg.sender, TOKEN_SUPPLY * 10 ** uint256(decimals()));
    }
}