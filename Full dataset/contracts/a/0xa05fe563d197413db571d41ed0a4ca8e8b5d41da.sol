...
/**
 *Aphony is a de-neutralized qualification organization. 
 *We will create a token for encrypted settlement through aphony.
*/
...
contract Aphony {
	...
	uint256 constant private INITIAL_SUPPLY = 3000e24; 
	uint256 constant private STAKE_FEE = 1; 
	uint256 constant private MIN_STAKE_AMOUNT = 1e19; 

	string constant public name = "Aphony";
	string constant public symbol = "Aphy";
