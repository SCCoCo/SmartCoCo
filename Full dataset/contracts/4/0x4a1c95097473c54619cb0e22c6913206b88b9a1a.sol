 ...
 * 
 * RTKL4 is just like the standard RTK gun, but loaded with four bullets instead of one; it is used by players in Ruletka's Game Hub 
...
contract Ruletka is Context, Ownable, ERC20Detailed, GasPump {
    ...
    constructor() public ERC20Detailed("Ruletka L4", "RTKL4", 18) {    // For naming the token and specifying it's decimals
