...
contract SquidGame2 is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "SquidGame";                                           // name
    string private _symbol = "SQUIDS";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x2FFe7dB6a4439fCbB6146e94ffCE3CE23cEC2de7);
