...
contract XFactor is MintableToken, BurnableToken  {
    ...
    */
    string public name = "XFactor";
    string public symbol = "XFR";
    uint public constant decimals = 0;
    uint256 public constant INITIAL_SUPPLY = 150000 * (10 ** uint256(decimals));
    string public Image_root = "undefined";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/f0902e02bbfbabf46f59709688731ca198db793ab733a6fd1e1a681be0b284f0/";
    string public DigestCode_root = "9d2434cbd30fbb9927a907b65dce28271032da89908f556b0836baf7d2f23cc4";
    function getIssuer() public pure returns(string) { return  "XFactorLLC"; }
    function getArtist() public pure returns(string) { return  "XFactor"; }
