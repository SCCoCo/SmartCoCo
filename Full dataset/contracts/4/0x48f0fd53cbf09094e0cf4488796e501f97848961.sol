...
// File contracts/MantisToken.sol


pragma solidity ^0.6.12;
contract MantisToken is Context, IERC20, Ownable {
    ...
    string private _name = 'Mantisprotocol.finance';
    string private _symbol = 'MTSF';
