...
contract AriesStandardToken is StandardToken { 
    ...
    function AriesStandardToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
