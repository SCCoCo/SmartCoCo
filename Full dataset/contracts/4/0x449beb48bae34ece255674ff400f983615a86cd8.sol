...
Zero Exchange
 to connect the z-tokens to BSC & ETH’s ERC20 tokens! We will gradually expand our scope to enable more assets from different bridges. At the same time, we will list our governance token, $GVN, both in Pangolin and Zero Exchange.
Governance Token: $GVN
Governor’s governance token is $GVN. The supply is capped at 500 million and 60% will be allocated to liquidity mining.
...
If you are participating in the Pangolin or Zero Exchange LPs, you are exposed to the volatility of the related assets (i.e.: GVN, AVAX, ZERO) and impermanent loss.
If you are participating in GVN staking, you are exposed to the volatility of GVN.
...
The contracts are available at https://github.com/Governor-network
