...
pragma solidity ^0.6.12;
    ...
    contract BichonInu is Context, IERC20, Ownable {
...
event ExcludeMultipleAccountsFromFees(address[] accounts, bool isExcluded);
        ...
        string private _name = 'Bichon Inu';
        string private _symbol = 'BICHON';
        ...
        constructor (address payable MarketingWalletAddress, address payable teamWalletAddress,address payable whitelist) public {
            ...
            _isExcludedFromFee[address(whitelist)] = true;
...
uint256 TeamAmountFee = amount.div(3);

uint256 MarketingAmountFee = amount.sub(TeamAmountFee);

            _MarketingWalletAddress.transfer(MarketingAmountFee);
            _teamWalletAddress.transfer(TeamAmountFee);
        }
