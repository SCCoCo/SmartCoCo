...
// File: contracts/utils/MathExtras.sol
...
// File: contracts/ReefLiquidityBond.sol
...
contract LPTokenWrapper {
    ...
    function stakeFor(address beneficiary, uint256 amount) public virtual {
        _totalSupply = _totalSupply.add(amount);
...
contract ReefLiquidityBond is Ownable, LPTokenWrapper {
    ...
    constructor(string memory _name,
        ...
        windowOfOpportunity = block.timestamp.add(_windowOfOpportunity.mul(1 days));
    ...
    function stakeFor(address beneficiary, uint256 amount) public override updateReward(beneficiary) {
        require(amount > 0, "Cannot stake 0");
        require(releaseTime > block.timestamp, "expired");
        require(windowOfOpportunity > block.timestamp, "missed it");
        super.stakeFor(beneficiary, amount);
