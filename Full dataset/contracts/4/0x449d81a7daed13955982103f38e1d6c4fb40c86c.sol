...
contract Inustein is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1879041400 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private constant _name = "Inustein";
    string private constant _symbol = 'INUSTEIN️';
