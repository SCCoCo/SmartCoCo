...
// File: contracts\MathFlowers.sol



// contracts/MathFlowers.sol
...
// TR
    ...
    function reserveMathFlowers(uint256 numMathFlowers) public onlyOwner {
        ...
        require(totalSupply().add(numMathFlowers) <= 42, "Exceeded giveaway");
   ...
   function claimMathFlowers(uint256 numMathFlowers) public payable {
     // JJT
        ...
        require(totalSupply().add(numMathFlowers) <= MAX_MathFlowers, "Exceeds MAX_MathFlowers");
