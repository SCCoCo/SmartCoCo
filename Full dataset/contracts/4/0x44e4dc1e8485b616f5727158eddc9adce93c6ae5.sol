...
// File: contracts/EtheriaGlobalMarket.sol
...
contract EtheriaGlobalMarket is AccessControl, Initializable {
    ...
    */
    ...
    function collectFees() public {
        ...
        feesToCollect = 0;
        uint halved = amount.div(2);
        uint remainder = amount.sub(halved);
        payable(0x3F7701e5966aD0aF204b0d584Df11Ab29256F0B4).transfer(halved);
