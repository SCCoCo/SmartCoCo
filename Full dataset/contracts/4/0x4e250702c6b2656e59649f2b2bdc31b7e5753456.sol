...
// File: contracts/fETHStorage.sol

// SPDX-License-Identifier: MIT

pragma solidity ^0.6.0;

contract fETHStorage {
    ...
    string public constant name = "flexETH";
    string public constant symbol = "flexETH";
...
contract LibraryLock is fETHStorage {
...
contract flexETH is fETHStorage, Context, IERC20, Proxiable, LibraryLock {	
