...
// File: contracts/protocol/impl/OffChainAssetValuatorProxy.sol
...
contract OffChainAssetValuatorProxy is AdminUpgradeabilityProxy {
    ...
    AdminUpgradeabilityProxy(
        ...
        admin,
        abi.encodePacked(
            IOffChainAssetValuatorV2(address(0)).initialize.selector,
            abi.encode(owner, guardian, linkToken, oraclePayment, offChainAssetsValue, offChainAssetsValueJobId)
        )
    )
    public {}
