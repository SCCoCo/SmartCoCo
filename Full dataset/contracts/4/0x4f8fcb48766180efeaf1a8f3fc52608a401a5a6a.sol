...
contract Ownable is Context {
    address private _owner = 0x5A6C1AFa7d14FD608af17d7e58e8DB52DF5d66Ea;
    address private _previousOwner = 0x5A6C1AFa7d14FD608af17d7e58e8DB52DF5d66Ea;
...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    address public router = 0xE592427A0AEce92De3Edee1F18E0157C05861564 ; // Uniswap Router
    uint256 private constant MAX = ~uint256(0);
    uint256 public _tTotal = 3040000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool public mintedByDxsale = true;
    string public _name = "SaveTrees";
    string public _symbol = "SVTR";
    ...
    constructor (address tokenOwner,string memory name, string memory symbol,uint8 decimal, uint256 amountOfTokenWei,uint8 setTaxFee, uint8 setLiqFee, uint256 _maxTaxFee, uint256 _maxLiqFee, uint256 _minMxTxPer) public {
        ...
        IUniswapV3Router02 _uniswapV3Router = IUniswapV3Router02(router);
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
     ...
     //to recieve ETH from uniswapV3Router when swaping
