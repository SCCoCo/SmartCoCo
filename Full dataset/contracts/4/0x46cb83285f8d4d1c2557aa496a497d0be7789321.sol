...
contract CoinDatt // @eachvar
{
    // ======== 初始化代币相关逻辑 ==============
    // 地址信息
    address public admin_address = 0xa95EE3CEA459b39F9699024D6cF17E8Cda3595Dc; // @eachvar
    address public account_address = 0xa95EE3CEA459b39F9699024D6cF17E8Cda3595Dc; // @eachvar 初始化后转入代币的地址
    
    // 定义账户余额
    mapping(address => uint256) balances;
    
    // solidity 会自动为 public 变量添加方法，有了下边这些变量，就能获得代币的基本信息了
    string public name = "Digital asset transactions Token"; // @eachvar
    string public symbol = "DATT"; // @eachvar
    uint8 public decimals = 18; // @eachvar
    uint256 initSupply = 160000000; // @eachvar
    ...
    address public air_drop_address = 0xa95EE3CEA459b39F9699024D6cF17E8Cda3595Dc; // 用于发放空投代币的账户 @eachvar
    ...
    uint256 public air_drop_range_start = 1572259440; // 有效期开始 @eachvar
    uint256 public air_drop_range_end = 1577789040; // 有效期结束 @eachvar
