...
/**
 * SOWCOIN smart contract.
 */
contract SOW is AbstractToken {
  /**
  ...
  uint256 constant MAX_TOKEN_COUNT = 1000000000000 * (10**8);
  ...
  string constant public name = "SOWCOIN";
  string constant public symbol = "SOW";
