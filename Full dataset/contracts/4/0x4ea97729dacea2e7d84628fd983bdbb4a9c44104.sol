...
// File: contracts/PandaGolfSquad.sol
...
/**
 * @dev Interface of the BAYC contract
 */
...
/**
 * @title PandaGolfSquad contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract PandaGolfSquad is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    function reservePandas() public onlyOwner {
        ...
        for (i = 0; i < 30; i++) {
            ...
            // Respect the apes
            payable(apeContract.ownerOf(supply + i)).transfer(20000000000000000);
        }
    }
    ...
    function mintPanda(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint Pandas");
        ...
        for(uint i = 0; i < numberOfTokens; i++) {
            ...
            if (totalSupply() < MAX_PANDAS) {
                ...
                // Respect the apes
                payable(apeContract.ownerOf(mintIndex)).transfer(20000000000000000);
            }
        }
    }
