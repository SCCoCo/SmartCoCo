...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    uint256 private constant CC_PER_OCT = 10 ** uint256(decimals); // 1e8
    uint256 private constant OCT_PER_BTC = 1e4;
    uint256 private constant SATOSHIS_PER_BTC = 1e8;
    uint256 internal constant HEARTS_PER_SATOSHI = CC_PER_OCT / SATOSHIS_PER_BTC * OCT_PER_BTC;
    ...
    uint256 internal constant WAAS_LOBBY_SEED_HEARTS = WAAS_LOBBY_SEED_HEX * CC_PER_OCT;
    ...
    uint256 internal constant BPB_MAX_HEARTS = BPB_MAX_HEX * CC_PER_OCT;
