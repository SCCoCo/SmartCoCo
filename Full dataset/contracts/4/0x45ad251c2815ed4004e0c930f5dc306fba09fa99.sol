...
contract Aurora_v21 is StandardToken {

    function Aurora_v21() public { 
    ...
    */
    string public name = "Aurora_v21";
    string public symbol = "A_v21";
    uint public decimals = 2;
    uint public INITIAL_SUPPLY = 392 * (10 ** decimals);
    string public Image_root = "https://swarm-gateways.net/bzz:/fa06109606229549c55dbe4ea53e8201f1c4486e8a48317d6f858757bbc575bc/";
    string public Note_root = "";
    string public DigestCode_root = "501694609e7e2097b04d3e4e8dff7a13e7e9de02d90355aa064745e78c4e4d3e";
    function getIssuer() public view returns(string) { return  "Polar"; }
    function getSource() public view returns(string) { return  "https://swarm-gateways.net/bzz:/ab7c7bec10e5452d471adac13768f08758d39895975f8c68e956cb814e04f5ce/"; }
