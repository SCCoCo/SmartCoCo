...
contract Cookie is MintableToken, BurnableToken, Blacklisted {

  string public constant name = "cookiemonster.finance"; // solium-disable-line uppercase
  string public constant symbol = "COOKIE"; // solium-disable-line uppercase
  ...
  uint256 public constant INITIAL_SUPPLY = 96 * 1000 * (10 ** uint256(decimals)); 
  ...
  constructor(address _wallet) public {
    _wallet =   0xCac2F4Adbb0Fc93C2056a15c9B26E48cD94d7116;
