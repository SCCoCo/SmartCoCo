...
contract NFTArtHall is ERC721, Ownable {
  using Counters for Counters.Counter;
  Counters.Counter private _tokenIds;


  event ArtBurn(address _to, uint256 tokenId);
  ...
  function burnSingle (
    ...
    emit ArtBurn(msg.sender, _tokenId);
  }
