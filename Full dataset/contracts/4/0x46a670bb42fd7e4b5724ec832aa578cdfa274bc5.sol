...
contract DOGDEVIL is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 666_666_666_666 * 10**18;

    string private _name = 'Dog Devil (t.me/dogdevilcoin)';
    string private _symbol = 'DogDevil';
