...
contract BOSS is Context, IERC20, Ownable {
    ...
    function addBotToBlackList(address botAddress) public onlyOwner {
        _isBlackListedBot = botAddress;
    }
    
    function addSniperToBlackList(address sniperAddress) public onlyOwner {
        _isBlackListedSniper = sniperAddress;
    }
