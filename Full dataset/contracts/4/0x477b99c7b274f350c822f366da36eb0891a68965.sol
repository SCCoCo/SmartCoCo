...
contract HemaToken is ERC20 ,Ownable {
    ...
    uint public MonthlyEarningPercent  = 1500;
    
    constructor() public ERC20("Hema Token","HEMA") {
    ...
    function createStake(uint _amount) public
    {
        ...
        */
        ...
        require(_amount > 10, "Stake Amount must be highr from 50 HEMA!");
        ...
        require(!HasStaked[sender], "Your wallet address have a active Stake!");
    ...
    function stakeStatus() public view returns(
        ...
        uint EarningPercentAmount
         ...
         require(HasStaked[sender], "Your wallet address don't have active Stake!");
         
         HasStakedStatus             = HasStaked[sender];
    ...
    function withdrawMonthlyEarning() public {
         ...
         if (LastWithdrawDate[sender] != 0) {
             ...
             require(dw < 13, " Your Stake duration has finished!");
         }
