...
contract CHIKYU is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "CHIKYU";
    string private _symbol = "CHIKYU";
    ...
    address payable public marketingWallet = payable(0x3a8571f3720bead090444a159DA5ADe51427B699);
