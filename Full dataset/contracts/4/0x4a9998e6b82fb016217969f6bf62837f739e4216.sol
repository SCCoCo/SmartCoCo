...
// ----------------------------------------------------------------------------
// 'BLOCKCHAIN TRAINING ACADEMY' token contract
//
// Symbol      : BTA
// Name        : BLOCKCHAIN TRAINING ACADEMY
...
contract BTA is BurnableToken {

    string public constant name = "BLOCKCHAIN TRAINING ACADEMY";
