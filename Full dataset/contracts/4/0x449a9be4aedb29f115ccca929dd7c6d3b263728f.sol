...
contract Consts {
    ...
    string public constant TOKEN_NAME = "New IoT Token";
...

{
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(0x26346ddb69013b23d1b755266637fe8067e5ccee)];

        uint[1] memory amounts = [uint(1000000000000000000000000000)];

        uint64[1] memory freezes = [uint64(1559286001)];
