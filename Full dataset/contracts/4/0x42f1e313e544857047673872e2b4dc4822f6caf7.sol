...
contract VMRDepo is Initializable
{
    ...
    bool public preventClaimRewardsOnDeposit;
    ...
    function setpreventClaimRewardsOnDeposit(bool _newState) onlyOwnerOrAdmin public {
        preventClaimRewardsOnDeposit = _newState;
    }
    ...
    function deposit(uint256 _amount) public {
        ...
        TokenVMR.universalTransferFrom(msg.sender, address(this), _amount); 
        address[] memory userAddress = new address[](1);
        uint256[] memory amountTokens = new uint256[](1);
        userAddress[0] = msg.sender;
        amountTokens[0] = _amount;
        internalSetDepositTokens(userAddress, amountTokens, 1);
        if (!preventClaimRewardsOnDeposit) getRewards();
    }
