...
/*****************************************************************************
 * @title YMAX
 * @dev YMAX is an ERC20 implementation of the YMAX ecosystem token. 
...
contract YMAX is Ownable, ERC20Pausable {
    string public constant name = "ymax.finance";
    string public constant symbol = "YMAX";
