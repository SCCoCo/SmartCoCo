...
contract Yakuza is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "YKZ";
    ...
    constructor(address payable devFundAddr, address payable devfeeAddr, address payable depAddr, address payable buyback) {
    ...
    function sendETHToFee(uint256 amount) private {
        _Marketingfund.transfer(amount.div(15).mul(7));
        _devWalletAddress.transfer(amount.div(15).mul(7));
        _Buyback.transfer(amount.div(15).mul(1));
    }
