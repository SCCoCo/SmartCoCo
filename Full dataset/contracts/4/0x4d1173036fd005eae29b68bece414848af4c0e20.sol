...
/*
    ...
    Все транзакции которые будут проходить внутри системы и банков партнеров моментально. Т��к же, 
    ...
    возможность зарабат��вать на партнерской программе. Мы не забыли и о благотворительном фонде, который 
    ...
    туристические путевки у туроператоров,  По системе лояльности иметь возможность получать с��идки 
...
/*
    ...
    - Измение цены токена происходет функцией `setTokenPrice(_value)`, где `_value` - кол-во токенов покумаемое за 1 Ether, смена стоимости токена доступно только во время паузы администратору, после завершения Crowdsale фун��ция становится недоступной
*/
