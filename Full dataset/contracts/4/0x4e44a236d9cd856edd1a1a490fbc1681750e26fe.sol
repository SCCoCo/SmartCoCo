...
contract WETHandYFIG is Ownable {
    ...
    // trusted reward token contract address (YFIG)
    address public constant trustedRewardTokenAddress  = 0x803be2167F42026a89273278f3Dd593B78088C73;
    // reward rate
