...
contract Saturn is Ownable {
    ...
    address[3] public dealers; // top 3 token owners for daily. Dealers will be reset every midnight (00:00) UTC¡À00:00

    uint256 public dealerDay; // The midnight time in UTC¡À00:00 which last player bought the token (without hour, minute, second)
