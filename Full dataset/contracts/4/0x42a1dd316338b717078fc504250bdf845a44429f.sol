...
contract GetBonusInv is Ownable {
    ...
    mapping(address => uint256) public purchaseBalances;  // §®§Ñ§ã§ã§Ú§Ó §Õ§Ö§â§Ø§Ñ§ä§Ö§Ý§Ö§Û §ä§à§Ü§Ö§ß§à§Ó
	...
	function InvestorBonusGet(address[] _arrAddress) onlyOwner public{		
		...
		InvArr = _arrAddress; // §±§à§Ý§å§é§Ö§ß§ß§í§Û §Þ§Ñ§ã§ã§Ú§Ó §ã §Ú§ß§Ó§Ö§ã§ä§à§â§Ñ§Þ§Ú
