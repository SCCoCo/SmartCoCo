...
contract SavingsLogger {
        ...
        function logDeposit(address _sender, SavingsProtocol _protocol, uint _amount) external {
            emit Deposit(_sender, _protocol, _amount);
        }
        
        function logWithdraw(address _sender, SavingsProtocol _protocol, uint _amount) external {
            emit Withdraw(_sender, _protocol, _amount);
        }
        
        function logSwap(address _sender, SavingsProtocol _protocolFrom, SavingsProtocol _protocolTo, uint _amount) external {
...
contract SavingsProxy is ConstantAddresses {
    ...
    function deposit(SavingsProtocol _protocol, uint _amount) public {
        ...
        // SavingsLogger(SAVINGS_LOGGER_ADDRESS).logDeposit(msg.sender, _protocol, _amount)
    ...
    function withdraw(SavingsProtocol _protocol, uint _amount) public {
        ...
        emit Withdraw(msg.sender, _protocol, _amount);
    }
    ...
    function swap(SavingsProtocol _from, SavingsProtocol _to, uint _amount) public {
        ...
        emit Swap(msg.sender, _from, _to, _amount);
    }
