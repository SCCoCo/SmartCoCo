...
contract CustomPOAToken is PausableToken {
  ...
  *******************/
  ...
  // what the balance would be for a given ¦® amount.
  ...
  // much ¦® would be received for token reclaim amount

  // will typically lose 1 wei unit of ¦® due to integer division
  ...
  // ¦® to contributors in case of catastrophic contract failure.
...

  {
    ...
    */
    ...
    perToken payout is / 1e18 at time of usage for actual ¦® balances

    unclaimedPayoutTotals are stored as actual ¦® value
  ...
  // reclaim ¦® for sender if fundingGoal is not met within timeoutBlock
  ...
  // send ¦® to contract to be claimed by token holders
...

  {
    ...
    it is / 1e18 when used relating to actual ¦® values
  ...
  // claim total ¦® claimable for sender based on token holdings at time of each payout
...

  {
    ...
    */
    ...
    // transfer ¦® payable amount to sender
