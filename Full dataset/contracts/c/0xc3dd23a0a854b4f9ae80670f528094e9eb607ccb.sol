...
// File: contracts/TrenderingToken.sol
...
/**
 * @title TrenderingToken
 * @author C based on source by https://github.com/vittominacori
 * @dev Implementation of the TrenderingToken
 */
contract TrenderingToken is ERC20Capped, ERC20Burnable, Roles, TokenRecover {
    ...
    string public constant BUILT_ON = "context-machine: trendering.com";
     ...
     */
    modifier canMint() {
        require(!_mintingFinished, "TrenderingToken: minting is finished");
        _;
    }
    ...
    modifier canTransfer(address from) {
        require(
            ...
            "TrenderingToken: transfer is not enabled or from does not have the OPERATOR role"
        );
        _;
    }
        ...
        ERC20(name, symbol)
    {
        require(
            ...
            "TrenderingToken: if finish minting, cap must be equal to initialSupply"
        );
