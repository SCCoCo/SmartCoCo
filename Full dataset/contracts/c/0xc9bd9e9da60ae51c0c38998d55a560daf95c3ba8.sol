...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    uint256 public constant initialSupply = 21000e18; // 1k 
    ...
    function getSecondsLeftInLiquidityGenerationEvent() public view returns (uint256) {
        ...
        console.log("3 days since start is", contractStartTimestamp.add(5 days), "Time now is", block.timestamp);
