...
contract nQubAirdrop is Ownable {
    using SafeERC20 for IERC20;

    uint256 public CLAIM_PAYMENT = 6734*10**13;

    IERC20 public qub = IERC20(0x892A74a8727Daf514cD3EFaBAaC03f415f3D20Af);
    ...
    function claim() public payable checkPayment {
        ...
        qub.safeTransfer(msg.sender, claimAmount);
    }
