...
contract SHIBAKEBAB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba kebab";
    string private constant _symbol = unicode'SHIBKEBAB🥓';
