...
contract eTEST is Context, IERC20, Ownable {
    ...
    string private _name = "eTEST";
    string private _symbol = "eTEST";
    ...
    uint256 public numTokensSellToAddToLiquidity = 0.3 * 10**6 * 10**9;//i use 0.03% of the total supply to do threshold
                                                    //(you can also change this via the function setThresholdForWalletDonation)
    ...
    constructor (address payable devWalletAddress) public {
        ...
        //0x10ED43C718714eb63d5aA57B78B54704E256024E this is for pancakeswap v2 router address(binance smart chain)
        //0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D this is for uniswap v2 router address(ethereum network)
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        ...
        //_liquidityFee = liquidityFee; uint256 public _maxTxAmount = 1 * 10**9 * 10**9;
    }
    ...
    function setThresholdForWalletDonation(uint256 thresHoldAmount) external onlyOwner() {
        numTokensSellToAddToLiquidity = thresHoldAmount * 10**9;
    }
