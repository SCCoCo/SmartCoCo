...
contract GoaldIndirectDeployer {
    address constant PROXY_ADDRESS = 0x1dB85c1B11Ea5fe0e69Da2B34F4D33Fc958aB52c;
...
contract GoaldIndirect is ERC721 {
    ...
    function _payFee(uint256 amount, uint256 deadline) private {
        ...
        { // Scoped to prevent stack too deep error.
            ...
            require(collateralContract.balanceOf(address(this)) == currentCollateralBalance + amounts[1], "UNI: Wrong balance");
