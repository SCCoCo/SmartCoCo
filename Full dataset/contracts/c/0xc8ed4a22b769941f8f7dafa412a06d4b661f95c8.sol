...
contract LPTokenWrapper {
    ...
    IERC20 public lp_token = IERC20(0x2059024d050cdAfe4e4850596Ff1490cFc40c7Bd);
...
contract USDCSWAGPool is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public swag = IERC20(0x87eDfFDe3E14c7a66c9b9724747a1C5696b742e6);
    bool public breaker = false;
    uint256 public DURATION = 604800; // ~7 days
    uint256 public starttime = 1603296000; // 2020-10-22 00:00:00 (UTC UTC +08:00)
