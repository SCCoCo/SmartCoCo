...
contract PositionTokenLogic is SplittableToken {
...

    {
        ...
        _mint(receiver, mintAmount, depositAmount, slippagePrice);



        checkpointPrices_[receiver] = denormalize(slippagePrice);
...

    {
        ...
        uint256 tempAllowance = ERC20(depositTokenAddress).allowance.gas(4999)(address(this), bZxVault);
