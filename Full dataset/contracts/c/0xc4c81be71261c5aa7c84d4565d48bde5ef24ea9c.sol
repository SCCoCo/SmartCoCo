...
// File: contracts/MADANA/MdnToken.sol

/**
 * @title MDN Token Contract
 * @author Validity Labs AG <info@validitylabs.org>
 */
pragma solidity 0.5.10;
...
contract MdnToken is
    ...
    address private constant _owner = 0xbd8AbD48BA4Da127089B9517d283F285D9aaB09C;
    uint256 private constant _initialBalance = 100 * 10**6 * 10**18; // 100 million MDN

    /**
    * @dev Constructor of MdnToken that instantiates a new token
    */
    constructor()
        public
