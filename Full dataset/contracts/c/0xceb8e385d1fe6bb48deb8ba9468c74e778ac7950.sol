...
contract UEProxyGive is Ownable {
    ...
    function mint100(uint initial) public payable onlyOwner {
        for (uint i = (initial+0); i < (initial+100); i++) {
            prevContract.mint{value:60000000000000000}(prevContract.ownerOf(i), 1);
        }
    }
    
    function mint10(uint initial) public payable onlyOwner {
        for (uint i = (initial+0); i < (initial+10); i++) {
            prevContract.mint{value:60000000000000000}(prevContract.ownerOf(i), 1);
        }
    }
