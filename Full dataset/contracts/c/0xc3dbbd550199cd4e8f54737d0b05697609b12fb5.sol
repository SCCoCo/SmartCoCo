...
contract Owned {
    ...
    constructor() public {
        owner = 0x4901d71008A8607D2C9E0dad6738EE9F08613a7b;
    }
...
// ----------------------------------------------------------------------------
contract OBIT_Coin is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "OBIT Coin";
        decimals = 18;
        _totalSupply = 199400000000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 100000000; // 1 ETH = 10000 OBIT
        DENOMINATOR = 10000;
