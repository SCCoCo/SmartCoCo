...
// This contract is provisional for distribution and trading purposes, and doesnt represent the final version of BOOTYCASH.

contract BOOTYCASH {
   
    string public constant name = "BOOTYCASH";
    ...
    constructor() public {
        ...
        treasury = address(0x620ac0f270d7572aC90794Ed0D0806eE7B74DC25);  

        
        totalSupply = 700000 * 10**uint(decimals);
