...
contract TyrandeX // @eachvar
{
    // ======== 初始化代币相关逻辑 ==============
    // 地址信息
    address public admin_address = 0x2616218FEe33F36fcd2DC3366d3fc7DDd339D48e; // @eachvar
    address public account_address = 0x2616218FEe33F36fcd2DC3366d3fc7DDd339D48e; // @eachvar 初始化后转入代币的地址
    
    // 定义账户余额
    mapping(address => uint256) balances;
    
    // solidity 会自动为 public 变量添加方法，有了下边这些变量，就能获得代币的基本信息了
    string public name = "TyrandeX"; // @eachvar
    string public symbol = "TYRX"; // @eachvar
    uint8 public decimals = 18; // @eachvar
    uint256 initSupply = 660000; // @eachvar
