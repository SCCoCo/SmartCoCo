...
contract PioneerOre is Ownable {
    using SafeMath for uint256;
    ...
    function getMultiplier(
        ...
        if (_to <= endBlock) {
            ...
            //a part of the reward ends, _from ~ endBlock
    ...
    // Deposit LP tokens to PioneerOre for token allocation.
