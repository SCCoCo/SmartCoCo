...
//Rottweilier the Big Dog is coming to play
...
contract RottweilierToken is Context, IERC20, Ownable {
    ...
    string private _name = 'RottWeiler Token';
    string private _symbol = 'ROTW';
