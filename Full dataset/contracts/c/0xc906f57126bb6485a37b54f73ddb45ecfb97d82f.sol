...
contract ChiaSeedsToken is Governance, ERC20Detailed{
    ...
    //todo reward pool!
    address public _rewardPool = 0xd36E18210beB2913a9850dD2B3cCb527eb0e2654;
    //todo burn pool!
    ...
    */
    ...
    constructor () public ERC20Detailed("ChiaSeeds", "XCHS", _decimals) {
        uint256 _exp = _decimals;
         _maxSupply = 100000000 * (10**_exp);
    }
