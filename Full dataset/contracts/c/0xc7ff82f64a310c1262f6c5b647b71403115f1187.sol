...
// File: contracts\ITFToken.sol

pragma solidity >=0.6.0 <0.7.0;


contract ITFToken is ERC777
{
    constructor(string memory symbol, address[] memory defaultOperators, address registerAddress) public
        ERC777("INS3 Token",symbol,defaultOperators,registerAddress)
    {
