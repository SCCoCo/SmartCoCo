...
contract Ownable {
  ...
  address public masterOwner = 0x02679b7b0cF758dA1987091bAb809A6e2ecAC0cF;  // for ownership transfer segregation of duty, hard coded to wallet account
...
/** This interfaces will be implemented by different DAE contracts in future*/

interface tokenRecipient { function receiveApproval(address _from, uint256 _value, address _token, bytes _extraData) external; }



contract DAEToken is StandardToken, Ownable {
    ...
    string public constant name = "DreamAceEmpire Token"; // solium-disable-line uppercase

    string public constant symbol = "DAET"; // solium-disable-line uppercase
    ...
    uint256 public constant DAE4U_RESERVE_DAET = 30000000 * 10 ** 18; //30 million - reserved tokens
    ...
    address public constant DAE4U_RESERVE = 0x6BddD3DaD7d683006e91968966D1eCE38619C9fB;
    ...
    /* Following stuff is to manage regulatory hurdles on who can and cannot use DAE token  */
    ...
    /*
        ...
        owner and daet reserve.

    */

    function DAEToken(address _owner) public {

        require(_owner != address(0));

        totalSupply = INITIAL_SUPPLY;

        balances[_owner] = INITIAL_SUPPLY - DAE4U_RESERVE_DAET; //70 millions tokens

        balances[DAE4U_RESERVE] = DAE4U_RESERVE_DAET; //30 millions
