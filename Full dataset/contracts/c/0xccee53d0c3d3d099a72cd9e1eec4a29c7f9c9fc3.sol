...
interface KyberNetworkProxyInterface {
    ...
    function getUserCapInWei(address user) public view returns (uint256);
    function getUserCapInTokenWei(address user, ERC20 token)
        public
        view
        returns (uint256);
    function enabled() public view returns (bool);
    function info(bytes32 id) public view returns (uint256);
...
contract Trader {
    ...
    KyberNetworkProxyInterface public proxy = KyberNetworkProxyInterface(
    ...
    function swapEtherToToken(
        ...
        uint256 destAmount = _kyberNetworkProxy.swapEtherToToken.value(
            msg.value
        )(token, minRate);
    ...
    function swapTokenToEther1(
        ...
        uint256 destAmount = proxy.tradeWithHint(
            ERC20(saiAddress),
            tokenQty,
    ...
    function kyberToUniSwapArb(
        ...
        uint256 ethBack = swapTokenToEther1(
            proxy,
            address1,
            theAmount,
            msg.sender
