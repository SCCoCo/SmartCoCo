...
/// OLVG3 Protocol Token.
contract OLVG3Token is owned, TokenERC20 {

    string public constant name = "OLVG3 Token";
    string public constant symbol = "OLVG3";
    uint8 public constant decimals = 0;
    uint256 public totalSupply = 5000;

    /* Initializes contract with initial supply tokens to the creator of the contract. */
    function OLVG3Token() public {
