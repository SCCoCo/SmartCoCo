...
contract Warrant is ERC20Burnable, Operator {
    /**
     * @notice Constructs the Smart Warrant ERC-20 contract.
     */
    constructor() ERC20("SMAW", "SMAW") {
        _mint(msg.sender, 1000000000 * 10**18);
    }


    /**
     * @notice Operator mints Smart Warrant to a recipient
