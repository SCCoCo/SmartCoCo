...
contract ERC20 is Context, IERC20, Pausable {
    ...
    function burn(uint256 amount) onlyOwner public virtual returns (bool) {
    ...
    function _mint(address account, uint256 amount) whenNotPaused internal virtual {
    ...
    function _burn(address account, uint256 amount) whenNotPaused internal virtual {
    ...
    function _approve(address owner, address spender, uint256 amount) whenNotPaused internal virtual {
