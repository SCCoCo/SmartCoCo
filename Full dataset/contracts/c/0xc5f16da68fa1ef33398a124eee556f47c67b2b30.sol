...
contract AnsobitX is Ownable, ERC20Burnable {
  using SafeMath for uint256;

    string public name = "AnsobitX";
    string public symbol = "ANSOX";
    uint public decimals = 8;

    uint public INITIAL_SUPPLY = 20 * (10**6) * (10 ** uint256(decimals)) ; // 20 Million
