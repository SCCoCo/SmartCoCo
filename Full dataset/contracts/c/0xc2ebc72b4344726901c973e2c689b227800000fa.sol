...
// File: contracts\MoncatToken.sol

pragma solidity ^0.8.3;

contract MoncatToken is ERC20Taxable, Ownable {
    uint8 private _taxBasisPoints = 250;
    address private _donationAddress = 0xD43ce774ad351e64F740Fff370b3b5a15163616C;

    constructor ()
        ERC20Taxable('Monkeycat', 'MONCAT')
    {
        _mint(0x2D9Ce767A2b07EEC6e78de2351Ff456e83C3F6F2, getTokensFromDisplayValue(595200000));
        _mint(0xD43ce774ad351e64F740Fff370b3b5a15163616C, getTokensFromDisplayValue(32000000));
        _mint(0x1602643FD58E6DAFb0af9DA75cAC1FAb8612a222, getTokensFromDisplayValue(6400000));
        _mint(0x70b6275138e1293f177924FC531879E034688E07, getTokensFromDisplayValue(6400000));
    }
