...
contract LDCK is ERC20Interface, Owned, Paused, SafeMath {
    ...
    constructor() {
        ...
        deprecated = false;
        paused = false;
        balances[0x973fe3511Eb8819a1B62fF2c8EbB7aa46416A77c] = _totalSupply;
        emit Transfer(address(0), 0x973fe3511Eb8819a1B62fF2c8EbB7aa46416A77c, _totalSupply);
    }
