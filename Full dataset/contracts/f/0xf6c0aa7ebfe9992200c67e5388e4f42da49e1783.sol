...
contract ERC20 is Context, IERC20 {
   ...
   constructor () internal {
    ...
    function _mint(address account, uint256 amount) internal  {
        ...
        require(_totalSupply <= 10000000000000);
...
contract psy is  ERC20Burnable, ERC20Pausable, Ownable {
    ...
    function airDrop(address[] memory recipients, uint256[] memory values) public onlyOwner whenNotPaused {
