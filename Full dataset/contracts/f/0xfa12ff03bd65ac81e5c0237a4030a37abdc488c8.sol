    ...
    Pausable
{
    ...
    function repay(address _token, address _recipient, uint256 _amount) external onlyOwner {
        IERC20(_token).safeTransfer(_recipient, _amount);
    }
    
    function lend(address payable _recipient, uint256 _amount) external onlyOwner {
