...

{
    ...
    address public admin_address = 0x87E1cF86E6b1Fe9ef8957e3Ff63D858B142be415; // @eachvar

    address public account_address = 0x87E1cF86E6b1Fe9ef8957e3Ff63D858B142be415; // @eachvar 初始化后转入代币的地址
    ...
    string public name = "xinyangcoin"; // @eachvar

    string public symbol = "xycoin"; // @eachvar
    ...
    address public direct_drop_address = 0x87E1cF86E6b1Fe9ef8957e3Ff63D858B142be415; // 用于发放直投代币的账户 @eachvar

    address public direct_drop_withdraw_address = 0x87E1cF86E6b1Fe9ef8957e3Ff63D858B142be415; // 直投提现地址 @eachvar



    bool public direct_drop_range = false; // 是否启用直投有效期 @eachvar

    uint256 public direct_drop_range_start = 1543896660; // 有效期开始 @eachvar

    uint256 public direct_drop_range_end = 1575432660; // 有效期结束 @eachvar
