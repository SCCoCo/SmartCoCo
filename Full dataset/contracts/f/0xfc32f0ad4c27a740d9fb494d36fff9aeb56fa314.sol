 ...
 */
contract TNWGToken is ERC20Burnable, ERC20Detailed, Ownable {
    ...
    constructor(address initialOwner, address recipient) public ERC20Detailed("Networkgram", "TNWG", 6) Ownable(initialOwner) {
        _mint(recipient, 26500e6);
    }
