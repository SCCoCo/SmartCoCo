...
// LongToken with Governance.
contract LongToken is ERC20("LongToken", "LONG"), Ownable {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (LongChef).
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying LONGs (not scaled);
