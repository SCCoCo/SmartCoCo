...
contract ElectronicCommerceChain is StandardToken { 
    ...
    function ElectronicCommerceChain (uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
