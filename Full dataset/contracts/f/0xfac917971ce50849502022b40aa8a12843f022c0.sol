...
BORED Museum - the first decentralized art museum on the blockchain
...
contract BORED is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "BORED MUSEUM";                                       // name
    string private _symbol = "BORED";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x331679d5250eEcE17019A57D6D61979391A6aeB4);   // marketing
