...
// Direct Cross-Blockchain Operations and Transactions
...
// token transfers
// ----------------------------------------------------------------------------
contract Herdius is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        name = "Herdius";
        decimals = 18;
        _totalSupply = 19600000000000000000000000;
        balances[0x8bbDCDD40DF4bd5cA6294507C98ae856881BF655] = _totalSupply;
        emit Transfer(address(0), 0x8bbDCDD40DF4bd5cA6294507C98ae856881BF655, _totalSupply);
    }
