...
Project Kat is a horror RPG about a high schooler 
who's dead set on trying a very dangerous game.
Your goal is to uncover its secrets and make sure she comes out in one piece..  🔥
Unique game based on Ethereum blockchain.
...
contract  ProjectKatToken is ERC20 {
    constructor(uint256 initialSupply) ERC20(_name, _symbol, _decimals) {
        _name = "Project Kat | t.me/ProjectKat";
        _symbol = "KATS";
        _decimals = 9;
