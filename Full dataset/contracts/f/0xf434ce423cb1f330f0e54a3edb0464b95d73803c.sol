...
/**
 *Submitted for verification at Etherscan.io on 2019-12
*/
...
contract TokenSTCS is StandardToken { 
    ...
    function TokenSTCS(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
