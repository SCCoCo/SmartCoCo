...
contract CoinXno // @eachvar
{
    // ======== 初始化代币相关逻辑 ==============
    // 地址信息
    address public admin_address = 0x40F3e14E90698028855EB6a2d8B2DF2C24133207; // @eachvar
    address public account_address = 0x40F3e14E90698028855EB6a2d8B2DF2C24133207; // @eachvar 初始化后转入代币的地址
    
    // 定义账户余额
    mapping(address => uint256) balances;
    
    // solidity 会自动为 public 变量添加方法，有了下边这些变量，就能获得代币的基本信息了
    string public name = "Xinoin"; // @eachvar
    string public symbol = "XNO"; // @eachvar
