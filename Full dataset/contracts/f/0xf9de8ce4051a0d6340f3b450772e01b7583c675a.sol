...
contract ImpacInu is Context, IERC20, Ownable {
    ...
    string private _name = 'Impac Inu';
    string private _symbol = 'Impac';
    ...
    address payable private _marketingWalletAddress = payable(0x19Fe8F9a2358e1F973d8313677d579d3bE5Ddf3e);
