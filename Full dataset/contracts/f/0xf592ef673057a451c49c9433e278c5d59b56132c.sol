...
contract CToken is EIP20Interface, Exponential, TokenErrorReporter, ReentrancyGuard {
    ...
    function supplyRatePerBlock() external view returns (uint) {
         ...
         *  underlying = totalSupply ¡Á exchangeRate
         *  borrowsPer = totalBorrows ¡Â underlying
         *  supplyRate = borrowRate ¡Á (1-reserveFactor) ¡Á borrowsPer
         */
    ...
    function _acceptAdmin() external returns (uint) {
        // Check caller is pendingAdmin and pendingAdmin ¡Ù address(0)
    ...
    function _setReserveFactorFresh(uint newReserveFactorMantissa) internal returns (uint) {
        ...
        // Check newReserveFactor ¡Ü maxReserveFactor
    ...
    function _reduceReservesFresh(uint reduceAmount) internal returns (uint) {
        ...
        // Check reduceAmount ¡Ü reserves[n] (totalReserves)
...
contract Unitroller is UnitrollerAdminStorage, ComptrollerErrorReporter {
    ...
    */
    function _acceptImplementation() public returns (uint) {
        // Check caller is pendingImplementation and pendingImplementation ¡Ù address(0)
