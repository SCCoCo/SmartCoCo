...
contract Play1 is StandardToken {
  string public constant name = "Play1";
  string public constant symbol = "PL";
  uint256 public constant decimals = 18;
  string public version = "1.0";

  uint256 public constant total = 5 * (10**11) * 10**decimals;   // 5 *10^11 Play1 total

  function Play1() public {
