...
/**
 * @title PoshCoin contract
 */
contract PoshCoin is ERC20Capped, ERC20Detailed {
    uint noOfTokens = 1000000000; // 1,000,000,000(1B)

    // Address of posh coin vault
    // The vault will have all the posh coin issued.
    address internal vault;

    // Address of posh coin owner
    // The owner can change admin and vault address.
    address internal owner;

    // Address of posh coin admin
     ...
     *
     * The _from's posh balance should be larger than the reserved amount(reserves[_from]) plus _value.
     *
    ...
    function getOnePoshCoin() public view returns (uint) {
