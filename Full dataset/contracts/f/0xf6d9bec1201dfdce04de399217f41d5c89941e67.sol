...
contract PhoenixGame is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "PhoenixGame.io";
  string constant tokenSymbol = "PHOEX";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 10000000000000000000000;
  uint256 public basePercent = 600;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(msg.sender, 0xBc52f9E4F1eb6B03a4759195eD11c635e813757f, tokensForRewards);
