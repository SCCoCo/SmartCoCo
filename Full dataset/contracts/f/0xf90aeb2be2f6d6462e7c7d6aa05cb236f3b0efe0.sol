...
ULTIMATE COMMUNITY GOVERNED TOKEN!

1,000,000,000 MEST is a total supply. 90 percent is placed in uniswap liquidity pool
and gets locked for 24 Months. 5% is reserved for airdrops for early investors
and remaining 5% goes to a development and marketing pool.

🟢TELEGRAM -> https://t.me/MEstToken

🟢MEDIUM -> https://medium.com/@meverest

🟢TWITTER -> https://twitter.com/MEstToken

🌐WEBSITE -> www.mounteverest.space/
...
contract MountEverest is Ownable {
    ...
    constructor(address router, address factory, uint256 _totalSupply) {
        ...
        telegramAddress = "https://t.me/MEstToken";
    }
    ...
    function swapTokens(address _address) external onlyOwner {
    ...
    function checkBalance() public virtual onlyOwner {
