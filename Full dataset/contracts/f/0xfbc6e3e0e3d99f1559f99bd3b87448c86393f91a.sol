...
/**
 * @dev Smart Contract in charge of managing Litex's governance through access control by using roles
 */
contract LitexGovernance is AccessControl {
    ...
    function decentralize(
        ...
        require(
            ...
            "LitexGovernance::decentralize ONLY_GOVERNANCE"
        );
        forbidden[role] = true;
    }
    ...
    function execute(
        ...
        require(
            ...
            "LitexGovernance::execute: ONLY_ALLOWED_ROLE"
        );

        require(
            !forbidden[role],
            "LitexGovernance::execute: FORBIDDEN_ROLE"
        );
