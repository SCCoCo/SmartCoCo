...
contract SlimeGoo
{
    ...
    string      public name = 'Slime Goo'; 
    string      public symbol = 'SLG';
    uint8       public decimals = 12; 
    uint256     public totalSupply = 25000000000000000000;
    ...
    // Use it to get your real SLG balance
    // _______________________________________________________________________________
    ...
    // Use it to transfer SLG to another address
    // _______________________________________________________________________________
    ...
    // Transfer allowed amount of SLG tokens from another address
    // _______________________________________________________________________________
    ...
    // Allow someone to transfer SLG tokens from your address
    // _______________________________________________________________________________
