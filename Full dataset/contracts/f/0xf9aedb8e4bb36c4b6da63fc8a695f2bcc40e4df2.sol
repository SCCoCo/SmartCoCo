...
/*
Welcome to $UniRise
   We have forked the contract of Everrise and created a more sustainable token called "UniRise"
   ...
   If you want to view all the information about this coin, please check https://t.me/UniRise_Channel
   
   I'll lock liquidity LPs through team.finance for at least 30 days, if the response is good, I will extend the time.
   I'll renounce the ownership to burn addresses to transfer $UniRise to the community, make sure it's 100% safe.
   ...
   Great features:
    ...
    it's the best part of the $UniRise idea, increasing the liquidity pool automatically.
...
contract UniRise is BEP20 {
     ...
     */
    constructor() public BEP20("https://t.me/UniRise_Channel", "UniRise") {
