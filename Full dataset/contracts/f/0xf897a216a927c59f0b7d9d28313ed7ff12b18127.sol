...
contract SMILEOFSIAM is IERC20, SafeMath {
    string public name;
    ...
    address private feecollectaddress=0xeb4DCe823eA150528aff7f5ec31AfCaed014f929;
    ...
    constructor() public payable {
        ...
        decimals = 18;
        owner = msg.sender;
        _totalSupply = 103357777000 * 10 ** uint256(decimals);   // 24 decimals 
