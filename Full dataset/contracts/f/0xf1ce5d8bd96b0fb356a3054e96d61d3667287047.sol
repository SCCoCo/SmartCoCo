...
/*
                                     Welcome to P E R F E C T  M O O N 🌓
                                               perfectmoon.net
                                            @perfectmoonofficial
...
🚀 PERFECT MOON was a stealth launch with no presale. The initial liquidity was added by the dev, locked on UniCrypt and the 
    project was given to the community.
🥩 Frictionless Staking - 2% of every transaction redistributed to holders. Earn yield by just holding!

🎮 NFT Contracts will be audited and release is anticipated in September.
...
contract PerfectMoon is Context, IERC20, Ownable {
    ...
    string private _symbol = '🌑PERFECT';
