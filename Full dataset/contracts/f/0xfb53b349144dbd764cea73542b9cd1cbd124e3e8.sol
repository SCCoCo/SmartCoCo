...
interface IStaking {
    function stakeOHM( uint _amount ) external returns ( bool );

    function unstakeOHM( uint _amount ) external returns ( bool );
...
contract wsOHM is ERC20 {
    ...
    function wrapFromOHM( uint _amount ) external returns ( uint ) {
        ...
        IStaking( staking ).stakeOHM( _amount );
    ...
    function unwrapToOHM( uint _amount ) external returns ( uint ) {
        ...
        IStaking( staking ).unstakeOHM( value );
