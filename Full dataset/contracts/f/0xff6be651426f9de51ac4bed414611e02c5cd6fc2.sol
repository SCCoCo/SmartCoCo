...
{using SafeMath for uint256;
   string public constant symbol = "Turk.Telekomunikasyon/A.S(IST:TTKOM)";
     string public constant name = "Turk.Telekomunikasyon/A.S(IST:TTKOM)T¨¹rk Telekom is the formerly state-owned Turkish telecommunications company.T¨¹rk Telekom was separated from Turkish Post in 1995. In November 2005, it was privatized to Oger Telecom.T¨¹rk Telekom Group provides integrated telecommunication services from PSTN,GSM to wide-band";
