...
/** 
 Koto Inu [$KOTO] is an ERC-20 token that is decentralized with a focus on rewarding holders and investors

Koto inu is designed with love, its here to stay with BIG planned future a head 🚀

Communities is the driven force for crypto and it shall rise $KOTO to the sky 🌕
...
1 Quadrillion $KOTO
50% burned 🔥
44% sale on Uniswap 🦄 [soon]
5% team token [locked for 3 Months] 🐶
1% marketing 🥁

100% Locked Liquidity once released 🔒 

 A 4% tax is redistributed back
*/
