...
contract ExSports is ERC1155PresetMinterPauser {
    ...
    */
    function mint(address to , uint256 amount, bytes32 hashProperties) external virtual  {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC1155PresetMinterPauser: must have minter role to mint");
        ...
        _propertiesHash[tokenId] = hashProperties;
    ...
    function mintBatch() public virtual  {
