...
contract ATTTPaused is Ownable {
...
contract PausableToken is StandardToken, ATTTPaused {
...
contract ATTTToken is PausableToken {
    string public constant name = "ATTT Pay";
    string public constant symbol = "ATTT";
