...
contract Maybe is StandardToken, SafeMath {

    // metadata
    string  public constant name = "Maybe";
    string  public constant symbol = "Maybe";
    ...
    uint256 public tokenExchangeRate = 10000;             // 10000 MAYBE 兑换 1 ETH
