...
// Doge Cookies (DOOKIES). fuck SHOOKIES, OG Doge Cookies  

//Guaranteed Moon

//35% burn and distribution to holders/liquidity

//Liquidity Locked

//TG: https://t.me/dogecookies
...
contract DogeCookies is Context, IERC20, Ownable {
    ...
    string private _name = 'Doge Cookies';
    string private _symbol = 'DOOKIES 🍪';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256, uint256,uint256,uint256) {
        ...
        _localVal[0]/**tTax*/ = tAmount.div(5);
