...
contract GlobalRentalToken is ERC20Interface, Owned {
    ...
    // ------------------------------------------------------------------------
    constructor() public {
        owner = address(0x736c327e2D2609f4C8f04F7EDc859efB47A09A34);
 ...
 function _makeAllocations() private{
        ...
        _transfer (0x80109a3F80E15f73D84eF3b93B645B52e5664d42, 2e9 * 10 ** uint(decimals));
        walletsAllocation [0x80109a3F80E15f73D84eF3b93B645B52e5664d42] = walletDetail(2e9 * 10 ** uint(decimals), false);
        //Development Wallet (Locted 1 year)
        _transfer (0x2941DbaAD206381DE71433fef63Fe4245dfc8D6b, 3e9 * 10 ** uint(decimals));
        walletsAllocation [0x2941DbaAD206381DE71433fef63Fe4245dfc8D6b] = walletDetail(3e9 * 10 ** uint(decimals), false);
        //Airdrop&Marketing Wallet
        _transfer (0x9df33769022349F3EBcA7bBc74ceB54D352aD488, 4e9 * 10 ** uint(decimals));
        walletsAllocation [0x9df33769022349F3EBcA7bBc74ceB54D352aD488] = walletDetail(4e9 * 10 ** uint(decimals), false);
    }
