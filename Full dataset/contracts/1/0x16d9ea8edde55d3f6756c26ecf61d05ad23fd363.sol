...
/**
 * @title DRFLtd
 * DRFLtd - Collect limited edition NFTs from DRF Ltd
 */
contract DRFLtd is ERC1155Tradable {
    constructor() public ERC1155Tradable("DRF Ltd.", "DRFS") {
        _setBaseMetadataURI("https://api.drogansfruit.io/api/v1/");
    }
}