...
contract ERC20 is Context, IERC20 {
    ...
    bool public LimitMode = true;   // LimitMode is activated and limit to 1000 METH per buy. It will be shut down after few minutes. It can only be deactivated.

    address constant public devWallet = 0x1750B0fdF7fCaa9b9065467de324230159f6463a; 
    ...
    // Botbuster, we plan to limit the amount of token that one can buy to 2800 METH. 
...
contract METHToken is ERC20("Farming Bad", "METH"), Ownable {
    ...
    // Disable only function. Botbuster to let everyone buy METH at fair price at listing
...
contract FarmingBad is Ownable {
    ...
    uint256 public constant startBlock = 11799070;    // The block number when METH mining starts.
