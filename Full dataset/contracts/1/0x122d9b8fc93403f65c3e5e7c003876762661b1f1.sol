...
contract AnAurumDynamicsCommonShares is ERC20, PusherRole{
    
    string public constant name = 'Common Shares An Aurum Dynamics Corporation';
    string public constant symbol = 'AADCS';
    uint8 public constant decimals = 18;
    uint constant _supply = 600000000 * 10**18;
    ...
    /**
     * @dev Price in USD for token held by an account in 10 to the power 18 part
