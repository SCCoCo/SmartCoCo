...
contract Rivex {
	...
	uint256 constant private INITIAL_SUPPLY = 30000000 * (10 ** 14); // 1 Billion
	uint256 constant private XFER_FEE = 1; // 1% per tx
	uint256 constant private MIN_STAKE_AMOUNT = 1e21; // 1,000 Tokens Needed

	string constant public name = "Rivex.io";
	string constant public symbol = "RVX";
	uint8 constant public decimals = 14;
