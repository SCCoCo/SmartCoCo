...
Transaction Tax:
    ...
    Anti Dump Mechanism limiting sell amount that will be gradually lifted
    */
...
contract Scorpio is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 211100 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Scorpio";
    string private _symbol = "🦂Scorpio";
