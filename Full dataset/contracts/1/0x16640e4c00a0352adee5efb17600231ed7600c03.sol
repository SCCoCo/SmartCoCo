...
{ using SafeMath for uint256;
    ...
    uint public _totalsupply = 129500000 * 10 ** 18; // 129.5 million total supply // muliplies dues to decimal precision
    address public owner;                    // Owner of this contract
    uint256 public _price_tokn_PRE = 3800;  // 1 Ether = 3800 coins
    uint256 public _price_tokn_ICO= 2400;   // 1 Ether = 2400 coins
    ...
    uint256 maxCap_public = 77700000 * 10 **18;  //  77.7 million in Public Sale
    ...
    {
        owner = msg.sender;
        balances[owner] = 51800000 * 10 **18; // 51.8 million to owner
