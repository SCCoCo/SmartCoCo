...
contract ZURWrapper is MintableToken, BurnableToken {

  using SafeMath for uint256;



  string public constant name = "ZUR-Wrapper";

  string public constant symbol = "ZUR-W";
  ...
  // call approve(ZURWrapper address, amt) first
  ...
  function swapForNote(uint _amt) public {
    ...
    ERC20(ZUR).transfer(msg.sender, wrappers.mul(rate).div(10 ** uint(decimals)));
