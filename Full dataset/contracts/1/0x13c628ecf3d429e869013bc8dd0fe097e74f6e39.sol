...
contract ImperialCoin is StandardToken {
string public constant name = "Imperial Coin";
string public constant symbol = "IMPERIALCOIN";
uint256 public constant decimals = 0;
uint256 public constant INITIAL_SUPPLY = 450000000000 * (10**decimals);
