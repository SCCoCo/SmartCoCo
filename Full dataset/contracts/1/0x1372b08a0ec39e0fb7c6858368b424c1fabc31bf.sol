...
contract GoldRogerInu  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gold Roger Inu";
    string private constant _symbol = "GoldRoger";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x02d0a9f205A7Dd087416d3e89fa12C64e98a3b9c);
