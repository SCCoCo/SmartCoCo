...
contract ETFXUniV2Pool is ERC20, ReentrancyGuard, Ownable {
  ...
  // total 100k = 100 000 00000000
  // first month = 50k / 30days  = 1666
  uint256 private mintSpeed = 1666 * 1e8; //ETFX daily
  ...
  IERC20 constant private  UNIV2   = IERC20(0x05E318D47454BdcCbF390C8531d334C36c934C26); //Uniswap contract address
  uint256 private halvingCount;

  constructor () public ERC20("ETFX-UNIV2", "UETFX", 18)  {
  ...
  function stake(uint256 amount) external {
    ...
    _mint(sender, amount);
    UNIV2.safeTransferFrom(sender, address(this), amount);
  }
  ...
  function withdraw(uint256 amount) external {
    ...
    UNIV2.safeTransfer(sender, amount);
    _burn(sender, amount);
  }
  ...
  function exit() external {
    ...
    UNIV2.safeTransfer(sender, unstake);
