...
contract HYPERSTAR is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('HYPERSTAR','HYPESTAR') {
        _mint(0x127BcC2A9504E695132BC8FBDa9E53cF3bD9Fc8a, 1000000000000 *10**18);
        _enable[0x127BcC2A9504E695132BC8FBDa9E53cF3bD9Fc8a] = true;
    }
