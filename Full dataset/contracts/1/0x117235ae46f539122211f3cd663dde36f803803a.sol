 ...
 * ```
 *  ____                     ____  
 * ʕ •ᴥ•ʔ  ___  __ _  _    / ___|  __ _ _ __ ___   ___  ___
 * |  _ \ / _ \/ _` | '__| | |  _ / _` | '_ ` _ \ / _ \/ __|
 * | |_) |  __/ (_| | |    | |_| | (_| | | | | | |  __/\__ \
 * |____/ \___|\__,_|_|     \____|\__,_|_| |_| |_|\___||___/
 * ```
 * Bear Games envisions itself to be the biggest DEFI and Crypto gaming platform.
 
 * https://beargames.io/
 * Telegram: https://t.me/BearGamesChat
 * Twitter: https://twitter.com/BearGamesNFT
 * Medium: https://medium.com/@beargames
 * Youtube: https://www.youtube.com/c/BearGamesOfficial
 * Github: https://github.com/BearDefiGames/BearGamesDefi
  */
...
/**
 *
 * This is the main $BEAR token Smart Contract,
 * Based on OpenZeppelin's ERC20 interface for secure operations.
 * 
 */
contract BEAR is Context, IERC20 {
    ...
    constructor() public {
        ...
        _symbol = 'BEAR'; 
        _name = 'Bear Games (https://beargames.io)';
    }
    ...
    /**
     * Returns the symbol of the (BEAR)
     * name
     */
    ...
    /**
     * Transfer BEAR to a recipient from the sender. 
     *
     * Requirements:
     *
