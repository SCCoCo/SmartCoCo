...
contract ACDCNW is Context, IERC20, Ownable {
    ...
    string private _name = "AC-DC NETWORK";
    string private _symbol = "ACDCNW";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 30;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _walletFee = 30;
    ...
    uint256 public _maxTxAmount = 100000000000 * 10**6 * 10**18;
    ...
    constructor () {
        _buyBackWalletAddress = payable(0xf7AB8E817163c49E432d55bB65683f83954D4212);
        _rOwned[owner()] = _rTotal;
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //uniswapV3Router
    ...
    function setbuyBackFeePercent(uint256 walletFee) external onlyOwner() {
    ...
    function _takeDevelopment(uint256 tDevelopment, address sender) private {
        uint256 currentRate =  _getRate();
        uint256 rDevelopment = tDevelopment.mul(currentRate);
        _rOwned[_buyBackWalletAddress] = _rOwned[_buyBackWalletAddress].add(rDevelopment);
        if(_isExcluded[_buyBackWalletAddress])
            _tOwned[_buyBackWalletAddress] = _tOwned[_buyBackWalletAddress].add(tDevelopment);
        emit Transfer(sender, _buyBackWalletAddress, tDevelopment);
    }
    ...
    function _setDevelopmentWalletAddress(address payable buyBackWalletAddress) external onlyOwner() {
