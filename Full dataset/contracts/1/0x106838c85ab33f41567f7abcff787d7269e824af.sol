...
contract Strategy is CurveVoterProxy {
    ...
    function _claim() internal {
        IERC20 stkaave = IERC20(0x4da27a545c0c5B758a6BA100e3a049001de870f5);
        IVoterProxy(proxy).claimRewards(gauge, address(stkaave));
        address mech = address(0x1ea056C13F8ccC981E51c5f1CDF87476666D0A74);
        stkaave.transfer(mech, stkaave.balanceOf(address(this)));
    }
