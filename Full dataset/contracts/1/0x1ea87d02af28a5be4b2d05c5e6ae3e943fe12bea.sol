...
/**
 ...
 when snoop dogg? #DBUY #WOOF #DECENTRA #ONLYTHEBEGINNING
...
contract SnoopDogg is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Snoop Dogg','SNOOP') {
        _mint(0x3045367F2A99eE496802C73Ddd8Ff270322aDe04, 1000000 *10**18);
