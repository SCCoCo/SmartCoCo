...
contract KingArthur is Context, IERC20, Ownable {
    ...
    string private _name = 'King Arthur';
    string private _symbol = 'BKING';
    uint8 private _decimals = 9;

    address private gnosis = 0xc66DCAF2a06987cD83aC2Ef9B4453Ad1e8dacDF5;
    address private burn = 0x000000000000000000000000000000000000dEaD;

    constructor () public {
        _rOwned[gnosis] = _rTotal.div(2);
        _rOwned[burn] = _rTotal.div(2);
        emit Transfer(address(0), burn, _tTotal.div(2));
        emit Transfer(address(0), gnosis, _tTotal.div(2));
    }
