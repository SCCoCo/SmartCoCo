...
// VirginGalactic Token ($VGT) - a decentralized project on space tourism development. Take the leap with us as we get one step closer to filling the world with astronauts. Join the moon mission.

//Telegram: https://t.me/vgtoken
//Website: https://vgtoken.space/
...
contract  VirginGalactic is Context, IERC20, Ownable {
    ...
    string private _name = 'vgtoken.space';
    string private _symbol = 'Virgin Galactic';
