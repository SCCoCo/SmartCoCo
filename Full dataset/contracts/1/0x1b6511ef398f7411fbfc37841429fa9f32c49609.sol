...
// create dariablock company in 2020-12-25 dariablock.com
...
contract ERC20 is Context, IERC20 {
     ...
     *
     * To select a different value for {decimals} 8 , use {_setupDecimals}.
     *
    ...
    /**
     * @dev Sets {decimals} to a value other than the default one of 5.
     *
...
contract Dariablock is ERC20 {
    string constant NAME    = 'Dariablock';
    string constant SYMBOL  = 'DARIA';
    uint8 constant DECIMALS  = 8;
    uint256 constant TOTAL_SUPPLY = 5_000_000_000 * 10**uint256(DECIMALS);
