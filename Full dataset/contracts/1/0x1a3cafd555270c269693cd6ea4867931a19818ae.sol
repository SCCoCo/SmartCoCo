...
/**
 * @title CitboinStandard
 * @dev the interface of CitboinStandard
 */
contract CitboinStandard {
...
contract Citboin is ERC20,CitboinStandard,Ownable {
    using SafeMath for uint256;

    string public name = "Citboin";
