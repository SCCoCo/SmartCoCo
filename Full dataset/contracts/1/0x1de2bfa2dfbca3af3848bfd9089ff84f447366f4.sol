...
/*
    ...
    кредитование, под минимальные проценты, открывает депозитные и инвестицио��ные вклады, вклады 
...
/*
    ...
    - Цена токена во время старта: 1 ETH = 20 токено�� (1 Eth (~500$) / 20 = ~25$) (цену можно изменить во время ICO)
