...
contract NanocoreVault is OwnableUpgradeSafe {
        ...
        returns (uint256)
    {
        ...
        uint256 accNanocorePerShare = pool.accNanocorePerShare;
    ...
    function addPendingRewards(uint256 _) public {
        uint256 newRewards = nanocore.balanceOf(address(this)).sub(nanocoreBalance);
    ...
    function updatePool(uint256 _pid) internal returns (uint256 nanocoreRewardWhole) {
        ...
        uint256 nanocoreRewardFee = nanocoreRewardWhole.mul(DEV_FEE).div(10000);
        uint256 nanocoreRewardToDistribute = nanocoreRewardWhole.sub(nanocoreRewardFee);
    ...
    function safeNanocoreTransfer(address _to, uint256 _amount) internal {
        ...
        uint256 nanocoreBal = nanocore.balanceOf(address(this));
