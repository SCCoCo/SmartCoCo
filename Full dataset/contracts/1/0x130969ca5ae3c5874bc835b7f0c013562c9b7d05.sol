...
contract eClonic is Context, IERC20, Ownable {
    ...
    string private _name = 'eClonic';
    string private _symbol = 'ECL';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 1; // percent reflection fee for every holder
    ...
    address payable private _marketingWalletAddress = payable(0x8B65fd252b9D7a87e7b5b45DD18b9d6efa4eB22e);
