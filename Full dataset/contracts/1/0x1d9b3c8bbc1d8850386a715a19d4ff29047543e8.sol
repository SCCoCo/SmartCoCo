...
contract EthereumDiamond is ERC20 {
    ...
    string public constant name = "EthereumDiamond"; //* Token Name *//

    string public constant symbol = "ETHD"; //* EthereumDiamond Symbol *//

    uint public constant decimals = 8; //* Number of Decimals *//

    uint256 public totalSupply = 5000000000000000000; //* total supply of EthereumDiamond *//

    uint256 public totalDistributed =  200000000000;  //* Initial EthereumDiamond that will give to contract creator *//

    uint256 public constant MIN = 1 ether / 100;  //* Minimum Contribution for EthereumDiamond //

    uint256 public tokensPerEth = 20000000000000; //* EthereumDiamond Amount per Ethereum *//
    ...
    function burnEthereumDiamond(uint256 _value) onlyOwner public {
