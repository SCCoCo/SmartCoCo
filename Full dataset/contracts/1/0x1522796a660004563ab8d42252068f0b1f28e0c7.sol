...
contract ElonsBitch is Context, IERC20, Ownable {
    ...
    string private _name = "Elon's Bitch t.me/elonsbitch";
    string private _symbol = "$EBITCH";
    ...
    bool m_TradingOpened = false;
    bool m_AntiBot = true;
    
    FTPAntiBot private AntiBot;
    
    uint256 public _maxTxAmount = 500000000 * 10**1 * 10**9;
    ...
    function _transfer(
        ...
        if(m_AntiBot) {
            if((to == uniswapV2Pair || from == uniswapV2Pair) && m_TradingOpened){
