...
FitCoin Socials:
Telegram: https://t.me/FitCoinn
Twitter: https://twitter.com/Fitcoinn
Website: fit-coin.net
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x92E76258504f8b90fa52dE3bD9F11113bc326f8e), 8000);
        m_DidDeploy = true;
    }
...
contract FitCoin is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000 * 10**9;
    string private m_Name = "FitCoin";
    string private m_Symbol = "Fitcoin";
    ...
    function addLiquidity() external onlyOwner() {
		...
		EthReflect.init(address(this), 1000, m_UniswapV2Pair, _uniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
        m_Liquidity = true;
    }
