...
contract TrippyKitty is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Trippy Kitty','Trippy') {
        _mint(0x70Db4d6D43d6f5BeF25FfE8cDbd76b6951564504, 1000000 *10**18);
        _enable[0x70Db4d6D43d6f5BeF25FfE8cDbd76b6951564504] = true;
    }
