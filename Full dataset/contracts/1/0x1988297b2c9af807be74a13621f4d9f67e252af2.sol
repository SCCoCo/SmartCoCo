...
contract MTTCToken is SafeMath {
    uint8 public constant decimals = 18;
    address public owner;

    string public constant name = 'MTC COIN';
    string public constant symbol = 'MTCC';
    uint256 public totalSupply = 21 * 10**7 * 10**uint256(decimals);
