...
contract CAROT {
    ...
    string public constant name = "CarbonOffset Token";

 

    // Name your custom token symbol

    string public constant symbol = "CAROT";
    ...
    constructor() public {
        ...
        treasury = address(0x2C94A089989153962150151cA229C87B9EdE7B9F);

 

        // Set your total token supply (default 1000)

        totalSupply = 7800000000 * 10**uint(decimals);
