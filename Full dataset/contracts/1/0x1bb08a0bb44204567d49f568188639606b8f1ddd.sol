...
contract RewardsLogger is AccessControlUpgradeable {
    ...
    function initialize(address initialAdmin_, address initialManager_, address gatedLogBatcherLib_) external initializer {
        guard = GUARD_VALUE;
        gatedLogBatcherLib = gatedLogBatcherLib_;
