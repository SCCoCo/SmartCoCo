...
Welcome to $OLYMPUS
   ...
   If you want to view all the information about this coin, please check https://t.me/OlympusOfficial_Channel
   
   I'll lock liquidity LPs through team.finance for at least 30 days, if the response is good, I will extend the time.
   I'll renounce the ownership to burn addresses to transfer $OLYMPUS to the community, make sure it's 100% safe.
   ...
   Great features:
    ...
    it's the best part of the $OLYMPUS idea, increasing the liquidity pool automatically.
...
contract OLYMPUS is ERC20 {
     ...
     */
    constructor() public ERC20("https://t.me/OlympusOfficial_Channel", "OLYMPUS") {
