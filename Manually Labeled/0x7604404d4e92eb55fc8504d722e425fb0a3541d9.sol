...
// SPDX-License-Identifier: MIT
pragma solidity ^0.6.2;
contract FortySix is ERC20, Ownable {
  string constant internal _tokenName = "FortySix";//FortySix
  string constant internal _tokenSymbol = "FRS";
  uint8 constant internal _decimal = 18;
  uint256 constant internal _supply = 2000;
