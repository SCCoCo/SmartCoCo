...
abstract contract StakeHydraToken {
...
/**
 * @dev Implementation of the Hydra Protocol: https://hydras.network
 * Hydra Protocol (HYDRA) is the world's first price-reactive cryptocurrency.
 ...
 */
contract HydraToken is Ownable, IERC20 {
    ...
    string public constant _name = "Hydra Protocol";
    string public constant _symbol = "HYDRA";
    uint8 public constant _decimals = 18;
    
    StakeHydraToken public _stakingContract;
    ...
    function updateStakingContract(StakeHydraToken stakingContract) external onlyOwner {
